...
class Accessible extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AccessiblePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AccessiblePainter}
/// Custom painter for [Accessible].
/// {@endtemplate}
class AccessiblePainter extends CustomPainter {
  /// {@macro AccessiblePainter}
  const AccessiblePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AccessiblePainter oldDelegate) =>

...
/// AdCircle widget.
/// {@endtemplate}
class AdCircle extends StatelessWidget {
  /// {@macro AdCircle}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AdCirclePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AdCirclePainter}
/// Custom painter for [AdCircle].
/// {@endtemplate}
class AdCirclePainter extends CustomPainter {
  /// {@macro AdCirclePainter}
  const AdCirclePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AdCirclePainter oldDelegate) =>

...
class Alarm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlarmPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlarmPainter}
/// Custom painter for [Alarm].
/// {@endtemplate}
class AlarmPainter extends CustomPainter {
  /// {@macro AlarmPainter}
  const AlarmPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlarmPainter oldDelegate) =>

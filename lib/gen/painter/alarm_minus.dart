...
/// AlarmMinus widget.
/// {@endtemplate}
class AlarmMinus extends StatelessWidget {
  /// {@macro AlarmMinus}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlarmMinusPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlarmMinusPainter}
/// Custom painter for [AlarmMinus].
/// {@endtemplate}
class AlarmMinusPainter extends CustomPainter {
  /// {@macro AlarmMinusPainter}
  const AlarmMinusPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlarmMinusPainter oldDelegate) =>

...
class AlarmSnooze extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlarmSnoozePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlarmSnoozePainter}
/// Custom painter for [AlarmSnooze].
/// {@endtemplate}
class AlarmSnoozePainter extends CustomPainter {
  /// {@macro AlarmSnoozePainter}
  const AlarmSnoozePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlarmSnoozePainter oldDelegate) =>

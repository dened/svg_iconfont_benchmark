...
class AlertOctagon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlertOctagonPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlertOctagonPainter}
/// Custom painter for [AlertOctagon].
/// {@endtemplate}
class AlertOctagonPainter extends CustomPainter {
  /// {@macro AlertOctagonPainter}
  const AlertOctagonPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlertOctagonPainter oldDelegate) =>

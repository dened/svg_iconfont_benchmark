...
/// {@endtemplate}
class AlertSquareRounded extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlertSquareRoundedPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlertSquareRoundedPainter}
/// Custom painter for [AlertSquareRounded].
/// {@endtemplate}
class AlertSquareRoundedPainter extends CustomPainter {
  /// {@macro AlertSquareRoundedPainter}
  const AlertSquareRoundedPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlertSquareRoundedPainter oldDelegate) =>

...
class Alien extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlienPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlienPainter}
/// Custom painter for [Alien].
/// {@endtemplate}
class AlienPainter extends CustomPainter {
  /// {@macro AlienPainter}
  const AlienPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlienPainter oldDelegate) =>

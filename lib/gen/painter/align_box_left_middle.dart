...
/// {@endtemplate}
class AlignBoxLeftMiddle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlignBoxLeftMiddlePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlignBoxLeftMiddlePainter}
/// Custom painter for [AlignBoxLeftMiddle].
/// {@endtemplate}
class AlignBoxLeftMiddlePainter extends CustomPainter {
  /// {@macro AlignBoxLeftMiddlePainter}
  const AlignBoxLeftMiddlePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlignBoxLeftMiddlePainter oldDelegate) =>

...
/// {@endtemplate}
class AlignBoxTopCenter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AlignBoxTopCenterPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AlignBoxTopCenterPainter}
/// Custom painter for [AlignBoxTopCenter].
/// {@endtemplate}
class AlignBoxTopCenterPainter extends CustomPainter {
  /// {@macro AlignBoxTopCenterPainter}
  const AlignBoxTopCenterPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AlignBoxTopCenterPainter oldDelegate) =>

...
class Analyze extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AnalyzePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AnalyzePainter}
/// Custom painter for [Analyze].
/// {@endtemplate}
class AnalyzePainter extends CustomPainter {
  /// {@macro AnalyzePainter}
  const AnalyzePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AnalyzePainter oldDelegate) =>

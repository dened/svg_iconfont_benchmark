...
class Apps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AppsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AppsPainter}
/// Custom painter for [Apps].
/// {@endtemplate}
class AppsPainter extends CustomPainter {
  /// {@macro AppsPainter}
  const AppsPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(AppsPainter oldDelegate) =>

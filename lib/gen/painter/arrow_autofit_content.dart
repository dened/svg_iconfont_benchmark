...
/// {@endtemplate}
class ArrowAutofitContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowAutofitContentPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowAutofitContentPainter}
/// Custom painter for [ArrowAutofitContent].
/// {@endtemplate}
class ArrowAutofitContentPainter extends CustomPainter {
  /// {@macro ArrowAutofitContentPainter}
  const ArrowAutofitContentPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowAutofitContentPainter oldDelegate) =>

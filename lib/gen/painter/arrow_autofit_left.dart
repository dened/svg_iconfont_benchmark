...
/// {@endtemplate}
class ArrowAutofitLeft extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowAutofitLeftPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowAutofitLeftPainter}
/// Custom painter for [ArrowAutofitLeft].
/// {@endtemplate}
class ArrowAutofitLeftPainter extends CustomPainter {
  /// {@macro ArrowAutofitLeftPainter}
  const ArrowAutofitLeftPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowAutofitLeftPainter oldDelegate) =>

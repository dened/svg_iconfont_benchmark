...
/// {@endtemplate}
class ArrowAutofitUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowAutofitUpPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowAutofitUpPainter}
/// Custom painter for [ArrowAutofitUp].
/// {@endtemplate}
class ArrowAutofitUpPainter extends CustomPainter {
  /// {@macro ArrowAutofitUpPainter}
  const ArrowAutofitUpPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowAutofitUpPainter oldDelegate) =>

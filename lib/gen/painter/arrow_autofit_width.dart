...
/// {@endtemplate}
class ArrowAutofitWidth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowAutofitWidthPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowAutofitWidthPainter}
/// Custom painter for [ArrowAutofitWidth].
/// {@endtemplate}
class ArrowAutofitWidthPainter extends CustomPainter {
  /// {@macro ArrowAutofitWidthPainter}
  const ArrowAutofitWidthPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowAutofitWidthPainter oldDelegate) =>

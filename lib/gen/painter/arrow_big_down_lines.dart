...
/// {@endtemplate}
class ArrowBigDownLines extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowBigDownLinesPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowBigDownLinesPainter}
/// Custom painter for [ArrowBigDownLines].
/// {@endtemplate}
class ArrowBigDownLinesPainter extends CustomPainter {
  /// {@macro ArrowBigDownLinesPainter}
  const ArrowBigDownLinesPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowBigDownLinesPainter oldDelegate) =>

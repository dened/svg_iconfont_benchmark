...
/// {@endtemplate}
class ArrowBigUpLines extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowBigUpLinesPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowBigUpLinesPainter}
/// Custom painter for [ArrowBigUpLines].
/// {@endtemplate}
class ArrowBigUpLinesPainter extends CustomPainter {
  /// {@macro ArrowBigUpLinesPainter}
  const ArrowBigUpLinesPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowBigUpLinesPainter oldDelegate) =>

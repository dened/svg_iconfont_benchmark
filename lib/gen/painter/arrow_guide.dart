...
/// ArrowGuide widget.
/// {@endtemplate}
class ArrowGuide extends StatelessWidget {
  /// {@macro ArrowGuide}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowGuidePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowGuidePainter}
/// Custom painter for [ArrowGuide].
/// {@endtemplate}
class ArrowGuidePainter extends CustomPainter {
  /// {@macro ArrowGuidePainter}
  const ArrowGuidePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowGuidePainter oldDelegate) =>

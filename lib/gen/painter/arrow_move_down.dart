...
/// {@endtemplate}
class ArrowMoveDown extends StatelessWidget {
  /// {@macro ArrowMoveDown}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowMoveDownPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowMoveDownPainter}
/// Custom painter for [ArrowMoveDown].
/// {@endtemplate}
class ArrowMoveDownPainter extends CustomPainter {
  /// {@macro ArrowMoveDownPainter}
  const ArrowMoveDownPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowMoveDownPainter oldDelegate) =>

...
/// {@endtemplate}
class ArrowMoveLeft extends StatelessWidget {
  /// {@macro ArrowMoveLeft}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowMoveLeftPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowMoveLeftPainter}
/// Custom painter for [ArrowMoveLeft].
/// {@endtemplate}
class ArrowMoveLeftPainter extends CustomPainter {
  /// {@macro ArrowMoveLeftPainter}
  const ArrowMoveLeftPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowMoveLeftPainter oldDelegate) =>

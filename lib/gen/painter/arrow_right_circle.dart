...
class ArrowRightCircle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArrowRightCirclePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArrowRightCirclePainter}
/// Custom painter for [ArrowRightCircle].
/// {@endtemplate}
class ArrowRightCirclePainter extends CustomPainter {
  /// {@macro ArrowRightCirclePainter}
  const ArrowRightCirclePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ArrowRightCirclePainter oldDelegate) =>

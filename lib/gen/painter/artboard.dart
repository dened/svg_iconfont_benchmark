...
class Artboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ArtboardPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ArtboardPainter}
/// Custom painter for [Artboard].
/// {@endtemplate}
class ArtboardPainter extends CustomPainter {
  /// {@macro ArtboardPainter}
  const ArtboardPainter({ui.ColorFilter? colorFilter})

...
class AspectRatio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AspectRatioPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AspectRatioPainter}
/// Custom painter for [AspectRatio].
/// {@endtemplate}
class AspectRatioPainter extends CustomPainter {
  /// {@macro AspectRatioPainter}
  const AspectRatioPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AspectRatioPainter oldDelegate) =>

...
/// Atom2 widget.
/// {@endtemplate}
class Atom2 extends StatelessWidget {
  /// {@macro Atom2}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Atom2Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Atom2Painter}
/// Custom painter for [Atom2].
/// {@endtemplate}
class Atom2Painter extends CustomPainter {
  /// {@macro Atom2Painter}
  const Atom2Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Atom2Painter oldDelegate) =>

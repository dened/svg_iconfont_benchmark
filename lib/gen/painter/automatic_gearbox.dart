...
/// {@endtemplate}
class AutomaticGearbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: AutomaticGearboxPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template AutomaticGearboxPainter}
/// Custom painter for [AutomaticGearbox].
/// {@endtemplate}
class AutomaticGearboxPainter extends CustomPainter {
  /// {@macro AutomaticGearboxPainter}
  const AutomaticGearboxPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(AutomaticGearboxPainter oldDelegate) =>

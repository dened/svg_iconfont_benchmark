...
/// BabyCarriage widget.
/// {@endtemplate}
class BabyCarriage extends StatelessWidget {
  /// {@macro BabyCarriage}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BabyCarriagePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BabyCarriagePainter}
/// Custom painter for [BabyCarriage].
/// {@endtemplate}
class BabyCarriagePainter extends CustomPainter {
  /// {@macro BabyCarriagePainter}
  const BabyCarriagePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BabyCarriagePainter oldDelegate) =>

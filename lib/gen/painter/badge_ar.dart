...
/// BadgeAr widget.
/// {@endtemplate}
class BadgeAr extends StatelessWidget {
  /// {@macro BadgeAr}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BadgeArPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BadgeArPainter}
/// Custom painter for [BadgeAr].
/// {@endtemplate}
class BadgeArPainter extends CustomPainter {
  /// {@macro BadgeArPainter}
  const BadgeArPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BadgeArPainter oldDelegate) =>

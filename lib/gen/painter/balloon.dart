...
class Balloon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BalloonPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BalloonPainter}
/// Custom painter for [Balloon].
/// {@endtemplate}
class BalloonPainter extends CustomPainter {
  /// {@macro BalloonPainter}
  const BalloonPainter({ui.ColorFilter? colorFilter})

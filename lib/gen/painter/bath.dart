...
class Bath extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BathPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BathPainter}
/// Custom painter for [Bath].
/// {@endtemplate}
class BathPainter extends CustomPainter {
  /// {@macro BathPainter}
  const BathPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(BathPainter oldDelegate) =>

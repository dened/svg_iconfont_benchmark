...
/// Battery3 widget.
/// {@endtemplate}
class Battery3 extends StatelessWidget {
  /// {@macro Battery3}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Battery3Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Battery3Painter}
/// Custom painter for [Battery3].
/// {@endtemplate}
class Battery3Painter extends CustomPainter {
  /// {@macro Battery3Painter}
  const Battery3Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Battery3Painter oldDelegate) =>

...
/// Battery4 widget.
/// {@endtemplate}
class Battery4 extends StatelessWidget {
  /// {@macro Battery4}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Battery4Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Battery4Painter}
/// Custom painter for [Battery4].
/// {@endtemplate}
class Battery4Painter extends CustomPainter {
  /// {@macro Battery4Painter}
  const Battery4Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Battery4Painter oldDelegate) =>

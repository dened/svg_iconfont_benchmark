...
class Bed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BedPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BedPainter}
/// Custom painter for [Bed].
/// {@endtemplate}
class BedPainter extends CustomPainter {
  /// {@macro BedPainter}
  const BedPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(BedPainter oldDelegate) =>

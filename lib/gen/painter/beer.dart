...
class Beer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BeerPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BeerPainter}
/// Custom painter for [Beer].
/// {@endtemplate}
class BeerPainter extends CustomPainter {
  /// {@macro BeerPainter}
  const BeerPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(BeerPainter oldDelegate) =>

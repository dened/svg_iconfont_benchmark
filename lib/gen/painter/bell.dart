...
class Bell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BellPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BellPainter}
/// Custom painter for [Bell].
/// {@endtemplate}
class BellPainter extends CustomPainter {
  /// {@macro BellPainter}
  const BellPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;

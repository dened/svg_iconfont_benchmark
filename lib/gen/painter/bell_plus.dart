...
/// BellPlus widget.
/// {@endtemplate}
class BellPlus extends StatelessWidget {
  /// {@macro BellPlus}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BellPlusPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BellPlusPainter}
/// Custom painter for [BellPlus].
/// {@endtemplate}
class BellPlusPainter extends CustomPainter {
  /// {@macro BellPlusPainter}
  const BellPlusPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BellPlusPainter oldDelegate) =>

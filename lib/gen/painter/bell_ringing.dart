...
/// BellRinging widget.
/// {@endtemplate}
class BellRinging extends StatelessWidget {
  /// {@macro BellRinging}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BellRingingPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BellRingingPainter}
/// Custom painter for [BellRinging].
/// {@endtemplate}
class BellRingingPainter extends CustomPainter {
  /// {@macro BellRingingPainter}
  const BellRingingPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BellRingingPainter oldDelegate) =>

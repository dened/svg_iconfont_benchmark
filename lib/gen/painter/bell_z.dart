...
/// BellZ widget.
/// {@endtemplate}
class BellZ extends StatelessWidget {
  /// {@macro BellZ}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BellZPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BellZPainter}
/// Custom painter for [BellZ].
/// {@endtemplate}
class BellZPainter extends CustomPainter {
  /// {@macro BellZPainter}
  const BellZPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BellZPainter oldDelegate) =>

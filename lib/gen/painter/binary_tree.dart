...
class BinaryTree extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BinaryTreePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BinaryTreePainter}
/// Custom painter for [BinaryTree].
/// {@endtemplate}
class BinaryTreePainter extends CustomPainter {
  /// {@macro BinaryTreePainter}
  const BinaryTreePainter({ui.ColorFilter? colorFilter})

...
/// Biohazard widget.
/// {@endtemplate}
class Biohazard extends StatelessWidget {
  /// {@macro Biohazard}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BiohazardPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BiohazardPainter}
/// Custom painter for [Biohazard].
/// {@endtemplate}
class BiohazardPainter extends CustomPainter {
  /// {@macro BiohazardPainter}
  const BiohazardPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BiohazardPainter oldDelegate) =>

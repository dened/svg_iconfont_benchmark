...
class Blade extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BladePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BladePainter}
/// Custom painter for [Blade].
/// {@endtemplate}
class BladePainter extends CustomPainter {
  /// {@macro BladePainter}
  const BladePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BladePainter oldDelegate) =>

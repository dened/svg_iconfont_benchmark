...
class Blender extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BlenderPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BlenderPainter}
/// Custom painter for [Blender].
/// {@endtemplate}
class BlenderPainter extends CustomPainter {
  /// {@macro BlenderPainter}
  const BlenderPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BlenderPainter oldDelegate) =>

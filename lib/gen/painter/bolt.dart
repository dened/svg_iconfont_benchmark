...
class Bolt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BoltPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BoltPainter}
/// Custom painter for [Bolt].
/// {@endtemplate}
class BoltPainter extends CustomPainter {
  /// {@macro BoltPainter}
  const BoltPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(BoltPainter oldDelegate) =>

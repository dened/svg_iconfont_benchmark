...
class Bone extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BonePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BonePainter}
/// Custom painter for [Bone].
/// {@endtemplate}
class BonePainter extends CustomPainter {
  /// {@macro BonePainter}
  const BonePainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;

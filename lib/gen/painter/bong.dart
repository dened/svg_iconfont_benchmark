...
class Bong extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BongPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BongPainter}
/// Custom painter for [Bong].
/// {@endtemplate}
class BongPainter extends CustomPainter {
  /// {@macro BongPainter}
  const BongPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(BongPainter oldDelegate) =>

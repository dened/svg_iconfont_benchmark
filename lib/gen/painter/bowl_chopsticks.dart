...
/// {@endtemplate}
class BowlChopsticks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BowlChopsticksPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BowlChopsticksPainter}
/// Custom painter for [BowlChopsticks].
/// {@endtemplate}
class BowlChopsticksPainter extends CustomPainter {
  /// {@macro BowlChopsticksPainter}
  const BowlChopsticksPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BowlChopsticksPainter oldDelegate) =>

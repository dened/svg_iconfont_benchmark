...
/// {@endtemplate}
class BoxAlignBottomRight extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BoxAlignBottomRightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BoxAlignBottomRightPainter}
/// Custom painter for [BoxAlignBottomRight].
/// {@endtemplate}
class BoxAlignBottomRightPainter extends CustomPainter {
  /// {@macro BoxAlignBottomRightPainter}
  const BoxAlignBottomRightPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BoxAlignBottomRightPainter oldDelegate) =>

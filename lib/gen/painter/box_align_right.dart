...
/// {@endtemplate}
class BoxAlignRight extends StatelessWidget {
  /// {@macro BoxAlignRight}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BoxAlignRightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BoxAlignRightPainter}
/// Custom painter for [BoxAlignRight].
/// {@endtemplate}
class BoxAlignRightPainter extends CustomPainter {
  /// {@macro BoxAlignRightPainter}
  const BoxAlignRightPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BoxAlignRightPainter oldDelegate) =>

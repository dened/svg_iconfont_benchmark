...
/// {@endtemplate}
class BoxAlignTopLeft extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BoxAlignTopLeftPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BoxAlignTopLeftPainter}
/// Custom painter for [BoxAlignTopLeft].
/// {@endtemplate}
class BoxAlignTopLeftPainter extends CustomPainter {
  /// {@macro BoxAlignTopLeftPainter}
  const BoxAlignTopLeftPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BoxAlignTopLeftPainter oldDelegate) =>

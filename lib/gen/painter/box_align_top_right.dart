...
/// {@endtemplate}
class BoxAlignTopRight extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BoxAlignTopRightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BoxAlignTopRightPainter}
/// Custom painter for [BoxAlignTopRight].
/// {@endtemplate}
class BoxAlignTopRightPainter extends CustomPainter {
  /// {@macro BoxAlignTopRightPainter}
  const BoxAlignTopRightPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BoxAlignTopRightPainter oldDelegate) =>

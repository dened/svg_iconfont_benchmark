...
/// {@endtemplate}
class BrandBitbucket extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandBitbucketPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandBitbucketPainter}
/// Custom painter for [BrandBitbucket].
/// {@endtemplate}
class BrandBitbucketPainter extends CustomPainter {
  /// {@macro BrandBitbucketPainter}
  const BrandBitbucketPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandBitbucketPainter oldDelegate) =>

...
/// {@endtemplate}
class BrandDribbble extends StatelessWidget {
  /// {@macro BrandDribbble}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandDribbblePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandDribbblePainter}
/// Custom painter for [BrandDribbble].
/// {@endtemplate}
class BrandDribbblePainter extends CustomPainter {
  /// {@macro BrandDribbblePainter}
  const BrandDribbblePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandDribbblePainter oldDelegate) =>

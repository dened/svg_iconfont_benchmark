...
/// BrandGithub widget.
/// {@endtemplate}
class BrandGithub extends StatelessWidget {
  /// {@macro BrandGithub}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandGithubPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandGithubPainter}
/// Custom painter for [BrandGithub].
/// {@endtemplate}
class BrandGithubPainter extends CustomPainter {
  /// {@macro BrandGithubPainter}
  const BrandGithubPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandGithubPainter oldDelegate) =>

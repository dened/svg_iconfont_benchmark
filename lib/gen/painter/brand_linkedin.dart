...
/// {@endtemplate}
class BrandLinkedin extends StatelessWidget {
  /// {@macro BrandLinkedin}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandLinkedinPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandLinkedinPainter}
/// Custom painter for [BrandLinkedin].
/// {@endtemplate}
class BrandLinkedinPainter extends CustomPainter {
  /// {@macro BrandLinkedinPainter}
  const BrandLinkedinPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandLinkedinPainter oldDelegate) =>

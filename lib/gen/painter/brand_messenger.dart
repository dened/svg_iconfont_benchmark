...
/// {@endtemplate}
class BrandMessenger extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandMessengerPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandMessengerPainter}
/// Custom painter for [BrandMessenger].
/// {@endtemplate}
class BrandMessengerPainter extends CustomPainter {
  /// {@macro BrandMessengerPainter}
  const BrandMessengerPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandMessengerPainter oldDelegate) =>

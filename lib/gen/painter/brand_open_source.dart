...
/// {@endtemplate}
class BrandOpenSource extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandOpenSourcePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandOpenSourcePainter}
/// Custom painter for [BrandOpenSource].
/// {@endtemplate}
class BrandOpenSourcePainter extends CustomPainter {
  /// {@macro BrandOpenSourcePainter}
  const BrandOpenSourcePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandOpenSourcePainter oldDelegate) =>

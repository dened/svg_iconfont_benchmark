...
/// {@endtemplate}
class BrandPinterest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandPinterestPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandPinterestPainter}
/// Custom painter for [BrandPinterest].
/// {@endtemplate}
class BrandPinterestPainter extends CustomPainter {
  /// {@macro BrandPinterestPainter}
  const BrandPinterestPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandPinterestPainter oldDelegate) =>

...
/// {@endtemplate}
class BrandSnapchat extends StatelessWidget {
  /// {@macro BrandSnapchat}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandSnapchatPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandSnapchatPainter}
/// Custom painter for [BrandSnapchat].
/// {@endtemplate}
class BrandSnapchatPainter extends CustomPainter {
  /// {@macro BrandSnapchatPainter}
  const BrandSnapchatPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandSnapchatPainter oldDelegate) =>

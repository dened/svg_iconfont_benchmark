...
/// BrandSpotify widget.
/// {@endtemplate}
class BrandSpotify extends StatelessWidget {
  /// {@macro BrandSpotify}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandSpotifyPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandSpotifyPainter}
/// Custom painter for [BrandSpotify].
/// {@endtemplate}
class BrandSpotifyPainter extends CustomPainter {
  /// {@macro BrandSpotifyPainter}
  const BrandSpotifyPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandSpotifyPainter oldDelegate) =>

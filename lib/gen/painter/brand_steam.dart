...
/// BrandSteam widget.
/// {@endtemplate}
class BrandSteam extends StatelessWidget {
  /// {@macro BrandSteam}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandSteamPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandSteamPainter}
/// Custom painter for [BrandSteam].
/// {@endtemplate}
class BrandSteamPainter extends CustomPainter {
  /// {@macro BrandSteamPainter}
  const BrandSteamPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandSteamPainter oldDelegate) =>

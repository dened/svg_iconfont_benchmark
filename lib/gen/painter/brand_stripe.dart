...
class BrandStripe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandStripePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandStripePainter}
/// Custom painter for [BrandStripe].
/// {@endtemplate}
class BrandStripePainter extends CustomPainter {
  /// {@macro BrandStripePainter}
  const BrandStripePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandStripePainter oldDelegate) =>

...
/// BrandTabler widget.
/// {@endtemplate}
class BrandTabler extends StatelessWidget {
  /// {@macro BrandTabler}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrandTablerPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrandTablerPainter}
/// Custom painter for [BrandTabler].
/// {@endtemplate}
class BrandTablerPainter extends CustomPainter {
  /// {@macro BrandTablerPainter}
  const BrandTablerPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrandTablerPainter oldDelegate) =>

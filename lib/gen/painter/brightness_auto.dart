...
/// {@endtemplate}
class BrightnessAuto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BrightnessAutoPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BrightnessAutoPainter}
/// Custom painter for [BrightnessAuto].
/// {@endtemplate}
class BrightnessAutoPainter extends CustomPainter {
  /// {@macro BrightnessAutoPainter}
  const BrightnessAutoPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BrightnessAutoPainter oldDelegate) =>

...
class BubbleText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BubbleTextPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BubbleTextPainter}
/// Custom painter for [BubbleText].
/// {@endtemplate}
class BubbleTextPainter extends CustomPainter {
  /// {@macro BubbleTextPainter}
  const BubbleTextPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BubbleTextPainter oldDelegate) =>

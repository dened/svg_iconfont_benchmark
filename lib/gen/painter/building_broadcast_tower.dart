...
/// {@endtemplate}
class BuildingBroadcastTower extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: BuildingBroadcastTowerPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template BuildingBroadcastTowerPainter}
/// Custom painter for [BuildingBroadcastTower].
/// {@endtemplate}
class BuildingBroadcastTowerPainter extends CustomPainter {
  /// {@macro BuildingBroadcastTowerPainter}
  const BuildingBroadcastTowerPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(BuildingBroadcastTowerPainter oldDelegate) =>

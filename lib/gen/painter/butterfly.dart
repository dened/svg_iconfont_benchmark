...
class Butterfly extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ButterflyPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ButterflyPainter}
/// Custom painter for [Butterfly].
/// {@endtemplate}
class ButterflyPainter extends CustomPainter {
  /// {@macro ButterflyPainter}
  const ButterflyPainter({ui.ColorFilter? colorFilter})

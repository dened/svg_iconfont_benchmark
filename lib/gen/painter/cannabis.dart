...
/// Cannabis widget.
/// {@endtemplate}
class Cannabis extends StatelessWidget {
  /// {@macro Cannabis}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CannabisPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CannabisPainter}
/// Custom painter for [Cannabis].
/// {@endtemplate}
class CannabisPainter extends CustomPainter {
  /// {@macro CannabisPainter}
  const CannabisPainter({ui.ColorFilter? colorFilter})

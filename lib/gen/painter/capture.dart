...
class Capture extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CapturePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CapturePainter}
/// Custom painter for [Capture].
/// {@endtemplate}
class CapturePainter extends CustomPainter {
  /// {@macro CapturePainter}
  const CapturePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CapturePainter oldDelegate) =>

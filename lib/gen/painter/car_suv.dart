...
/// CarSuv widget.
/// {@endtemplate}
class CarSuv extends StatelessWidget {
  /// {@macro CarSuv}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CarSuvPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CarSuvPainter}
/// Custom painter for [CarSuv].
/// {@endtemplate}
class CarSuvPainter extends CustomPainter {
  /// {@macro CarSuvPainter}
  const CarSuvPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CarSuvPainter oldDelegate) =>

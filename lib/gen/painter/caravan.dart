...
class Caravan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CaravanPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CaravanPainter}
/// Custom painter for [Caravan].
/// {@endtemplate}
class CaravanPainter extends CustomPainter {
  /// {@macro CaravanPainter}
  const CaravanPainter({ui.ColorFilter? colorFilter})

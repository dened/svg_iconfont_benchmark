...
class Cardboards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CardboardsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CardboardsPainter}
/// Custom painter for [Cardboards].
/// {@endtemplate}
class CardboardsPainter extends CustomPainter {
  /// {@macro CardboardsPainter}
  const CardboardsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CardboardsPainter oldDelegate) =>

...
class Cards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CardsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CardsPainter}
/// Custom painter for [Cards].
/// {@endtemplate}
class CardsPainter extends CustomPainter {
  /// {@macro CardsPainter}
  const CardsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CardsPainter oldDelegate) =>

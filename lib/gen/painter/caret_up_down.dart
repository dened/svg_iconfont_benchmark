...
/// CaretUpDown widget.
/// {@endtemplate}
class CaretUpDown extends StatelessWidget {
  /// {@macro CaretUpDown}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CaretUpDownPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CaretUpDownPainter}
/// Custom painter for [CaretUpDown].
/// {@endtemplate}
class CaretUpDownPainter extends CustomPainter {
  /// {@macro CaretUpDownPainter}
  const CaretUpDownPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CaretUpDownPainter oldDelegate) =>

...
class CarouselHorizontal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CarouselHorizontalPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CarouselHorizontalPainter}
/// Custom painter for [CarouselHorizontal].
/// {@endtemplate}
class CarouselHorizontalPainter extends CustomPainter {
  /// {@macro CarouselHorizontalPainter}
  const CarouselHorizontalPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CarouselHorizontalPainter oldDelegate) =>

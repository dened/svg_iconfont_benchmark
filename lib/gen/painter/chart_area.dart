...
class ChartArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartAreaPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartAreaPainter}
/// Custom painter for [ChartArea].
/// {@endtemplate}
class ChartAreaPainter extends CustomPainter {
  /// {@macro ChartAreaPainter}
  const ChartAreaPainter({ui.ColorFilter? colorFilter})

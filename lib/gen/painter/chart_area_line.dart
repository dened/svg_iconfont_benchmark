...
/// {@endtemplate}
class ChartAreaLine extends StatelessWidget {
  /// {@macro ChartAreaLine}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartAreaLinePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartAreaLinePainter}
/// Custom painter for [ChartAreaLine].
/// {@endtemplate}
class ChartAreaLinePainter extends CustomPainter {
  /// {@macro ChartAreaLinePainter}
  const ChartAreaLinePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ChartAreaLinePainter oldDelegate) =>

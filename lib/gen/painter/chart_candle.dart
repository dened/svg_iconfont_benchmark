...
/// ChartCandle widget.
/// {@endtemplate}
class ChartCandle extends StatelessWidget {
  /// {@macro ChartCandle}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartCandlePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartCandlePainter}
/// Custom painter for [ChartCandle].
/// {@endtemplate}
class ChartCandlePainter extends CustomPainter {
  /// {@macro ChartCandlePainter}
  const ChartCandlePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ChartCandlePainter oldDelegate) =>

...
/// ChartDots widget.
/// {@endtemplate}
class ChartDots extends StatelessWidget {
  /// {@macro ChartDots}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartDotsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartDotsPainter}
/// Custom painter for [ChartDots].
/// {@endtemplate}
class ChartDotsPainter extends CustomPainter {
  /// {@macro ChartDotsPainter}
  const ChartDotsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ChartDotsPainter oldDelegate) =>

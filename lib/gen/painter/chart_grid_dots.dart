...
/// {@endtemplate}
class ChartGridDots extends StatelessWidget {
  /// {@macro ChartGridDots}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartGridDotsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartGridDotsPainter}
/// Custom painter for [ChartGridDots].
/// {@endtemplate}
class ChartGridDotsPainter extends CustomPainter {
  /// {@macro ChartGridDotsPainter}
  const ChartGridDotsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ChartGridDotsPainter oldDelegate) =>

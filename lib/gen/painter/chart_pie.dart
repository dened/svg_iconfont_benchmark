...
class ChartPie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChartPiePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChartPiePainter}
/// Custom painter for [ChartPie].
/// {@endtemplate}
class ChartPiePainter extends CustomPainter {
  /// {@macro ChartPiePainter}
  const ChartPiePainter({ui.ColorFilter? colorFilter})

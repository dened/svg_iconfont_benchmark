...
class ChefHat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChefHatPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChefHatPainter}
/// Custom painter for [ChefHat].
/// {@endtemplate}
class ChefHatPainter extends CustomPainter {
  /// {@macro ChefHatPainter}
  const ChefHatPainter({ui.ColorFilter? colorFilter})

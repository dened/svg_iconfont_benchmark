...
/// ChessKing widget.
/// {@endtemplate}
class ChessKing extends StatelessWidget {
  /// {@macro ChessKing}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChessKingPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChessKingPainter}
/// Custom painter for [ChessKing].
/// {@endtemplate}
class ChessKingPainter extends CustomPainter {
  /// {@macro ChessKingPainter}
  const ChessKingPainter({ui.ColorFilter? colorFilter})

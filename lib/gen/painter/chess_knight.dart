...
/// ChessKnight widget.
/// {@endtemplate}
class ChessKnight extends StatelessWidget {
  /// {@macro ChessKnight}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChessKnightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChessKnightPainter}
/// Custom painter for [ChessKnight].
/// {@endtemplate}
class ChessKnightPainter extends CustomPainter {
  /// {@macro ChessKnightPainter}
  const ChessKnightPainter({ui.ColorFilter? colorFilter})

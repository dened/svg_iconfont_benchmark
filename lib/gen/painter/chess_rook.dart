...
/// ChessRook widget.
/// {@endtemplate}
class ChessRook extends StatelessWidget {
  /// {@macro ChessRook}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ChessRookPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ChessRookPainter}
/// Custom painter for [ChessRook].
/// {@endtemplate}
class ChessRookPainter extends CustomPainter {
  /// {@macro ChessRookPainter}
  const ChessRookPainter({ui.ColorFilter? colorFilter})

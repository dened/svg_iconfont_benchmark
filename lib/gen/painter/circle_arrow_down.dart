...
/// {@endtemplate}
class CircleArrowDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleArrowDownPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleArrowDownPainter}
/// Custom painter for [CircleArrowDown].
/// {@endtemplate}
class CircleArrowDownPainter extends CustomPainter {
  /// {@macro CircleArrowDownPainter}
  const CircleArrowDownPainter({ui.ColorFilter? colorFilter})

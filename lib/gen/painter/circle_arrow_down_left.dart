...
/// {@endtemplate}
class CircleArrowDownLeft extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleArrowDownLeftPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleArrowDownLeftPainter}
/// Custom painter for [CircleArrowDownLeft].
/// {@endtemplate}
class CircleArrowDownLeftPainter extends CustomPainter {
  /// {@macro CircleArrowDownLeftPainter}
  const CircleArrowDownLeftPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleArrowDownLeftPainter oldDelegate) =>

...
/// {@endtemplate}
class CircleArrowDownRight extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleArrowDownRightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleArrowDownRightPainter}
/// Custom painter for [CircleArrowDownRight].
/// {@endtemplate}
class CircleArrowDownRightPainter extends CustomPainter {
  /// {@macro CircleArrowDownRightPainter}
  const CircleArrowDownRightPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleArrowDownRightPainter oldDelegate) =>

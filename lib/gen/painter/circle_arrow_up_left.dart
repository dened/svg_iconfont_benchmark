...
/// {@endtemplate}
class CircleArrowUpLeft extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleArrowUpLeftPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleArrowUpLeftPainter}
/// Custom painter for [CircleArrowUpLeft].
/// {@endtemplate}
class CircleArrowUpLeftPainter extends CustomPainter {
  /// {@macro CircleArrowUpLeftPainter}
  const CircleArrowUpLeftPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleArrowUpLeftPainter oldDelegate) =>

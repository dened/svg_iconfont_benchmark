...
/// {@endtemplate}
class CircleArrowUpRight extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleArrowUpRightPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleArrowUpRightPainter}
/// Custom painter for [CircleArrowUpRight].
/// {@endtemplate}
class CircleArrowUpRightPainter extends CustomPainter {
  /// {@macro CircleArrowUpRightPainter}
  const CircleArrowUpRightPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleArrowUpRightPainter oldDelegate) =>

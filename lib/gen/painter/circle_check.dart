...
class CircleCheck extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleCheckPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleCheckPainter}
/// Custom painter for [CircleCheck].
/// {@endtemplate}
class CircleCheckPainter extends CustomPainter {
  /// {@macro CircleCheckPainter}
  const CircleCheckPainter({ui.ColorFilter? colorFilter})

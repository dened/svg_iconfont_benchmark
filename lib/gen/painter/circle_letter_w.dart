...
/// {@endtemplate}
class CircleLetterW extends StatelessWidget {
  /// {@macro CircleLetterW}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleLetterWPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleLetterWPainter}
/// Custom painter for [CircleLetterW].
/// {@endtemplate}
class CircleLetterWPainter extends CustomPainter {
  /// {@macro CircleLetterWPainter}
  const CircleLetterWPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleLetterWPainter oldDelegate) =>

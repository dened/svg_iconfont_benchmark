...
/// {@endtemplate}
class CircleNumber3 extends StatelessWidget {
  /// {@macro CircleNumber3}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleNumber3Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleNumber3Painter}
/// Custom painter for [CircleNumber3].
/// {@endtemplate}
class CircleNumber3Painter extends CustomPainter {
  /// {@macro CircleNumber3Painter}
  const CircleNumber3Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleNumber3Painter oldDelegate) =>

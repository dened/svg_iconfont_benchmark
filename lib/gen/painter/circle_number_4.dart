...
/// {@endtemplate}
class CircleNumber4 extends StatelessWidget {
  /// {@macro CircleNumber4}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleNumber4Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleNumber4Painter}
/// Custom painter for [CircleNumber4].
/// {@endtemplate}
class CircleNumber4Painter extends CustomPainter {
  /// {@macro CircleNumber4Painter}
  const CircleNumber4Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleNumber4Painter oldDelegate) =>

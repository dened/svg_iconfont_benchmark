...
/// {@endtemplate}
class CircleNumber8 extends StatelessWidget {
  /// {@macro CircleNumber8}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleNumber8Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleNumber8Painter}
/// Custom painter for [CircleNumber8].
/// {@endtemplate}
class CircleNumber8Painter extends CustomPainter {
  /// {@macro CircleNumber8Painter}
  const CircleNumber8Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CircleNumber8Painter oldDelegate) =>

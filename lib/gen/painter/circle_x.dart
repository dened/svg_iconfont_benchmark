...
/// CircleX widget.
/// {@endtemplate}
class CircleX extends StatelessWidget {
  /// {@macro CircleX}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CircleXPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CircleXPainter}
/// Custom painter for [CircleX].
/// {@endtemplate}
class CircleXPainter extends CustomPainter {
  /// {@macro CircleXPainter}
  const CircleXPainter({ui.ColorFilter? colorFilter})

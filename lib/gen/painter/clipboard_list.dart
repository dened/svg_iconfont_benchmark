...
class ClipboardList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClipboardListPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClipboardListPainter}
/// Custom painter for [ClipboardList].
/// {@endtemplate}
class ClipboardListPainter extends CustomPainter {
  /// {@macro ClipboardListPainter}
  const ClipboardListPainter({ui.ColorFilter? colorFilter})

...
/// {@endtemplate}
class ClipboardSmile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClipboardSmilePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClipboardSmilePainter}
/// Custom painter for [ClipboardSmile].
/// {@endtemplate}
class ClipboardSmilePainter extends CustomPainter {
  /// {@macro ClipboardSmilePainter}
  const ClipboardSmilePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ClipboardSmilePainter oldDelegate) =>

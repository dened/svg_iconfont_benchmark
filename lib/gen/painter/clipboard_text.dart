...
class ClipboardText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClipboardTextPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClipboardTextPainter}
/// Custom painter for [ClipboardText].
/// {@endtemplate}
class ClipboardTextPainter extends CustomPainter {
  /// {@macro ClipboardTextPainter}
  const ClipboardTextPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ClipboardTextPainter oldDelegate) =>

...
/// ClipboardX widget.
/// {@endtemplate}
class ClipboardX extends StatelessWidget {
  /// {@macro ClipboardX}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClipboardXPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClipboardXPainter}
/// Custom painter for [ClipboardX].
/// {@endtemplate}
class ClipboardXPainter extends CustomPainter {
  /// {@macro ClipboardXPainter}
  const ClipboardXPainter({ui.ColorFilter? colorFilter})

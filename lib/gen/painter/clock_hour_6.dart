...
/// ClockHour6 widget.
/// {@endtemplate}
class ClockHour6 extends StatelessWidget {
  /// {@macro ClockHour6}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClockHour6Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClockHour6Painter}
/// Custom painter for [ClockHour6].
/// {@endtemplate}
class ClockHour6Painter extends CustomPainter {
  /// {@macro ClockHour6Painter}
  const ClockHour6Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ClockHour6Painter oldDelegate) =>

...
class CloudComputing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CloudComputingPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CloudComputingPainter}
/// Custom painter for [CloudComputing].
/// {@endtemplate}
class CloudComputingPainter extends CustomPainter {
  /// {@macro CloudComputingPainter}
  const CloudComputingPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CloudComputingPainter oldDelegate) =>

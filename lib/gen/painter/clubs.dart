...
class Clubs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ClubsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ClubsPainter}
/// Custom painter for [Clubs].
/// {@endtemplate}
class ClubsPainter extends CustomPainter {
  /// {@macro ClubsPainter}
  const ClubsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ClubsPainter oldDelegate) =>

...
/// CodeCircle2 widget.
/// {@endtemplate}
class CodeCircle2 extends StatelessWidget {
  /// {@macro CodeCircle2}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CodeCircle2Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CodeCircle2Painter}
/// Custom painter for [CodeCircle2].
/// {@endtemplate}
class CodeCircle2Painter extends CustomPainter {
  /// {@macro CodeCircle2Painter}
  const CodeCircle2Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CodeCircle2Painter oldDelegate) =>

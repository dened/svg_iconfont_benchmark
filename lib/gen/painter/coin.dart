...
class Coin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CoinPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CoinPainter}
/// Custom painter for [Coin].
/// {@endtemplate}
class CoinPainter extends CustomPainter {
  /// {@macro CoinPainter}
  const CoinPainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;

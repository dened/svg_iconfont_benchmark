...
/// CoinBitcoin widget.
/// {@endtemplate}
class CoinBitcoin extends StatelessWidget {
  /// {@macro CoinBitcoin}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CoinBitcoinPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CoinBitcoinPainter}
/// Custom painter for [CoinBitcoin].
/// {@endtemplate}
class CoinBitcoinPainter extends CustomPainter {
  /// {@macro CoinBitcoinPainter}
  const CoinBitcoinPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CoinBitcoinPainter oldDelegate) =>

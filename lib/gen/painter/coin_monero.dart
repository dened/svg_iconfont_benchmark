...
/// CoinMonero widget.
/// {@endtemplate}
class CoinMonero extends StatelessWidget {
  /// {@macro CoinMonero}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CoinMoneroPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CoinMoneroPainter}
/// Custom painter for [CoinMonero].
/// {@endtemplate}
class CoinMoneroPainter extends CustomPainter {
  /// {@macro CoinMoneroPainter}
  const CoinMoneroPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CoinMoneroPainter oldDelegate) =>

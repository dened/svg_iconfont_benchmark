...
/// CoinPound widget.
/// {@endtemplate}
class CoinPound extends StatelessWidget {
  /// {@macro CoinPound}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CoinPoundPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CoinPoundPainter}
/// Custom painter for [CoinPound].
/// {@endtemplate}
class CoinPoundPainter extends CustomPainter {
  /// {@macro CoinPoundPainter}
  const CoinPoundPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CoinPoundPainter oldDelegate) =>

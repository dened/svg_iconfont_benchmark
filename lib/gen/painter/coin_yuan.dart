...
/// CoinYuan widget.
/// {@endtemplate}
class CoinYuan extends StatelessWidget {
  /// {@macro CoinYuan}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CoinYuanPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CoinYuanPainter}
/// Custom painter for [CoinYuan].
/// {@endtemplate}
class CoinYuanPainter extends CustomPainter {
  /// {@macro CoinYuanPainter}
  const CoinYuanPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CoinYuanPainter oldDelegate) =>

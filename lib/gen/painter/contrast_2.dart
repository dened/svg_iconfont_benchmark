...
/// Contrast2 widget.
/// {@endtemplate}
class Contrast2 extends StatelessWidget {
  /// {@macro Contrast2}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Contrast2Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Contrast2Painter}
/// Custom painter for [Contrast2].
/// {@endtemplate}
class Contrast2Painter extends CustomPainter {
  /// {@macro Contrast2Painter}
  const Contrast2Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Contrast2Painter oldDelegate) =>

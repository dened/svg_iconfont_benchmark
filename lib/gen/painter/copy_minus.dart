...
/// CopyMinus widget.
/// {@endtemplate}
class CopyMinus extends StatelessWidget {
  /// {@macro CopyMinus}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CopyMinusPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CopyMinusPainter}
/// Custom painter for [CopyMinus].
/// {@endtemplate}
class CopyMinusPainter extends CustomPainter {
  /// {@macro CopyMinusPainter}
  const CopyMinusPainter({ui.ColorFilter? colorFilter})

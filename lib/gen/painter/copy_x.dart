...
/// CopyX widget.
/// {@endtemplate}
class CopyX extends StatelessWidget {
  /// {@macro CopyX}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CopyXPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CopyXPainter}
/// Custom painter for [CopyX].
/// {@endtemplate}
class CopyXPainter extends CustomPainter {
  /// {@macro CopyXPainter}
  const CopyXPainter({ui.ColorFilter? colorFilter})

...
class CurrentLocation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: CurrentLocationPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template CurrentLocationPainter}
/// Custom painter for [CurrentLocation].
/// {@endtemplate}
class CurrentLocationPainter extends CustomPainter {
  /// {@macro CurrentLocationPainter}
  const CurrentLocationPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(CurrentLocationPainter oldDelegate) =>

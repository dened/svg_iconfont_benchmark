...
/// {@endtemplate}
class DeviceGamepad3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DeviceGamepad3Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DeviceGamepad3Painter}
/// Custom painter for [DeviceGamepad3].
/// {@endtemplate}
class DeviceGamepad3Painter extends CustomPainter {
  /// {@macro DeviceGamepad3Painter}
  const DeviceGamepad3Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DeviceGamepad3Painter oldDelegate) =>

...
class DeviceRemote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DeviceRemotePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DeviceRemotePainter}
/// Custom painter for [DeviceRemote].
/// {@endtemplate}
class DeviceRemotePainter extends CustomPainter {
  /// {@macro DeviceRemotePainter}
  const DeviceRemotePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DeviceRemotePainter oldDelegate) =>

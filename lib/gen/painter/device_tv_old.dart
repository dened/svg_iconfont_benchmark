...
/// DeviceTvOld widget.
/// {@endtemplate}
class DeviceTvOld extends StatelessWidget {
  /// {@macro DeviceTvOld}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DeviceTvOldPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DeviceTvOldPainter}
/// Custom painter for [DeviceTvOld].
/// {@endtemplate}
class DeviceTvOldPainter extends CustomPainter {
  /// {@macro DeviceTvOldPainter}
  const DeviceTvOldPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DeviceTvOldPainter oldDelegate) =>

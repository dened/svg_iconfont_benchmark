...
/// {@endtemplate}
class DeviceVisionPro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DeviceVisionProPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DeviceVisionProPainter}
/// Custom painter for [DeviceVisionPro].
/// {@endtemplate}
class DeviceVisionProPainter extends CustomPainter {
  /// {@macro DeviceVisionProPainter}
  const DeviceVisionProPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DeviceVisionProPainter oldDelegate) =>

...
class Dice3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Dice3Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Dice3Painter}
/// Custom painter for [Dice3].
/// {@endtemplate}
class Dice3Painter extends CustomPainter {
  /// {@macro Dice3Painter}
  const Dice3Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Dice3Painter oldDelegate) =>

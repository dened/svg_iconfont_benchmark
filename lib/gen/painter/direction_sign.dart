...
class DirectionSign extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DirectionSignPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DirectionSignPainter}
/// Custom painter for [DirectionSign].
/// {@endtemplate}
class DirectionSignPainter extends CustomPainter {
  /// {@macro DirectionSignPainter}
  const DirectionSignPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DirectionSignPainter oldDelegate) =>

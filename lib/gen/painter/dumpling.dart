...
/// Dumpling widget.
/// {@endtemplate}
class Dumpling extends StatelessWidget {
  /// {@macro Dumpling}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: DumplingPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template DumplingPainter}
/// Custom painter for [Dumpling].
/// {@endtemplate}
class DumplingPainter extends CustomPainter {
  /// {@macro DumplingPainter}
  const DumplingPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(DumplingPainter oldDelegate) =>

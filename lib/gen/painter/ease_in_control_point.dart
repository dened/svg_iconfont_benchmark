...
class EaseInControlPoint extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EaseInControlPointPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EaseInControlPointPainter}
/// Custom painter for [EaseInControlPoint].
/// {@endtemplate}
class EaseInControlPointPainter extends CustomPainter {
  /// {@macro EaseInControlPointPainter}
  const EaseInControlPointPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EaseInControlPointPainter oldDelegate) =>

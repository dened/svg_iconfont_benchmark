...
/// {@endtemplate}
class EaseInOutControlPoints extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EaseInOutControlPointsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EaseInOutControlPointsPainter}
/// Custom painter for [EaseInOutControlPoints].
/// {@endtemplate}
class EaseInOutControlPointsPainter extends CustomPainter {
  /// {@macro EaseInOutControlPointsPainter}
  const EaseInOutControlPointsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EaseInOutControlPointsPainter oldDelegate) =>

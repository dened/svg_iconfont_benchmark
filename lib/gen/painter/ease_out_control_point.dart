...
class EaseOutControlPoint extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EaseOutControlPointPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EaseOutControlPointPainter}
/// Custom painter for [EaseOutControlPoint].
/// {@endtemplate}
class EaseOutControlPointPainter extends CustomPainter {
  /// {@macro EaseOutControlPointPainter}
  const EaseOutControlPointPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EaseOutControlPointPainter oldDelegate) =>

...
/// EscalatorUp widget.
/// {@endtemplate}
class EscalatorUp extends StatelessWidget {
  /// {@macro EscalatorUp}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EscalatorUpPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EscalatorUpPainter}
/// Custom painter for [EscalatorUp].
/// {@endtemplate}
class EscalatorUpPainter extends CustomPainter {
  /// {@macro EscalatorUpPainter}
  const EscalatorUpPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EscalatorUpPainter oldDelegate) =>

...
class Exchange extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ExchangePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ExchangePainter}
/// Custom painter for [Exchange].
/// {@endtemplate}
class ExchangePainter extends CustomPainter {
  /// {@macro ExchangePainter}
  const ExchangePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ExchangePainter oldDelegate) =>

...
class Explicit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ExplicitPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ExplicitPainter}
/// Custom painter for [Explicit].
/// {@endtemplate}
class ExplicitPainter extends CustomPainter {
  /// {@macro ExplicitPainter}
  const ExplicitPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ExplicitPainter oldDelegate) =>

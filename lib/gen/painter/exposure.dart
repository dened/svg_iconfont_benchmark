...
class Exposure extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: ExposurePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template ExposurePainter}
/// Custom painter for [Exposure].
/// {@endtemplate}
class ExposurePainter extends CustomPainter {
  /// {@macro ExposurePainter}
  const ExposurePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(ExposurePainter oldDelegate) =>

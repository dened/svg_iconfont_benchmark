...
/// EyeTable widget.
/// {@endtemplate}
class EyeTable extends StatelessWidget {
  /// {@macro EyeTable}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EyeTablePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EyeTablePainter}
/// Custom painter for [EyeTable].
/// {@endtemplate}
class EyeTablePainter extends CustomPainter {
  /// {@macro EyeTablePainter}
  const EyeTablePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EyeTablePainter oldDelegate) =>

...
class Eyeglass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: EyeglassPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template EyeglassPainter}
/// Custom painter for [Eyeglass].
/// {@endtemplate}
class EyeglassPainter extends CustomPainter {
  /// {@macro EyeglassPainter}
  const EyeglassPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(EyeglassPainter oldDelegate) =>

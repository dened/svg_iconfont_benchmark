...
class Favicon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FaviconPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FaviconPainter}
/// Custom painter for [Favicon].
/// {@endtemplate}
class FaviconPainter extends CustomPainter {
  /// {@macro FaviconPainter}
  const FaviconPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FaviconPainter oldDelegate) =>

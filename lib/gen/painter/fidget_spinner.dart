...
/// {@endtemplate}
class FidgetSpinner extends StatelessWidget {
  /// {@macro FidgetSpinner}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FidgetSpinnerPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FidgetSpinnerPainter}
/// Custom painter for [FidgetSpinner].
/// {@endtemplate}
class FidgetSpinnerPainter extends CustomPainter {
  /// {@macro FidgetSpinnerPainter}
  const FidgetSpinnerPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FidgetSpinnerPainter oldDelegate) =>

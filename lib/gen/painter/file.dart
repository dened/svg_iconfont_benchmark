...
class File extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FilePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FilePainter}
/// Custom painter for [File].
/// {@endtemplate}
class FilePainter extends CustomPainter {
  /// {@macro FilePainter}
  const FilePainter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;

...
/// {@endtemplate}
class FileAnalytics extends StatelessWidget {
  /// {@macro FileAnalytics}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileAnalyticsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileAnalyticsPainter}
/// Custom painter for [FileAnalytics].
/// {@endtemplate}
class FileAnalyticsPainter extends CustomPainter {
  /// {@macro FileAnalyticsPainter}
  const FileAnalyticsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileAnalyticsPainter oldDelegate) =>

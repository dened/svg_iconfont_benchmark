...
/// FileCode widget.
/// {@endtemplate}
class FileCode extends StatelessWidget {
  /// {@macro FileCode}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileCodePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileCodePainter}
/// Custom painter for [FileCode].
/// {@endtemplate}
class FileCodePainter extends CustomPainter {
  /// {@macro FileCodePainter}
  const FileCodePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileCodePainter oldDelegate) =>

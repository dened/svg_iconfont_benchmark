...
/// FileCode2 widget.
/// {@endtemplate}
class FileCode2 extends StatelessWidget {
  /// {@macro FileCode2}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileCode2Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileCode2Painter}
/// Custom painter for [FileCode2].
/// {@endtemplate}
class FileCode2Painter extends CustomPainter {
  /// {@macro FileCode2Painter}
  const FileCode2Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileCode2Painter oldDelegate) =>

...
/// FileCv widget.
/// {@endtemplate}
class FileCv extends StatelessWidget {
  /// {@macro FileCv}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileCvPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileCvPainter}
/// Custom painter for [FileCv].
/// {@endtemplate}
class FileCvPainter extends CustomPainter {
  /// {@macro FileCvPainter}
  const FileCvPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileCvPainter oldDelegate) =>

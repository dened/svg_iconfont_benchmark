...
/// FileDollar widget.
/// {@endtemplate}
class FileDollar extends StatelessWidget {
  /// {@macro FileDollar}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileDollarPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileDollarPainter}
/// Custom painter for [FileDollar].
/// {@endtemplate}
class FileDollarPainter extends CustomPainter {
  /// {@macro FileDollarPainter}
  const FileDollarPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileDollarPainter oldDelegate) =>

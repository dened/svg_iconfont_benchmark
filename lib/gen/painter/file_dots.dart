...
/// FileDots widget.
/// {@endtemplate}
class FileDots extends StatelessWidget {
  /// {@macro FileDots}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileDotsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileDotsPainter}
/// Custom painter for [FileDots].
/// {@endtemplate}
class FileDotsPainter extends CustomPainter {
  /// {@macro FileDotsPainter}
  const FileDotsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileDotsPainter oldDelegate) =>

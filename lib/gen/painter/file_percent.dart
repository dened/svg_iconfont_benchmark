...
class FilePercent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FilePercentPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FilePercentPainter}
/// Custom painter for [FilePercent].
/// {@endtemplate}
class FilePercentPainter extends CustomPainter {
  /// {@macro FilePercentPainter}
  const FilePercentPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FilePercentPainter oldDelegate) =>

...
/// FileScissors widget.
/// {@endtemplate}
class FileScissors extends StatelessWidget {
  /// {@macro FileScissors}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileScissorsPainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileScissorsPainter}
/// Custom painter for [FileScissors].
/// {@endtemplate}
class FileScissorsPainter extends CustomPainter {
  /// {@macro FileScissorsPainter}
  const FileScissorsPainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileScissorsPainter oldDelegate) =>

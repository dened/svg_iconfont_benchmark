...
/// FileTime widget.
/// {@endtemplate}
class FileTime extends StatelessWidget {
  /// {@macro FileTime}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: FileTimePainter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template FileTimePainter}
/// Custom painter for [FileTime].
/// {@endtemplate}
class FileTimePainter extends CustomPainter {
  /// {@macro FileTimePainter}
  const FileTimePainter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(FileTimePainter oldDelegate) =>

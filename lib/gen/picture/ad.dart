...
/// Ad widget.
/// {@endtemplate}
class Ad extends LeafRenderObjectWidget {
  /// {@macro Ad}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => AdRenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, AdRenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class AdRenderObject extends RenderBox {
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Ad.svgSize.width;
    final desiredHeight = _height ?? Ad.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Ad.svgSize.width == 0 || Ad.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

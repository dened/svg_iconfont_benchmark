...
/// Adjustments widget.
/// {@endtemplate}
class Adjustments extends LeafRenderObjectWidget {
  /// {@macro Adjustments}
  ...
  void updateRenderObject(
    ...
    AdjustmentsRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AdjustmentsRenderObject extends RenderBox {
  AdjustmentsRenderObject();

  final _painter = _AdjustmentsPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Adjustments.svgSize.width;
    final desiredHeight = _height ?? Adjustments.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Adjustments.svgSize.width == 0 || Adjustments.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

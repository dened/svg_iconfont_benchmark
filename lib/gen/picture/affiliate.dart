...
/// Affiliate widget.
/// {@endtemplate}
class Affiliate extends LeafRenderObjectWidget {
  /// {@macro Affiliate}
  ...
  void updateRenderObject(
    ...
    AffiliateRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AffiliateRenderObject extends RenderBox {
  AffiliateRenderObject();

  final _painter = _AffiliatePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Affiliate.svgSize.width;
    final desiredHeight = _height ?? Affiliate.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Affiliate.svgSize.width == 0 || Affiliate.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// AlarmPlus widget.
/// {@endtemplate}
class AlarmPlus extends LeafRenderObjectWidget {
  /// {@macro AlarmPlus}
  const AlarmPlus({super.key, this.width, this.height, this.colorFilter});
  ...
  void updateRenderObject(
    ...
    AlarmPlusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlarmPlusRenderObject extends RenderBox {
  AlarmPlusRenderObject();

  final _painter = _AlarmPlusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlarmPlus.svgSize.width;
    final desiredHeight = _height ?? AlarmPlus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlarmPlus.svgSize.width == 0 || AlarmPlus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / AlarmPlus.svgSize.width,
      size.height / AlarmPlus.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - AlarmPlus.svgSize.width * scale) / 2;
    final dy = (size.height - AlarmPlus.svgSize.height * scale) / 2;
...
class _AlarmPlusPainter {
  ...
  void _createPicture() {
    ...
    final path_0 = Path()
      ...
      ..lineTo(11, 14)
      ..lineTo(11, 15)
      ..lineTo(11.007, 15.117)
      ..cubicTo(11.0695, 15.6424, 11.5304, 16.0282, 12.0586, 15.9972)
      ..cubicTo(12.5868, 15.9662, 12.9994, 15.5291, 13, 15)
      ..lineTo(13, 14)
      ..lineTo(14, 14)
      ...
      ..lineTo(13, 12)
      ..lineTo(13, 11)
      ..lineTo(12.993, 10.883)
      ..cubicTo(12.9337, 10.3795, 12.507, 10.0001, 12, 10)
      ..close();

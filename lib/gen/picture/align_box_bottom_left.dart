...
/// {@endtemplate}
class AlignBoxBottomLeft extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) =>
      AlignBoxBottomLeftRenderObject()
        ..width = width
        ..height = height
  ...
  void updateRenderObject(
    ...
    AlignBoxBottomLeftRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxBottomLeftRenderObject extends RenderBox {
  AlignBoxBottomLeftRenderObject();

  final _painter = _AlignBoxBottomLeftPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxBottomLeft.svgSize.width;
    final desiredHeight = _height ?? AlignBoxBottomLeft.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxBottomLeft.svgSize.width == 0 ||
        AlignBoxBottomLeft.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _AlignBoxBottomLeftPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

...
/// {@endtemplate}
class AlignBoxCenterMiddle extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) =>
      AlignBoxCenterMiddleRenderObject()
        ..width = width
        ..height = height
  ...
  void updateRenderObject(
    ...
    AlignBoxCenterMiddleRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxCenterMiddleRenderObject extends RenderBox {
  AlignBoxCenterMiddleRenderObject();

  final _painter = _AlignBoxCenterMiddlePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxCenterMiddle.svgSize.width;
    final desiredHeight = _height ?? AlignBoxCenterMiddle.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxCenterMiddle.svgSize.width == 0 ||
        AlignBoxCenterMiddle.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _AlignBoxCenterMiddlePainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

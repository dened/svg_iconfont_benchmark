...
/// {@endtemplate}
class AlignBoxLeftBottom extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) =>
      AlignBoxLeftBottomRenderObject()
        ..width = width
        ..height = height
  ...
  void updateRenderObject(
    ...
    AlignBoxLeftBottomRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxLeftBottomRenderObject extends RenderBox {
  AlignBoxLeftBottomRenderObject();

  final _painter = _AlignBoxLeftBottomPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxLeftBottom.svgSize.width;
    final desiredHeight = _height ?? AlignBoxLeftBottom.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxLeftBottom.svgSize.width == 0 ||
        AlignBoxLeftBottom.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _AlignBoxLeftBottomPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

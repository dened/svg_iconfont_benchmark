...
/// {@endtemplate}
class AlignBoxLeftTop extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    AlignBoxLeftTopRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxLeftTopRenderObject extends RenderBox {
  AlignBoxLeftTopRenderObject();

  final _painter = _AlignBoxLeftTopPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxLeftTop.svgSize.width;
    final desiredHeight = _height ?? AlignBoxLeftTop.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxLeftTop.svgSize.width == 0 ||
        AlignBoxLeftTop.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class AlignBoxRightTop extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    AlignBoxRightTopRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxRightTopRenderObject extends RenderBox {
  AlignBoxRightTopRenderObject();

  final _painter = _AlignBoxRightTopPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxRightTop.svgSize.width;
    final desiredHeight = _height ?? AlignBoxRightTop.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxRightTop.svgSize.width == 0 ||
        AlignBoxRightTop.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _AlignBoxRightTopPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

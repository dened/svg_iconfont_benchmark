...
/// {@endtemplate}
class AlignBoxTopLeft extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    AlignBoxTopLeftRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AlignBoxTopLeftRenderObject extends RenderBox {
  AlignBoxTopLeftRenderObject();

  final _painter = _AlignBoxTopLeftPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? AlignBoxTopLeft.svgSize.width;
    final desiredHeight = _height ?? AlignBoxTopLeft.svgSize.height;
  ...
  void performLayout() {
    ...
    if (AlignBoxTopLeft.svgSize.width == 0 ||
        AlignBoxTopLeft.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

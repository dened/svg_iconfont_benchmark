...
/// Apple widget.
/// {@endtemplate}
class Apple extends LeafRenderObjectWidget {
  /// {@macro Apple}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => AppleRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    AppleRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AppleRenderObject extends RenderBox {
  AppleRenderObject();

  final _painter = _ApplePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Apple.svgSize.width;
    final desiredHeight = _height ?? Apple.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Apple.svgSize.width == 0 || Apple.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

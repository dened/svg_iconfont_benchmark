...
/// Archive widget.
/// {@endtemplate}
class Archive extends LeafRenderObjectWidget {
  /// {@macro Archive}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => ArchiveRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    ArchiveRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArchiveRenderObject extends RenderBox {
  ArchiveRenderObject();

  final _painter = _ArchivePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Archive.svgSize.width;
    final desiredHeight = _height ?? Archive.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Archive.svgSize.width == 0 || Archive.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

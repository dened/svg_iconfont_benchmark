...
/// {@endtemplate}
class ArrowAutofitDown extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowAutofitDownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowAutofitDownRenderObject extends RenderBox {
  ArrowAutofitDownRenderObject();

  final _painter = _ArrowAutofitDownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowAutofitDown.svgSize.width;
    final desiredHeight = _height ?? ArrowAutofitDown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowAutofitDown.svgSize.width == 0 ||
        ArrowAutofitDown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _ArrowAutofitDownPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

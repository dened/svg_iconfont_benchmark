...
/// {@endtemplate}
class ArrowAutofitHeight extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) =>
      ArrowAutofitHeightRenderObject()
        ..width = width
        ..height = height
  ...
  void updateRenderObject(
    ...
    ArrowAutofitHeightRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowAutofitHeightRenderObject extends RenderBox {
  ArrowAutofitHeightRenderObject();

  final _painter = _ArrowAutofitHeightPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowAutofitHeight.svgSize.width;
    final desiredHeight = _height ?? ArrowAutofitHeight.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowAutofitHeight.svgSize.width == 0 ||
        ArrowAutofitHeight.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _ArrowAutofitHeightPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

...
/// {@endtemplate}
class ArrowBigLeftLines extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowBigLeftLinesRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowBigLeftLinesRenderObject extends RenderBox {
  ArrowBigLeftLinesRenderObject();

  final _painter = _ArrowBigLeftLinesPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowBigLeftLines.svgSize.width;
    final desiredHeight = _height ?? ArrowBigLeftLines.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowBigLeftLines.svgSize.width == 0 ||
        ArrowBigLeftLines.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _ArrowBigLeftLinesPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

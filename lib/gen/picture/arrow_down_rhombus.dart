...
/// {@endtemplate}
class ArrowDownRhombus extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowDownRhombusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowDownRhombusRenderObject extends RenderBox {
  ArrowDownRhombusRenderObject();

  final _painter = _ArrowDownRhombusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowDownRhombus.svgSize.width;
    final desiredHeight = _height ?? ArrowDownRhombus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowDownRhombus.svgSize.width == 0 ||
        ArrowDownRhombus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _ArrowDownRhombusPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

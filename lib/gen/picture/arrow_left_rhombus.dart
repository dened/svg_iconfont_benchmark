...
/// {@endtemplate}
class ArrowLeftRhombus extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowLeftRhombusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowLeftRhombusRenderObject extends RenderBox {
  ArrowLeftRhombusRenderObject();

  final _painter = _ArrowLeftRhombusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowLeftRhombus.svgSize.width;
    final desiredHeight = _height ?? ArrowLeftRhombus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowLeftRhombus.svgSize.width == 0 ||
        ArrowLeftRhombus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _ArrowLeftRhombusPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

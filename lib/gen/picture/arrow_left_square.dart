...
/// {@endtemplate}
class ArrowLeftSquare extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowLeftSquareRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowLeftSquareRenderObject extends RenderBox {
  ArrowLeftSquareRenderObject();

  final _painter = _ArrowLeftSquarePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowLeftSquare.svgSize.width;
    final desiredHeight = _height ?? ArrowLeftSquare.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowLeftSquare.svgSize.width == 0 ||
        ArrowLeftSquare.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class ArrowMoveRight extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    ArrowMoveRightRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowMoveRightRenderObject extends RenderBox {
  ArrowMoveRightRenderObject();

  final _painter = _ArrowMoveRightPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowMoveRight.svgSize.width;
    final desiredHeight = _height ?? ArrowMoveRight.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowMoveRight.svgSize.width == 0 ||
        ArrowMoveRight.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

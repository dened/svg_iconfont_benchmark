...
/// {@endtemplate}
class ArrowUpCircle extends LeafRenderObjectWidget {
  /// {@macro ArrowUpCircle}
  ...
  void updateRenderObject(
    ...
    ArrowUpCircleRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowUpCircleRenderObject extends RenderBox {
  ArrowUpCircleRenderObject();

  final _painter = _ArrowUpCirclePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowUpCircle.svgSize.width;
    final desiredHeight = _height ?? ArrowUpCircle.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ArrowUpCircle.svgSize.width == 0 || ArrowUpCircle.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

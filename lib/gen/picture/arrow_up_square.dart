...
/// {@endtemplate}
class ArrowUpSquare extends LeafRenderObjectWidget {
  /// {@macro ArrowUpSquare}
  ...
  void updateRenderObject(
    ...
    ArrowUpSquareRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ArrowUpSquareRenderObject extends RenderBox {
  ArrowUpSquareRenderObject();

  final _painter = _ArrowUpSquarePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ArrowUpSquare.svgSize.width;
  ...
  void performLayout() {
    ...
    if (ArrowUpSquare.svgSize.width == 0 || ArrowUpSquare.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

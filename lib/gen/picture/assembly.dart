...
/// Assembly widget.
/// {@endtemplate}
class Assembly extends LeafRenderObjectWidget {
  /// {@macro Assembly}
  ...
  void updateRenderObject(
    ...
    AssemblyRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AssemblyRenderObject extends RenderBox {
  AssemblyRenderObject();

  final _painter = _AssemblyPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Assembly.svgSize.width;
    final desiredHeight = _height ?? Assembly.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Assembly.svgSize.width == 0 || Assembly.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

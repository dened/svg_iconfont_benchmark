...
/// Asset widget.
/// {@endtemplate}
class Asset extends LeafRenderObjectWidget {
  /// {@macro Asset}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => AssetRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    AssetRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class AssetRenderObject extends RenderBox {
  AssetRenderObject();

  final _painter = _AssetPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Asset.svgSize.width;
    final desiredHeight = _height ?? Asset.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Asset.svgSize.width == 0 || Asset.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

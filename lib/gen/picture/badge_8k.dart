...
/// Badge8k widget.
/// {@endtemplate}
class Badge8k extends LeafRenderObjectWidget {
  /// {@macro Badge8k}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Badge8kRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Badge8kRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Badge8kRenderObject extends RenderBox {
  Badge8kRenderObject();

  final _painter = _Badge8kPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Badge8k.svgSize.width;
    final desiredHeight = _height ?? Badge8k.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Badge8k.svgSize.width == 0 || Badge8k.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

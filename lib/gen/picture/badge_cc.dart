...
/// BadgeCc widget.
/// {@endtemplate}
class BadgeCc extends LeafRenderObjectWidget {
  /// {@macro BadgeCc}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BadgeCcRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    BadgeCcRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BadgeCcRenderObject extends RenderBox {
  BadgeCcRenderObject();

  final _painter = _BadgeCcPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BadgeCc.svgSize.width;
    final desiredHeight = _height ?? BadgeCc.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BadgeCc.svgSize.width == 0 || BadgeCc.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

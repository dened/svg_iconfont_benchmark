...
/// BadgeTm widget.
/// {@endtemplate}
class BadgeTm extends LeafRenderObjectWidget {
  /// {@macro BadgeTm}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BadgeTmRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    BadgeTmRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BadgeTmRenderObject extends RenderBox {
  BadgeTmRenderObject();

  final _painter = _BadgeTmPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BadgeTm.svgSize.width;
    final desiredHeight = _height ?? BadgeTm.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BadgeTm.svgSize.width == 0 || BadgeTm.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

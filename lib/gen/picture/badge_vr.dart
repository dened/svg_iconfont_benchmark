...
/// BadgeVr widget.
/// {@endtemplate}
class BadgeVr extends LeafRenderObjectWidget {
  /// {@macro BadgeVr}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BadgeVrRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    BadgeVrRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BadgeVrRenderObject extends RenderBox {
  BadgeVrRenderObject();

  final _painter = _BadgeVrPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BadgeVr.svgSize.width;
    final desiredHeight = _height ?? BadgeVr.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BadgeVr.svgSize.width == 0 || BadgeVr.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

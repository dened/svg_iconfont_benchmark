...
/// BarrierBlock widget.
/// {@endtemplate}
class BarrierBlock extends LeafRenderObjectWidget {
  /// {@macro BarrierBlock}
  ...
  void updateRenderObject(
    ...
    BarrierBlockRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BarrierBlockRenderObject extends RenderBox {
  BarrierBlockRenderObject();

  final _painter = _BarrierBlockPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BarrierBlock.svgSize.width;
    final desiredHeight = _height ?? BarrierBlock.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BarrierBlock.svgSize.width == 0 || BarrierBlock.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

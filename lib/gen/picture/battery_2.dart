...
/// Battery2 widget.
/// {@endtemplate}
class Battery2 extends LeafRenderObjectWidget {
  /// {@macro Battery2}
  ...
  void updateRenderObject(
    ...
    Battery2RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Battery2RenderObject extends RenderBox {
  Battery2RenderObject();

  final _painter = _Battery2Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Battery2.svgSize.width;
    final desiredHeight = _height ?? Battery2.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Battery2.svgSize.width == 0 || Battery2.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

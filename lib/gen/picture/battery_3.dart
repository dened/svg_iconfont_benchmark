...
/// Battery3 widget.
/// {@endtemplate}
class Battery3 extends LeafRenderObjectWidget {
  /// {@macro Battery3}
  const Battery3({super.key, this.width, this.height, this.colorFilter});
  ...
  void updateRenderObject(
    ...
    Battery3RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Battery3RenderObject extends RenderBox {
  Battery3RenderObject();

  final _painter = _Battery3Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Battery3.svgSize.width;
    final desiredHeight = _height ?? Battery3.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Battery3.svgSize.width == 0 || Battery3.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / Battery3.svgSize.width,
      size.height / Battery3.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - Battery3.svgSize.width * scale) / 2;
    final dy = (size.height - Battery3.svgSize.height * scale) / 2;

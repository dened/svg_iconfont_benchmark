...
/// {@endtemplate}
class BatteryVertical4 extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    BatteryVertical4RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BatteryVertical4RenderObject extends RenderBox {
  BatteryVertical4RenderObject();

  final _painter = _BatteryVertical4Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BatteryVertical4.svgSize.width;
    final desiredHeight = _height ?? BatteryVertical4.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BatteryVertical4.svgSize.width == 0 ||
        BatteryVertical4.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _BatteryVertical4Painter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

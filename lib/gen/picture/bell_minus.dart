...
/// BellMinus widget.
/// {@endtemplate}
class BellMinus extends LeafRenderObjectWidget {
  /// {@macro BellMinus}
  ...
  void updateRenderObject(
    ...
    BellMinusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BellMinusRenderObject extends RenderBox {
  BellMinusRenderObject();

  final _painter = _BellMinusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BellMinus.svgSize.width;
    final desiredHeight = _height ?? BellMinus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BellMinus.svgSize.width == 0 || BellMinus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// BellX widget.
/// {@endtemplate}
class BellX extends LeafRenderObjectWidget {
  /// {@macro BellX}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BellXRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    BellXRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BellXRenderObject extends RenderBox {
  BellXRenderObject();

  final _painter = _BellXPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BellX.svgSize.width;
    final desiredHeight = _height ?? BellX.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BellX.svgSize.width == 0 || BellX.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

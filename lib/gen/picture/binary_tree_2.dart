...
/// BinaryTree2 widget.
/// {@endtemplate}
class BinaryTree2 extends LeafRenderObjectWidget {
  /// {@macro BinaryTree2}
  ...
  void updateRenderObject(
    ...
    BinaryTree2RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BinaryTree2RenderObject extends RenderBox {
  BinaryTree2RenderObject();

  final _painter = _BinaryTree2Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BinaryTree2.svgSize.width;
    final desiredHeight = _height ?? BinaryTree2.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BinaryTree2.svgSize.width == 0 || BinaryTree2.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

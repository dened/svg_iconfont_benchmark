...
/// Binoculars widget.
/// {@endtemplate}
class Binoculars extends LeafRenderObjectWidget {
  /// {@macro Binoculars}
  ...
  void updateRenderObject(
    ...
    BinocularsRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BinocularsRenderObject extends RenderBox {
  BinocularsRenderObject();

  final _painter = _BinocularsPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Binoculars.svgSize.width;
    final desiredHeight = _height ?? Binoculars.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Binoculars.svgSize.width == 0 || Binoculars.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

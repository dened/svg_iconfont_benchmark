...
class Boom extends LeafRenderObjectWidget {
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BoomRenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, BoomRenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class BoomRenderObject extends RenderBox {
  BoomRenderObject();

  final _painter = _BoomPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Boom.svgSize.width;
    final desiredHeight = _height ?? Boom.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Boom.svgSize.width == 0 || Boom.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class BoxAlignBottomLeft extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) =>
      BoxAlignBottomLeftRenderObject()
        ..width = width
        ..height = height
  ...
  void updateRenderObject(
    ...
    BoxAlignBottomLeftRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BoxAlignBottomLeftRenderObject extends RenderBox {
  BoxAlignBottomLeftRenderObject();

  final _painter = _BoxAlignBottomLeftPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BoxAlignBottomLeft.svgSize.width;
    final desiredHeight = _height ?? BoxAlignBottomLeft.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BoxAlignBottomLeft.svgSize.width == 0 ||
        BoxAlignBottomLeft.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _BoxAlignBottomLeftPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

...
/// BoxAlignLeft widget.
/// {@endtemplate}
class BoxAlignLeft extends LeafRenderObjectWidget {
  /// {@macro BoxAlignLeft}
  ...
  void updateRenderObject(
    ...
    BoxAlignLeftRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BoxAlignLeftRenderObject extends RenderBox {
  BoxAlignLeftRenderObject();

  final _painter = _BoxAlignLeftPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BoxAlignLeft.svgSize.width;
    final desiredHeight = _height ?? BoxAlignLeft.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BoxAlignLeft.svgSize.width == 0 || BoxAlignLeft.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// BoxAlignTop widget.
/// {@endtemplate}
class BoxAlignTop extends LeafRenderObjectWidget {
  /// {@macro BoxAlignTop}
  ...
  void updateRenderObject(
    ...
    BoxAlignTopRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BoxAlignTopRenderObject extends RenderBox {
  BoxAlignTopRenderObject();

  final _painter = _BoxAlignTopPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BoxAlignTop.svgSize.width;
    final desiredHeight = _height ?? BoxAlignTop.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BoxAlignTop.svgSize.width == 0 || BoxAlignTop.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// BrandDiscord widget.
/// {@endtemplate}
class BrandDiscord extends LeafRenderObjectWidget {
  /// {@macro BrandDiscord}
  ...
  void updateRenderObject(
    ...
    BrandDiscordRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BrandDiscordRenderObject extends RenderBox {
  BrandDiscordRenderObject();

  final _painter = _BrandDiscordPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BrandDiscord.svgSize.width;
    final desiredHeight = _height ?? BrandDiscord.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BrandDiscord.svgSize.width == 0 || BrandDiscord.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

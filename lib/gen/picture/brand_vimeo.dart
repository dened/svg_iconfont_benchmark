...
/// BrandVimeo widget.
/// {@endtemplate}
class BrandVimeo extends LeafRenderObjectWidget {
  /// {@macro BrandVimeo}
  ...
  void updateRenderObject(
    ...
    BrandVimeoRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BrandVimeoRenderObject extends RenderBox {
  BrandVimeoRenderObject();

  final _painter = _BrandVimeoPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BrandVimeo.svgSize.width;
    final desiredHeight = _height ?? BrandVimeo.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BrandVimeo.svgSize.width == 0 || BrandVimeo.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

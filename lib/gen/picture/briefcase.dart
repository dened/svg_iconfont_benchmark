...
/// Briefcase widget.
/// {@endtemplate}
class Briefcase extends LeafRenderObjectWidget {
  /// {@macro Briefcase}
  ...
  void updateRenderObject(
    ...
    BriefcaseRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BriefcaseRenderObject extends RenderBox {
  BriefcaseRenderObject();

  final _painter = _BriefcasePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Briefcase.svgSize.width;
    final desiredHeight = _height ?? Briefcase.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Briefcase.svgSize.width == 0 || Briefcase.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

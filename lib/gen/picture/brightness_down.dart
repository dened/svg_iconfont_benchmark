...
/// {@endtemplate}
class BrightnessDown extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    BrightnessDownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BrightnessDownRenderObject extends RenderBox {
  BrightnessDownRenderObject();

  final _painter = _BrightnessDownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BrightnessDown.svgSize.width;
    final desiredHeight = _height ?? BrightnessDown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BrightnessDown.svgSize.width == 0 ||
        BrightnessDown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

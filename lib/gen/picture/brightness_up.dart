...
/// BrightnessUp widget.
/// {@endtemplate}
class BrightnessUp extends LeafRenderObjectWidget {
  /// {@macro BrightnessUp}
  ...
  void updateRenderObject(
    ...
    BrightnessUpRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class BrightnessUpRenderObject extends RenderBox {
  BrightnessUpRenderObject();

  final _painter = _BrightnessUpPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? BrightnessUp.svgSize.width;
    final desiredHeight = _height ?? BrightnessUp.svgSize.height;
  ...
  void performLayout() {
    ...
    if (BrightnessUp.svgSize.width == 0 || BrightnessUp.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Bulb widget.
/// {@endtemplate}
class Bulb extends LeafRenderObjectWidget {
  /// {@macro Bulb}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => BulbRenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, BulbRenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class BulbRenderObject extends RenderBox {
  BulbRenderObject();

  final _painter = _BulbPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Bulb.svgSize.width;
    final desiredHeight = _height ?? Bulb.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Bulb.svgSize.width == 0 || Bulb.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

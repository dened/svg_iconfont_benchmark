...
/// CalendarWeek widget.
/// {@endtemplate}
class CalendarWeek extends LeafRenderObjectWidget {
  /// {@macro CalendarWeek}
  ...
  void updateRenderObject(
    ...
    CalendarWeekRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CalendarWeekRenderObject extends RenderBox {
  CalendarWeekRenderObject();

  final _painter = _CalendarWeekPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CalendarWeek.svgSize.width;
    final desiredHeight = _height ?? CalendarWeek.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CalendarWeek.svgSize.width == 0 || CalendarWeek.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

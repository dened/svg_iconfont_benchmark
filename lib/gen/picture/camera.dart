...
/// Camera widget.
/// {@endtemplate}
class Camera extends LeafRenderObjectWidget {
  /// {@macro Camera}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => CameraRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    CameraRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CameraRenderObject extends RenderBox {
  CameraRenderObject();

  final _painter = _CameraPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Camera.svgSize.width;
    final desiredHeight = _height ?? Camera.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Camera.svgSize.width == 0 || Camera.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

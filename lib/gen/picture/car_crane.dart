...
/// CarCrane widget.
/// {@endtemplate}
class CarCrane extends LeafRenderObjectWidget {
  /// {@macro CarCrane}
  ...
  void updateRenderObject(
    ...
    CarCraneRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CarCraneRenderObject extends RenderBox {
  CarCraneRenderObject();

  final _painter = _CarCranePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CarCrane.svgSize.width;
    final desiredHeight = _height ?? CarCrane.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CarCrane.svgSize.width == 0 || CarCrane.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class CaretLeftRight extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    CaretLeftRightRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CaretLeftRightRenderObject extends RenderBox {
  CaretLeftRightRenderObject();

  final _painter = _CaretLeftRightPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CaretLeftRight.svgSize.width;
    final desiredHeight = _height ?? CaretLeftRight.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CaretLeftRight.svgSize.width == 0 ||
        CaretLeftRight.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

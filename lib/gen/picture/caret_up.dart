...
/// CaretUp widget.
/// {@endtemplate}
class CaretUp extends LeafRenderObjectWidget {
  /// {@macro CaretUp}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => CaretUpRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    CaretUpRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CaretUpRenderObject extends RenderBox {
  CaretUpRenderObject();

  final _painter = _CaretUpPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CaretUp.svgSize.width;
    final desiredHeight = _height ?? CaretUp.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CaretUp.svgSize.width == 0 || CaretUp.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

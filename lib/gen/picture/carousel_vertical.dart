...
/// {@endtemplate}
class CarouselVertical extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    CarouselVerticalRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CarouselVerticalRenderObject extends RenderBox {
  CarouselVerticalRenderObject();

  final _painter = _CarouselVerticalPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CarouselVertical.svgSize.width;
    final desiredHeight = _height ?? CarouselVertical.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CarouselVertical.svgSize.width == 0 ||
        CarouselVertical.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _CarouselVerticalPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

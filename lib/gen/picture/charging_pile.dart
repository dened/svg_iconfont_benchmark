...
/// ChargingPile widget.
/// {@endtemplate}
class ChargingPile extends LeafRenderObjectWidget {
  /// {@macro ChargingPile}
  ...
  void updateRenderObject(
    ...
    ChargingPileRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChargingPileRenderObject extends RenderBox {
  ChargingPileRenderObject();

  final _painter = _ChargingPilePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChargingPile.svgSize.width;
    final desiredHeight = _height ?? ChargingPile.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChargingPile.svgSize.width == 0 || ChargingPile.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// ChartBubble widget.
/// {@endtemplate}
class ChartBubble extends LeafRenderObjectWidget {
  /// {@macro ChartBubble}
  ...
  void updateRenderObject(
    ...
    ChartBubbleRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChartBubbleRenderObject extends RenderBox {
  ChartBubbleRenderObject();

  final _painter = _ChartBubblePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChartBubble.svgSize.width;
    final desiredHeight = _height ?? ChartBubble.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChartBubble.svgSize.width == 0 || ChartBubble.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

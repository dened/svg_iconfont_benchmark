...
/// ChartDonut widget.
/// {@endtemplate}
class ChartDonut extends LeafRenderObjectWidget {
  /// {@macro ChartDonut}
  ...
  void updateRenderObject(
    ...
    ChartDonutRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChartDonutRenderObject extends RenderBox {
  ChartDonutRenderObject();

  final _painter = _ChartDonutPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChartDonut.svgSize.width;
    final desiredHeight = _height ?? ChartDonut.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChartDonut.svgSize.width == 0 || ChartDonut.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

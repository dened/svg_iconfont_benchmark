...
/// ChartDots3 widget.
/// {@endtemplate}
class ChartDots3 extends LeafRenderObjectWidget {
  /// {@macro ChartDots3}
  ...
  void updateRenderObject(
    ...
    ChartDots3RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChartDots3RenderObject extends RenderBox {
  ChartDots3RenderObject();

  final _painter = _ChartDots3Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChartDots3.svgSize.width;
    final desiredHeight = _height ?? ChartDots3.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChartDots3.svgSize.width == 0 || ChartDots3.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

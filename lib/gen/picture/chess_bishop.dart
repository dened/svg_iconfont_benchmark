...
/// ChessBishop widget.
/// {@endtemplate}
class ChessBishop extends LeafRenderObjectWidget {
  /// {@macro ChessBishop}
  ...
  void updateRenderObject(
    ...
    ChessBishopRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChessBishopRenderObject extends RenderBox {
  ChessBishopRenderObject();

  final _painter = _ChessBishopPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChessBishop.svgSize.width;
    final desiredHeight = _height ?? ChessBishop.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChessBishop.svgSize.width == 0 || ChessBishop.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class ChristmasTree extends LeafRenderObjectWidget {
  /// {@macro ChristmasTree}
  ...
  void updateRenderObject(
    ...
    ChristmasTreeRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ChristmasTreeRenderObject extends RenderBox {
  ChristmasTreeRenderObject();

  final _painter = _ChristmasTreePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ChristmasTree.svgSize.width;
    final desiredHeight = _height ?? ChristmasTree.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ChristmasTree.svgSize.width == 0 || ChristmasTree.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

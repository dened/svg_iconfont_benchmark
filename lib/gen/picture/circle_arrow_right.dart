...
/// {@endtemplate}
class CircleArrowRight extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    CircleArrowRightRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleArrowRightRenderObject extends RenderBox {
  CircleArrowRightRenderObject();

  final _painter = _CircleArrowRightPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleArrowRight.svgSize.width;
    final desiredHeight = _height ?? CircleArrowRight.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleArrowRight.svgSize.width == 0 ||
        CircleArrowRight.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
...
class _CircleArrowRightPainter {
  ui.Picture? _picture;
  ui.ColorFilter? _colorFilter;

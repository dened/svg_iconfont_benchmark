...
/// {@endtemplate}
class CircleArrowUp extends LeafRenderObjectWidget {
  /// {@macro CircleArrowUp}
  ...
  void updateRenderObject(
    ...
    CircleArrowUpRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleArrowUpRenderObject extends RenderBox {
  CircleArrowUpRenderObject();

  final _painter = _CircleArrowUpPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleArrowUp.svgSize.width;
    final desiredHeight = _height ?? CircleArrowUp.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleArrowUp.svgSize.width == 0 || CircleArrowUp.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

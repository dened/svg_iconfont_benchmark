...
/// {@endtemplate}
class CircleCaretDown extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    CircleCaretDownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleCaretDownRenderObject extends RenderBox {
  CircleCaretDownRenderObject();

  final _painter = _CircleCaretDownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleCaretDown.svgSize.width;
    final desiredHeight = _height ?? CircleCaretDown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleCaretDown.svgSize.width == 0 ||
        CircleCaretDown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

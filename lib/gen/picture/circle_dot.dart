...
/// CircleDot widget.
/// {@endtemplate}
class CircleDot extends LeafRenderObjectWidget {
  /// {@macro CircleDot}
  ...
  void updateRenderObject(
    ...
    CircleDotRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleDotRenderObject extends RenderBox {
  CircleDotRenderObject();

  final _painter = _CircleDotPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleDot.svgSize.width;
    final desiredHeight = _height ?? CircleDot.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleDot.svgSize.width == 0 || CircleDot.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

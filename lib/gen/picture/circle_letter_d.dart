...
/// {@endtemplate}
class CircleLetterD extends LeafRenderObjectWidget {
  /// {@macro CircleLetterD}
  ...
  void updateRenderObject(
    ...
    CircleLetterDRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleLetterDRenderObject extends RenderBox {
  CircleLetterDRenderObject();

  final _painter = _CircleLetterDPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleLetterD.svgSize.width;
    final desiredHeight = _height ?? CircleLetterD.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleLetterD.svgSize.width == 0 || CircleLetterD.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

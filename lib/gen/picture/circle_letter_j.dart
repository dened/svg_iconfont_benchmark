...
/// {@endtemplate}
class CircleLetterJ extends LeafRenderObjectWidget {
  /// {@macro CircleLetterJ}
  ...
  void updateRenderObject(
    ...
    CircleLetterJRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleLetterJRenderObject extends RenderBox {
  CircleLetterJRenderObject();

  final _painter = _CircleLetterJPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleLetterJ.svgSize.width;
    final desiredHeight = _height ?? CircleLetterJ.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleLetterJ.svgSize.width == 0 || CircleLetterJ.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

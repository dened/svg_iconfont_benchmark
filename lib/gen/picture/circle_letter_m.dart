...
/// {@endtemplate}
class CircleLetterM extends LeafRenderObjectWidget {
  /// {@macro CircleLetterM}
  ...
  void updateRenderObject(
    ...
    CircleLetterMRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleLetterMRenderObject extends RenderBox {
  CircleLetterMRenderObject();

  final _painter = _CircleLetterMPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleLetterM.svgSize.width;
    final desiredHeight = _height ?? CircleLetterM.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleLetterM.svgSize.width == 0 || CircleLetterM.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

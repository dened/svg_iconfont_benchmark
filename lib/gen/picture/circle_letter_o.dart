...
/// {@endtemplate}
class CircleLetterO extends LeafRenderObjectWidget {
  /// {@macro CircleLetterO}
  ...
  void updateRenderObject(
    ...
    CircleLetterORenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleLetterORenderObject extends RenderBox {
  CircleLetterORenderObject();

  final _painter = _CircleLetterOPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleLetterO.svgSize.width;
    final desiredHeight = _height ?? CircleLetterO.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleLetterO.svgSize.width == 0 || CircleLetterO.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

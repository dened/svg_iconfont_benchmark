...
/// {@endtemplate}
class CircleLetterQ extends LeafRenderObjectWidget {
  /// {@macro CircleLetterQ}
  ...
  void updateRenderObject(
    ...
    CircleLetterQRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CircleLetterQRenderObject extends RenderBox {
  CircleLetterQRenderObject();

  final _painter = _CircleLetterQPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CircleLetterQ.svgSize.width;
    final desiredHeight = _height ?? CircleLetterQ.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CircleLetterQ.svgSize.width == 0 || CircleLetterQ.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// ClockHour1 widget.
/// {@endtemplate}
class ClockHour1 extends LeafRenderObjectWidget {
  /// {@macro ClockHour1}
  const ClockHour1({super.key, this.width, this.height, this.colorFilter});
  ...
  void updateRenderObject(
    ...
    ClockHour1RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ClockHour1RenderObject extends RenderBox {
  ClockHour1RenderObject();

  final _painter = _ClockHour1Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ClockHour1.svgSize.width;
    final desiredHeight = _height ?? ClockHour1.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ClockHour1.svgSize.width == 0 || ClockHour1.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / ClockHour1.svgSize.width,
      size.height / ClockHour1.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - ClockHour1.svgSize.width * scale) / 2;
    final dy = (size.height - ClockHour1.svgSize.height * scale) / 2;
...
class _ClockHour1Painter {
  ...
  void _createPicture() {
    ...
    final path_0 = Path()
      ...
      ..lineTo(14.832, 9.555)
      ..cubicTo(15.1385, 9.0955, 15.0145, 8.4745, 14.555, 8.168)
      ..cubicTo(14.0955, 7.8615, 13.4745, 7.9855, 13.168, 8.445)
      ..lineTo(13, 8.696)
      ..lineTo(13, 7)

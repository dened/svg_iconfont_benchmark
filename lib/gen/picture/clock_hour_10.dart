...
/// ClockHour10 widget.
/// {@endtemplate}
class ClockHour10 extends LeafRenderObjectWidget {
  /// {@macro ClockHour10}
  ...
  void updateRenderObject(
    ...
    ClockHour10RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ClockHour10RenderObject extends RenderBox {
  ClockHour10RenderObject();

  final _painter = _ClockHour10Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ClockHour10.svgSize.width;
    final desiredHeight = _height ?? ClockHour10.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ClockHour10.svgSize.width == 0 || ClockHour10.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

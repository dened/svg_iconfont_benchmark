...
/// ClockHour12 widget.
/// {@endtemplate}
class ClockHour12 extends LeafRenderObjectWidget {
  /// {@macro ClockHour12}
  ...
  void updateRenderObject(
    ...
    ClockHour12RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ClockHour12RenderObject extends RenderBox {
  ClockHour12RenderObject();

  final _painter = _ClockHour12Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ClockHour12.svgSize.width;
    final desiredHeight = _height ?? ClockHour12.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ClockHour12.svgSize.width == 0 || ClockHour12.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

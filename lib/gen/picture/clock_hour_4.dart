...
/// ClockHour4 widget.
/// {@endtemplate}
class ClockHour4 extends LeafRenderObjectWidget {
  /// {@macro ClockHour4}
  ...
  void updateRenderObject(
    ...
    ClockHour4RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class ClockHour4RenderObject extends RenderBox {
  ClockHour4RenderObject();

  final _painter = _ClockHour4Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? ClockHour4.svgSize.width;
    final desiredHeight = _height ?? ClockHour4.svgSize.height;
  ...
  void performLayout() {
    ...
    if (ClockHour4.svgSize.width == 0 || ClockHour4.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// CoinEuro widget.
/// {@endtemplate}
class CoinEuro extends LeafRenderObjectWidget {
  /// {@macro CoinEuro}
  ...
  void updateRenderObject(
    ...
    CoinEuroRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CoinEuroRenderObject extends RenderBox {
  CoinEuroRenderObject();

  final _painter = _CoinEuroPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CoinEuro.svgSize.width;
    final desiredHeight = _height ?? CoinEuro.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CoinEuro.svgSize.width == 0 || CoinEuro.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

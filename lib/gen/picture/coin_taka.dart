...
/// CoinTaka widget.
/// {@endtemplate}
class CoinTaka extends LeafRenderObjectWidget {
  /// {@macro CoinTaka}
  ...
  void updateRenderObject(
    ...
    CoinTakaRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CoinTakaRenderObject extends RenderBox {
  CoinTakaRenderObject();

  final _painter = _CoinTakaPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CoinTaka.svgSize.width;
    final desiredHeight = _height ?? CoinTaka.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CoinTaka.svgSize.width == 0 || CoinTaka.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

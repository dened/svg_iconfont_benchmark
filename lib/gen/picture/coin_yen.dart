...
/// CoinYen widget.
/// {@endtemplate}
class CoinYen extends LeafRenderObjectWidget {
  /// {@macro CoinYen}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => CoinYenRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    CoinYenRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CoinYenRenderObject extends RenderBox {
  CoinYenRenderObject();

  final _painter = _CoinYenPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CoinYen.svgSize.width;
    final desiredHeight = _height ?? CoinYen.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CoinYen.svgSize.width == 0 || CoinYen.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

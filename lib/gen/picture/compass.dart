...
/// Compass widget.
/// {@endtemplate}
class Compass extends LeafRenderObjectWidget {
  /// {@macro Compass}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => CompassRenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    CompassRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CompassRenderObject extends RenderBox {
  CompassRenderObject();

  final _painter = _CompassPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Compass.svgSize.width;
    final desiredHeight = _height ?? Compass.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Compass.svgSize.width == 0 || Compass.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

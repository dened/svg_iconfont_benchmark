...
/// CookieMan widget.
/// {@endtemplate}
class CookieMan extends LeafRenderObjectWidget {
  /// {@macro CookieMan}
  ...
  void updateRenderObject(
    ...
    CookieManRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CookieManRenderObject extends RenderBox {
  CookieManRenderObject();

  final _painter = _CookieManPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CookieMan.svgSize.width;
    final desiredHeight = _height ?? CookieMan.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CookieMan.svgSize.width == 0 || CookieMan.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// CopyCheck widget.
/// {@endtemplate}
class CopyCheck extends LeafRenderObjectWidget {
  /// {@macro CopyCheck}
  ...
  void updateRenderObject(
    ...
    CopyCheckRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CopyCheckRenderObject extends RenderBox {
  CopyCheckRenderObject();

  final _painter = _CopyCheckPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CopyCheck.svgSize.width;
    final desiredHeight = _height ?? CopyCheck.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CopyCheck.svgSize.width == 0 || CopyCheck.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

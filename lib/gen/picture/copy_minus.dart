...
/// CopyMinus widget.
/// {@endtemplate}
class CopyMinus extends LeafRenderObjectWidget {
  /// {@macro CopyMinus}
  const CopyMinus({super.key, this.width, this.height, this.colorFilter});
  ...
  void updateRenderObject(
    ...
    CopyMinusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CopyMinusRenderObject extends RenderBox {
  CopyMinusRenderObject();

  final _painter = _CopyMinusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CopyMinus.svgSize.width;
    final desiredHeight = _height ?? CopyMinus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CopyMinus.svgSize.width == 0 || CopyMinus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / CopyMinus.svgSize.width,
      size.height / CopyMinus.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - CopyMinus.svgSize.width * scale) / 2;
    final dy = (size.height - CopyMinus.svgSize.height * scale) / 2;
...
class _CopyMinusPainter {
  ...
  void _createPicture() {
    ...
    final path_0 = Path()
      ...
      ..moveTo(17, 13)
      ..lineTo(11, 13)
      ..cubicTo(10.4477, 13, 10, 13.4477, 10, 14)

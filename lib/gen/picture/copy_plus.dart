...
/// CopyPlus widget.
/// {@endtemplate}
class CopyPlus extends LeafRenderObjectWidget {
  /// {@macro CopyPlus}
  ...
  void updateRenderObject(
    ...
    CopyPlusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class CopyPlusRenderObject extends RenderBox {
  CopyPlusRenderObject();

  final _painter = _CopyPlusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? CopyPlus.svgSize.width;
    final desiredHeight = _height ?? CopyPlus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (CopyPlus.svgSize.width == 0 || CopyPlus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// {@endtemplate}
class DeviceGamepad extends LeafRenderObjectWidget {
  /// {@macro DeviceGamepad}
  ...
  void updateRenderObject(
    ...
    DeviceGamepadRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class DeviceGamepadRenderObject extends RenderBox {
  DeviceGamepadRenderObject();

  final _painter = _DeviceGamepadPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? DeviceGamepad.svgSize.width;
    final desiredHeight = _height ?? DeviceGamepad.svgSize.height;
  ...
  void performLayout() {
    ...
    if (DeviceGamepad.svgSize.width == 0 || DeviceGamepad.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// DeviceMobile widget.
/// {@endtemplate}
class DeviceMobile extends LeafRenderObjectWidget {
  /// {@macro DeviceMobile}
  ...
  void updateRenderObject(
    ...
    DeviceMobileRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class DeviceMobileRenderObject extends RenderBox {
  DeviceMobileRenderObject();

  final _painter = _DeviceMobilePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? DeviceMobile.svgSize.width;
    final desiredHeight = _height ?? DeviceMobile.svgSize.height;
  ...
  void performLayout() {
    ...
    if (DeviceMobile.svgSize.width == 0 || DeviceMobile.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

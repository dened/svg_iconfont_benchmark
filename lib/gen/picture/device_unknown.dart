...
/// {@endtemplate}
class DeviceUnknown extends LeafRenderObjectWidget {
  /// {@macro DeviceUnknown}
  ...
  void updateRenderObject(
    ...
    DeviceUnknownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class DeviceUnknownRenderObject extends RenderBox {
  DeviceUnknownRenderObject();

  final _painter = _DeviceUnknownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? DeviceUnknown.svgSize.width;
    final desiredHeight = _height ?? DeviceUnknown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (DeviceUnknown.svgSize.width == 0 || DeviceUnknown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

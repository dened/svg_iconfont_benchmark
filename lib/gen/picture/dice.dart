...
/// Dice widget.
/// {@endtemplate}
class Dice extends LeafRenderObjectWidget {
  /// {@macro Dice}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => DiceRenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, DiceRenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class DiceRenderObject extends RenderBox {
  DiceRenderObject();

  final _painter = _DicePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Dice.svgSize.width;
    final desiredHeight = _height ?? Dice.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Dice.svgSize.width == 0 || Dice.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

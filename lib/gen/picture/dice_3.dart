...
/// Dice3 widget.
/// {@endtemplate}
class Dice3 extends LeafRenderObjectWidget {
  /// {@macro Dice3}
  const Dice3({super.key, this.width, this.height, this.colorFilter});
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Dice3RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Dice3RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Dice3RenderObject extends RenderBox {
  Dice3RenderObject();

  final _painter = _Dice3Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Dice3.svgSize.width;
    final desiredHeight = _height ?? Dice3.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Dice3.svgSize.width == 0 || Dice3.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(
      size.width / Dice3.svgSize.width,
      size.height / Dice3.svgSize.height,
    );
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final dx = (size.width - Dice3.svgSize.width * scale) / 2;
    final dy = (size.height - Dice3.svgSize.height * scale) / 2;

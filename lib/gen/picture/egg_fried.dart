...
/// EggFried widget.
/// {@endtemplate}
class EggFried extends LeafRenderObjectWidget {
  /// {@macro EggFried}
  ...
  void updateRenderObject(
    ...
    EggFriedRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class EggFriedRenderObject extends RenderBox {
  EggFriedRenderObject();

  final _painter = _EggFriedPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? EggFried.svgSize.width;
    final desiredHeight = _height ?? EggFried.svgSize.height;
  ...
  void performLayout() {
    ...
    if (EggFried.svgSize.width == 0 || EggFried.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

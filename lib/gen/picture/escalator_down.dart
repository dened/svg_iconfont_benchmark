...
/// {@endtemplate}
class EscalatorDown extends LeafRenderObjectWidget {
  /// {@macro EscalatorDown}
  ...
  void updateRenderObject(
    ...
    EscalatorDownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class EscalatorDownRenderObject extends RenderBox {
  EscalatorDownRenderObject();

  final _painter = _EscalatorDownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? EscalatorDown.svgSize.width;
    final desiredHeight = _height ?? EscalatorDown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (EscalatorDown.svgSize.width == 0 || EscalatorDown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

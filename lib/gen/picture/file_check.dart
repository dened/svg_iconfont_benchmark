...
/// FileCheck widget.
/// {@endtemplate}
class FileCheck extends LeafRenderObjectWidget {
  /// {@macro FileCheck}
  ...
  void updateRenderObject(
    ...
    FileCheckRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileCheckRenderObject extends RenderBox {
  FileCheckRenderObject();

  final _painter = _FileCheckPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileCheck.svgSize.width;
    final desiredHeight = _height ?? FileCheck.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileCheck.svgSize.width == 0 || FileCheck.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

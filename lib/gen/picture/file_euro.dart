...
/// FileEuro widget.
/// {@endtemplate}
class FileEuro extends LeafRenderObjectWidget {
  /// {@macro FileEuro}
  ...
  void updateRenderObject(
    ...
    FileEuroRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileEuroRenderObject extends RenderBox {
  FileEuroRenderObject();

  final _painter = _FileEuroPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileEuro.svgSize.width;
    final desiredHeight = _height ?? FileEuro.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileEuro.svgSize.width == 0 || FileEuro.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// FileFunction widget.
/// {@endtemplate}
class FileFunction extends LeafRenderObjectWidget {
  /// {@macro FileFunction}
  ...
  void updateRenderObject(
    ...
    FileFunctionRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileFunctionRenderObject extends RenderBox {
  FileFunctionRenderObject();

  final _painter = _FileFunctionPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileFunction.svgSize.width;
    final desiredHeight = _height ?? FileFunction.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileFunction.svgSize.width == 0 || FileFunction.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

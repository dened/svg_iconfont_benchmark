...
/// FileInvoice widget.
/// {@endtemplate}
class FileInvoice extends LeafRenderObjectWidget {
  /// {@macro FileInvoice}
  ...
  void updateRenderObject(
    ...
    FileInvoiceRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileInvoiceRenderObject extends RenderBox {
  FileInvoiceRenderObject();

  final _painter = _FileInvoicePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileInvoice.svgSize.width;
    final desiredHeight = _height ?? FileInvoice.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileInvoice.svgSize.width == 0 || FileInvoice.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

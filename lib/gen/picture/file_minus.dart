...
/// FileMinus widget.
/// {@endtemplate}
class FileMinus extends LeafRenderObjectWidget {
  /// {@macro FileMinus}
  ...
  void updateRenderObject(
    ...
    FileMinusRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileMinusRenderObject extends RenderBox {
  FileMinusRenderObject();

  final _painter = _FileMinusPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileMinus.svgSize.width;
    final desiredHeight = _height ?? FileMinus.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileMinus.svgSize.width == 0 || FileMinus.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

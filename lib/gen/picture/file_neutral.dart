...
/// FileNeutral widget.
/// {@endtemplate}
class FileNeutral extends LeafRenderObjectWidget {
  /// {@macro FileNeutral}
  ...
  void updateRenderObject(
    ...
    FileNeutralRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileNeutralRenderObject extends RenderBox {
  FileNeutralRenderObject();

  final _painter = _FileNeutralPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileNeutral.svgSize.width;
    final desiredHeight = _height ?? FileNeutral.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileNeutral.svgSize.width == 0 || FileNeutral.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// FilePhone widget.
/// {@endtemplate}
class FilePhone extends LeafRenderObjectWidget {
  /// {@macro FilePhone}
  ...
  void updateRenderObject(
    ...
    FilePhoneRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FilePhoneRenderObject extends RenderBox {
  FilePhoneRenderObject();

  final _painter = _FilePhonePainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FilePhone.svgSize.width;
    final desiredHeight = _height ?? FilePhone.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FilePhone.svgSize.width == 0 || FilePhone.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

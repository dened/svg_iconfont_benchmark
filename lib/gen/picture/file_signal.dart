...
/// FileSignal widget.
/// {@endtemplate}
class FileSignal extends LeafRenderObjectWidget {
  /// {@macro FileSignal}
  ...
  void updateRenderObject(
    ...
    FileSignalRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileSignalRenderObject extends RenderBox {
  FileSignalRenderObject();

  final _painter = _FileSignalPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileSignal.svgSize.width;
    final desiredHeight = _height ?? FileSignal.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileSignal.svgSize.width == 0 || FileSignal.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

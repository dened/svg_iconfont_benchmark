...
/// FileUnknown widget.
/// {@endtemplate}
class FileUnknown extends LeafRenderObjectWidget {
  /// {@macro FileUnknown}
  ...
  void updateRenderObject(
    ...
    FileUnknownRenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class FileUnknownRenderObject extends RenderBox {
  FileUnknownRenderObject();

  final _painter = _FileUnknownPainter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? FileUnknown.svgSize.width;
    final desiredHeight = _height ?? FileUnknown.svgSize.height;
  ...
  void performLayout() {
    ...
    if (FileUnknown.svgSize.width == 0 || FileUnknown.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

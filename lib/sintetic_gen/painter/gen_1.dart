...
class Gen1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen1Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen1Painter}
/// Custom painter for [Gen1].
/// {@endtemplate}
class Gen1Painter extends CustomPainter {
  /// {@macro Gen1Painter}
  const Gen1Painter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(Gen1Painter oldDelegate) =>

...
/// Gen10 widget.
/// {@endtemplate}
class Gen10 extends StatelessWidget {
  /// {@macro Gen10}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen10Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen10Painter}
/// Custom painter for [Gen10].
/// {@endtemplate}
class Gen10Painter extends CustomPainter {
  /// {@macro Gen10Painter}
  const Gen10Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen10Painter oldDelegate) =>

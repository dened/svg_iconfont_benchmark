...
/// Gen100 widget.
/// {@endtemplate}
class Gen100 extends StatelessWidget {
  /// {@macro Gen100}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen100Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen100Painter}
/// Custom painter for [Gen100].
/// {@endtemplate}
class Gen100Painter extends CustomPainter {
  /// {@macro Gen100Painter}
  const Gen100Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen100Painter oldDelegate) =>

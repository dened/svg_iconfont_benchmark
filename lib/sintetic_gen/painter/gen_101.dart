...
/// Gen101 widget.
/// {@endtemplate}
class Gen101 extends StatelessWidget {
  /// {@macro Gen101}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen101Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen101Painter}
/// Custom painter for [Gen101].
/// {@endtemplate}
class Gen101Painter extends CustomPainter {
  /// {@macro Gen101Painter}
  const Gen101Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen101Painter oldDelegate) =>

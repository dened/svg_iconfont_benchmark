...
/// Gen102 widget.
/// {@endtemplate}
class Gen102 extends StatelessWidget {
  /// {@macro Gen102}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen102Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen102Painter}
/// Custom painter for [Gen102].
/// {@endtemplate}
class Gen102Painter extends CustomPainter {
  /// {@macro Gen102Painter}
  const Gen102Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen102Painter oldDelegate) =>

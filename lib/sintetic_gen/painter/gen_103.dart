...
/// Gen103 widget.
/// {@endtemplate}
class Gen103 extends StatelessWidget {
  /// {@macro Gen103}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen103Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen103Painter}
/// Custom painter for [Gen103].
/// {@endtemplate}
class Gen103Painter extends CustomPainter {
  /// {@macro Gen103Painter}
  const Gen103Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen103Painter oldDelegate) =>

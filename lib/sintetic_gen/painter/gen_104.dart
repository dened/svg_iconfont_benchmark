...
/// Gen104 widget.
/// {@endtemplate}
class Gen104 extends StatelessWidget {
  /// {@macro Gen104}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen104Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen104Painter}
/// Custom painter for [Gen104].
/// {@endtemplate}
class Gen104Painter extends CustomPainter {
  /// {@macro Gen104Painter}
  const Gen104Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen104Painter oldDelegate) =>

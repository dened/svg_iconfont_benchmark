...
/// Gen105 widget.
/// {@endtemplate}
class Gen105 extends StatelessWidget {
  /// {@macro Gen105}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen105Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen105Painter}
/// Custom painter for [Gen105].
/// {@endtemplate}
class Gen105Painter extends CustomPainter {
  /// {@macro Gen105Painter}
  const Gen105Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen105Painter oldDelegate) =>

...
/// Gen106 widget.
/// {@endtemplate}
class Gen106 extends StatelessWidget {
  /// {@macro Gen106}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen106Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen106Painter}
/// Custom painter for [Gen106].
/// {@endtemplate}
class Gen106Painter extends CustomPainter {
  /// {@macro Gen106Painter}
  const Gen106Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen106Painter oldDelegate) =>

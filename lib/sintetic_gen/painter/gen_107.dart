...
/// Gen107 widget.
/// {@endtemplate}
class Gen107 extends StatelessWidget {
  /// {@macro Gen107}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen107Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen107Painter}
/// Custom painter for [Gen107].
/// {@endtemplate}
class Gen107Painter extends CustomPainter {
  /// {@macro Gen107Painter}
  const Gen107Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen107Painter oldDelegate) =>

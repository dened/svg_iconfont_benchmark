...
/// Gen108 widget.
/// {@endtemplate}
class Gen108 extends StatelessWidget {
  /// {@macro Gen108}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen108Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen108Painter}
/// Custom painter for [Gen108].
/// {@endtemplate}
class Gen108Painter extends CustomPainter {
  /// {@macro Gen108Painter}
  const Gen108Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen108Painter oldDelegate) =>

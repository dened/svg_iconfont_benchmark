...
/// Gen109 widget.
/// {@endtemplate}
class Gen109 extends StatelessWidget {
  /// {@macro Gen109}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen109Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen109Painter}
/// Custom painter for [Gen109].
/// {@endtemplate}
class Gen109Painter extends CustomPainter {
  /// {@macro Gen109Painter}
  const Gen109Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen109Painter oldDelegate) =>

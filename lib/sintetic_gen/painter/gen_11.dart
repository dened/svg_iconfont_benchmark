...
/// Gen11 widget.
/// {@endtemplate}
class Gen11 extends StatelessWidget {
  /// {@macro Gen11}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen11Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen11Painter}
/// Custom painter for [Gen11].
/// {@endtemplate}
class Gen11Painter extends CustomPainter {
  /// {@macro Gen11Painter}
  const Gen11Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen11Painter oldDelegate) =>

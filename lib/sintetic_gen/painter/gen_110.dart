...
/// Gen110 widget.
/// {@endtemplate}
class Gen110 extends StatelessWidget {
  /// {@macro Gen110}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen110Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen110Painter}
/// Custom painter for [Gen110].
/// {@endtemplate}
class Gen110Painter extends CustomPainter {
  /// {@macro Gen110Painter}
  const Gen110Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen110Painter oldDelegate) =>

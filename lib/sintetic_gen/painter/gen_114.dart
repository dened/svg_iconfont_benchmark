...
/// Gen114 widget.
/// {@endtemplate}
class Gen114 extends StatelessWidget {
  /// {@macro Gen114}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen114Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen114Painter}
/// Custom painter for [Gen114].
/// {@endtemplate}
class Gen114Painter extends CustomPainter {
  /// {@macro Gen114Painter}
  const Gen114Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen114Painter oldDelegate) =>

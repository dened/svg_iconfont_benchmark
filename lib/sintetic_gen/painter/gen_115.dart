...
/// Gen115 widget.
/// {@endtemplate}
class Gen115 extends StatelessWidget {
  /// {@macro Gen115}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen115Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen115Painter}
/// Custom painter for [Gen115].
/// {@endtemplate}
class Gen115Painter extends CustomPainter {
  /// {@macro Gen115Painter}
  const Gen115Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen115Painter oldDelegate) =>

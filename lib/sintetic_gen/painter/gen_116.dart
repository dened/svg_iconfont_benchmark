...
/// Gen116 widget.
/// {@endtemplate}
class Gen116 extends StatelessWidget {
  /// {@macro Gen116}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen116Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen116Painter}
/// Custom painter for [Gen116].
/// {@endtemplate}
class Gen116Painter extends CustomPainter {
  /// {@macro Gen116Painter}
  const Gen116Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen116Painter oldDelegate) =>

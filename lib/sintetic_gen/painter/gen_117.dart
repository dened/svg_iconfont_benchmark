...
/// Gen117 widget.
/// {@endtemplate}
class Gen117 extends StatelessWidget {
  /// {@macro Gen117}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen117Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen117Painter}
/// Custom painter for [Gen117].
/// {@endtemplate}
class Gen117Painter extends CustomPainter {
  /// {@macro Gen117Painter}
  const Gen117Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen117Painter oldDelegate) =>

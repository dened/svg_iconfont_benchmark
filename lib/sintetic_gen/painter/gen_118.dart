...
/// Gen118 widget.
/// {@endtemplate}
class Gen118 extends StatelessWidget {
  /// {@macro Gen118}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen118Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen118Painter}
/// Custom painter for [Gen118].
/// {@endtemplate}
class Gen118Painter extends CustomPainter {
  /// {@macro Gen118Painter}
  const Gen118Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen118Painter oldDelegate) =>

...
/// Gen119 widget.
/// {@endtemplate}
class Gen119 extends StatelessWidget {
  /// {@macro Gen119}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen119Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen119Painter}
/// Custom painter for [Gen119].
/// {@endtemplate}
class Gen119Painter extends CustomPainter {
  /// {@macro Gen119Painter}
  const Gen119Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen119Painter oldDelegate) =>

...
/// Gen12 widget.
/// {@endtemplate}
class Gen12 extends StatelessWidget {
  /// {@macro Gen12}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen12Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen12Painter}
/// Custom painter for [Gen12].
/// {@endtemplate}
class Gen12Painter extends CustomPainter {
  /// {@macro Gen12Painter}
  const Gen12Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen12Painter oldDelegate) =>

...
/// Gen120 widget.
/// {@endtemplate}
class Gen120 extends StatelessWidget {
  /// {@macro Gen120}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen120Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen120Painter}
/// Custom painter for [Gen120].
/// {@endtemplate}
class Gen120Painter extends CustomPainter {
  /// {@macro Gen120Painter}
  const Gen120Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen120Painter oldDelegate) =>

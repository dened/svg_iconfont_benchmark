...
/// Gen121 widget.
/// {@endtemplate}
class Gen121 extends StatelessWidget {
  /// {@macro Gen121}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen121Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen121Painter}
/// Custom painter for [Gen121].
/// {@endtemplate}
class Gen121Painter extends CustomPainter {
  /// {@macro Gen121Painter}
  const Gen121Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen121Painter oldDelegate) =>

...
/// Gen123 widget.
/// {@endtemplate}
class Gen123 extends StatelessWidget {
  /// {@macro Gen123}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen123Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen123Painter}
/// Custom painter for [Gen123].
/// {@endtemplate}
class Gen123Painter extends CustomPainter {
  /// {@macro Gen123Painter}
  const Gen123Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen123Painter oldDelegate) =>

...
/// Gen124 widget.
/// {@endtemplate}
class Gen124 extends StatelessWidget {
  /// {@macro Gen124}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen124Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen124Painter}
/// Custom painter for [Gen124].
/// {@endtemplate}
class Gen124Painter extends CustomPainter {
  /// {@macro Gen124Painter}
  const Gen124Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen124Painter oldDelegate) =>

...
/// Gen125 widget.
/// {@endtemplate}
class Gen125 extends StatelessWidget {
  /// {@macro Gen125}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen125Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen125Painter}
/// Custom painter for [Gen125].
/// {@endtemplate}
class Gen125Painter extends CustomPainter {
  /// {@macro Gen125Painter}
  const Gen125Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen125Painter oldDelegate) =>

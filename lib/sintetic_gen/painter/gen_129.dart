...
/// Gen129 widget.
/// {@endtemplate}
class Gen129 extends StatelessWidget {
  /// {@macro Gen129}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen129Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen129Painter}
/// Custom painter for [Gen129].
/// {@endtemplate}
class Gen129Painter extends CustomPainter {
  /// {@macro Gen129Painter}
  const Gen129Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen129Painter oldDelegate) =>

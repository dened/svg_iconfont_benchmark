...
/// Gen130 widget.
/// {@endtemplate}
class Gen130 extends StatelessWidget {
  /// {@macro Gen130}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen130Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen130Painter}
/// Custom painter for [Gen130].
/// {@endtemplate}
class Gen130Painter extends CustomPainter {
  /// {@macro Gen130Painter}
  const Gen130Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen130Painter oldDelegate) =>

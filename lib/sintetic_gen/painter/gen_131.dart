...
/// Gen131 widget.
/// {@endtemplate}
class Gen131 extends StatelessWidget {
  /// {@macro Gen131}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen131Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen131Painter}
/// Custom painter for [Gen131].
/// {@endtemplate}
class Gen131Painter extends CustomPainter {
  /// {@macro Gen131Painter}
  const Gen131Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen131Painter oldDelegate) =>

...
/// Gen135 widget.
/// {@endtemplate}
class Gen135 extends StatelessWidget {
  /// {@macro Gen135}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen135Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen135Painter}
/// Custom painter for [Gen135].
/// {@endtemplate}
class Gen135Painter extends CustomPainter {
  /// {@macro Gen135Painter}
  const Gen135Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen135Painter oldDelegate) =>

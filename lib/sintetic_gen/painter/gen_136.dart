...
/// Gen136 widget.
/// {@endtemplate}
class Gen136 extends StatelessWidget {
  /// {@macro Gen136}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen136Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen136Painter}
/// Custom painter for [Gen136].
/// {@endtemplate}
class Gen136Painter extends CustomPainter {
  /// {@macro Gen136Painter}
  const Gen136Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen136Painter oldDelegate) =>

...
/// Gen137 widget.
/// {@endtemplate}
class Gen137 extends StatelessWidget {
  /// {@macro Gen137}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen137Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen137Painter}
/// Custom painter for [Gen137].
/// {@endtemplate}
class Gen137Painter extends CustomPainter {
  /// {@macro Gen137Painter}
  const Gen137Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen137Painter oldDelegate) =>

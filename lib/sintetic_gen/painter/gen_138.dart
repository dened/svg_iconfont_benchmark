...
/// Gen138 widget.
/// {@endtemplate}
class Gen138 extends StatelessWidget {
  /// {@macro Gen138}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen138Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen138Painter}
/// Custom painter for [Gen138].
/// {@endtemplate}
class Gen138Painter extends CustomPainter {
  /// {@macro Gen138Painter}
  const Gen138Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen138Painter oldDelegate) =>

...
/// Gen139 widget.
/// {@endtemplate}
class Gen139 extends StatelessWidget {
  /// {@macro Gen139}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen139Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen139Painter}
/// Custom painter for [Gen139].
/// {@endtemplate}
class Gen139Painter extends CustomPainter {
  /// {@macro Gen139Painter}
  const Gen139Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen139Painter oldDelegate) =>

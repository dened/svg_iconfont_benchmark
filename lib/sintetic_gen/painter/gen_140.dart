...
/// Gen140 widget.
/// {@endtemplate}
class Gen140 extends StatelessWidget {
  /// {@macro Gen140}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen140Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen140Painter}
/// Custom painter for [Gen140].
/// {@endtemplate}
class Gen140Painter extends CustomPainter {
  /// {@macro Gen140Painter}
  const Gen140Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen140Painter oldDelegate) =>

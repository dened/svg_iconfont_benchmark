...
/// Gen143 widget.
/// {@endtemplate}
class Gen143 extends StatelessWidget {
  /// {@macro Gen143}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen143Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen143Painter}
/// Custom painter for [Gen143].
/// {@endtemplate}
class Gen143Painter extends CustomPainter {
  /// {@macro Gen143Painter}
  const Gen143Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen143Painter oldDelegate) =>

...
/// Gen144 widget.
/// {@endtemplate}
class Gen144 extends StatelessWidget {
  /// {@macro Gen144}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen144Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen144Painter}
/// Custom painter for [Gen144].
/// {@endtemplate}
class Gen144Painter extends CustomPainter {
  /// {@macro Gen144Painter}
  const Gen144Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen144Painter oldDelegate) =>

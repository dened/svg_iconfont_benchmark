...
/// Gen145 widget.
/// {@endtemplate}
class Gen145 extends StatelessWidget {
  /// {@macro Gen145}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen145Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen145Painter}
/// Custom painter for [Gen145].
/// {@endtemplate}
class Gen145Painter extends CustomPainter {
  /// {@macro Gen145Painter}
  const Gen145Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen145Painter oldDelegate) =>

...
/// Gen146 widget.
/// {@endtemplate}
class Gen146 extends StatelessWidget {
  /// {@macro Gen146}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen146Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen146Painter}
/// Custom painter for [Gen146].
/// {@endtemplate}
class Gen146Painter extends CustomPainter {
  /// {@macro Gen146Painter}
  const Gen146Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen146Painter oldDelegate) =>

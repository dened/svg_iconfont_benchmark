...
/// Gen148 widget.
/// {@endtemplate}
class Gen148 extends StatelessWidget {
  /// {@macro Gen148}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen148Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen148Painter}
/// Custom painter for [Gen148].
/// {@endtemplate}
class Gen148Painter extends CustomPainter {
  /// {@macro Gen148Painter}
  const Gen148Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen148Painter oldDelegate) =>

...
/// Gen15 widget.
/// {@endtemplate}
class Gen15 extends StatelessWidget {
  /// {@macro Gen15}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen15Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen15Painter}
/// Custom painter for [Gen15].
/// {@endtemplate}
class Gen15Painter extends CustomPainter {
  /// {@macro Gen15Painter}
  const Gen15Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen15Painter oldDelegate) =>

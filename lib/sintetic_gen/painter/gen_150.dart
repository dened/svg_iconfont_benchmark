...
/// Gen150 widget.
/// {@endtemplate}
class Gen150 extends StatelessWidget {
  /// {@macro Gen150}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen150Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen150Painter}
/// Custom painter for [Gen150].
/// {@endtemplate}
class Gen150Painter extends CustomPainter {
  /// {@macro Gen150Painter}
  const Gen150Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen150Painter oldDelegate) =>

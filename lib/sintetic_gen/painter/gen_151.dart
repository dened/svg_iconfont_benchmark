...
/// Gen151 widget.
/// {@endtemplate}
class Gen151 extends StatelessWidget {
  /// {@macro Gen151}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen151Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen151Painter}
/// Custom painter for [Gen151].
/// {@endtemplate}
class Gen151Painter extends CustomPainter {
  /// {@macro Gen151Painter}
  const Gen151Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen151Painter oldDelegate) =>

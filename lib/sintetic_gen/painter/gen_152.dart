...
/// Gen152 widget.
/// {@endtemplate}
class Gen152 extends StatelessWidget {
  /// {@macro Gen152}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen152Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen152Painter}
/// Custom painter for [Gen152].
/// {@endtemplate}
class Gen152Painter extends CustomPainter {
  /// {@macro Gen152Painter}
  const Gen152Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen152Painter oldDelegate) =>

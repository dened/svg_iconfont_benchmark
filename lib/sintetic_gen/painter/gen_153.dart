...
/// Gen153 widget.
/// {@endtemplate}
class Gen153 extends StatelessWidget {
  /// {@macro Gen153}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen153Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen153Painter}
/// Custom painter for [Gen153].
/// {@endtemplate}
class Gen153Painter extends CustomPainter {
  /// {@macro Gen153Painter}
  const Gen153Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen153Painter oldDelegate) =>

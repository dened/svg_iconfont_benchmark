...
/// Gen154 widget.
/// {@endtemplate}
class Gen154 extends StatelessWidget {
  /// {@macro Gen154}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen154Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen154Painter}
/// Custom painter for [Gen154].
/// {@endtemplate}
class Gen154Painter extends CustomPainter {
  /// {@macro Gen154Painter}
  const Gen154Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen154Painter oldDelegate) =>

...
/// Gen155 widget.
/// {@endtemplate}
class Gen155 extends StatelessWidget {
  /// {@macro Gen155}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen155Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen155Painter}
/// Custom painter for [Gen155].
/// {@endtemplate}
class Gen155Painter extends CustomPainter {
  /// {@macro Gen155Painter}
  const Gen155Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen155Painter oldDelegate) =>

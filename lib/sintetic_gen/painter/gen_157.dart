...
/// Gen157 widget.
/// {@endtemplate}
class Gen157 extends StatelessWidget {
  /// {@macro Gen157}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen157Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen157Painter}
/// Custom painter for [Gen157].
/// {@endtemplate}
class Gen157Painter extends CustomPainter {
  /// {@macro Gen157Painter}
  const Gen157Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen157Painter oldDelegate) =>

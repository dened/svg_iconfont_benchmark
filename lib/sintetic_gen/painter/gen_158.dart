...
/// Gen158 widget.
/// {@endtemplate}
class Gen158 extends StatelessWidget {
  /// {@macro Gen158}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen158Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen158Painter}
/// Custom painter for [Gen158].
/// {@endtemplate}
class Gen158Painter extends CustomPainter {
  /// {@macro Gen158Painter}
  const Gen158Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen158Painter oldDelegate) =>

...
/// Gen161 widget.
/// {@endtemplate}
class Gen161 extends StatelessWidget {
  /// {@macro Gen161}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen161Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen161Painter}
/// Custom painter for [Gen161].
/// {@endtemplate}
class Gen161Painter extends CustomPainter {
  /// {@macro Gen161Painter}
  const Gen161Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen161Painter oldDelegate) =>

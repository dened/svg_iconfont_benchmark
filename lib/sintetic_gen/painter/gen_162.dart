...
/// Gen162 widget.
/// {@endtemplate}
class Gen162 extends StatelessWidget {
  /// {@macro Gen162}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen162Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen162Painter}
/// Custom painter for [Gen162].
/// {@endtemplate}
class Gen162Painter extends CustomPainter {
  /// {@macro Gen162Painter}
  const Gen162Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen162Painter oldDelegate) =>

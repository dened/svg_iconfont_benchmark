...
/// Gen164 widget.
/// {@endtemplate}
class Gen164 extends StatelessWidget {
  /// {@macro Gen164}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen164Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen164Painter}
/// Custom painter for [Gen164].
/// {@endtemplate}
class Gen164Painter extends CustomPainter {
  /// {@macro Gen164Painter}
  const Gen164Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen164Painter oldDelegate) =>

...
/// Gen165 widget.
/// {@endtemplate}
class Gen165 extends StatelessWidget {
  /// {@macro Gen165}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen165Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen165Painter}
/// Custom painter for [Gen165].
/// {@endtemplate}
class Gen165Painter extends CustomPainter {
  /// {@macro Gen165Painter}
  const Gen165Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen165Painter oldDelegate) =>

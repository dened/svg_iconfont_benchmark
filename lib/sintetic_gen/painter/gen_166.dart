...
/// Gen166 widget.
/// {@endtemplate}
class Gen166 extends StatelessWidget {
  /// {@macro Gen166}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen166Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen166Painter}
/// Custom painter for [Gen166].
/// {@endtemplate}
class Gen166Painter extends CustomPainter {
  /// {@macro Gen166Painter}
  const Gen166Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen166Painter oldDelegate) =>

...
/// Gen167 widget.
/// {@endtemplate}
class Gen167 extends StatelessWidget {
  /// {@macro Gen167}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen167Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen167Painter}
/// Custom painter for [Gen167].
/// {@endtemplate}
class Gen167Painter extends CustomPainter {
  /// {@macro Gen167Painter}
  const Gen167Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen167Painter oldDelegate) =>

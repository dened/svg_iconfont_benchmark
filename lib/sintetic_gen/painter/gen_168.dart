...
/// Gen168 widget.
/// {@endtemplate}
class Gen168 extends StatelessWidget {
  /// {@macro Gen168}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen168Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen168Painter}
/// Custom painter for [Gen168].
/// {@endtemplate}
class Gen168Painter extends CustomPainter {
  /// {@macro Gen168Painter}
  const Gen168Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen168Painter oldDelegate) =>

...
/// Gen17 widget.
/// {@endtemplate}
class Gen17 extends StatelessWidget {
  /// {@macro Gen17}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen17Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen17Painter}
/// Custom painter for [Gen17].
/// {@endtemplate}
class Gen17Painter extends CustomPainter {
  /// {@macro Gen17Painter}
  const Gen17Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen17Painter oldDelegate) =>

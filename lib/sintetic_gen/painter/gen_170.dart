...
/// Gen170 widget.
/// {@endtemplate}
class Gen170 extends StatelessWidget {
  /// {@macro Gen170}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen170Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen170Painter}
/// Custom painter for [Gen170].
/// {@endtemplate}
class Gen170Painter extends CustomPainter {
  /// {@macro Gen170Painter}
  const Gen170Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen170Painter oldDelegate) =>

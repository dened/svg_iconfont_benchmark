...
/// Gen171 widget.
/// {@endtemplate}
class Gen171 extends StatelessWidget {
  /// {@macro Gen171}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen171Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen171Painter}
/// Custom painter for [Gen171].
/// {@endtemplate}
class Gen171Painter extends CustomPainter {
  /// {@macro Gen171Painter}
  const Gen171Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen171Painter oldDelegate) =>

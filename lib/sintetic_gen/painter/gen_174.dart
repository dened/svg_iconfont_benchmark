...
/// Gen174 widget.
/// {@endtemplate}
class Gen174 extends StatelessWidget {
  /// {@macro Gen174}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen174Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen174Painter}
/// Custom painter for [Gen174].
/// {@endtemplate}
class Gen174Painter extends CustomPainter {
  /// {@macro Gen174Painter}
  const Gen174Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen174Painter oldDelegate) =>

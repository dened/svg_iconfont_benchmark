...
/// Gen175 widget.
/// {@endtemplate}
class Gen175 extends StatelessWidget {
  /// {@macro Gen175}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen175Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen175Painter}
/// Custom painter for [Gen175].
/// {@endtemplate}
class Gen175Painter extends CustomPainter {
  /// {@macro Gen175Painter}
  const Gen175Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen175Painter oldDelegate) =>

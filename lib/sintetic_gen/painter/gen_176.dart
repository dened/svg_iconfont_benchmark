...
/// Gen176 widget.
/// {@endtemplate}
class Gen176 extends StatelessWidget {
  /// {@macro Gen176}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen176Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen176Painter}
/// Custom painter for [Gen176].
/// {@endtemplate}
class Gen176Painter extends CustomPainter {
  /// {@macro Gen176Painter}
  const Gen176Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen176Painter oldDelegate) =>

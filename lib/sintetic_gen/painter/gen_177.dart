...
/// Gen177 widget.
/// {@endtemplate}
class Gen177 extends StatelessWidget {
  /// {@macro Gen177}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen177Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen177Painter}
/// Custom painter for [Gen177].
/// {@endtemplate}
class Gen177Painter extends CustomPainter {
  /// {@macro Gen177Painter}
  const Gen177Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen177Painter oldDelegate) =>

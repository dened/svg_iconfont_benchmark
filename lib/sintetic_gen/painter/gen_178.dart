...
/// Gen178 widget.
/// {@endtemplate}
class Gen178 extends StatelessWidget {
  /// {@macro Gen178}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen178Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen178Painter}
/// Custom painter for [Gen178].
/// {@endtemplate}
class Gen178Painter extends CustomPainter {
  /// {@macro Gen178Painter}
  const Gen178Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen178Painter oldDelegate) =>

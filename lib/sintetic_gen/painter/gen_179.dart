...
/// Gen179 widget.
/// {@endtemplate}
class Gen179 extends StatelessWidget {
  /// {@macro Gen179}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen179Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen179Painter}
/// Custom painter for [Gen179].
/// {@endtemplate}
class Gen179Painter extends CustomPainter {
  /// {@macro Gen179Painter}
  const Gen179Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen179Painter oldDelegate) =>

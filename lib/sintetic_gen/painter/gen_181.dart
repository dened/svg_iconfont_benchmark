...
/// Gen181 widget.
/// {@endtemplate}
class Gen181 extends StatelessWidget {
  /// {@macro Gen181}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen181Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen181Painter}
/// Custom painter for [Gen181].
/// {@endtemplate}
class Gen181Painter extends CustomPainter {
  /// {@macro Gen181Painter}
  const Gen181Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen181Painter oldDelegate) =>

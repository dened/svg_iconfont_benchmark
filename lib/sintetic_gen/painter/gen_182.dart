...
/// Gen182 widget.
/// {@endtemplate}
class Gen182 extends StatelessWidget {
  /// {@macro Gen182}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen182Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen182Painter}
/// Custom painter for [Gen182].
/// {@endtemplate}
class Gen182Painter extends CustomPainter {
  /// {@macro Gen182Painter}
  const Gen182Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen182Painter oldDelegate) =>

...
/// Gen184 widget.
/// {@endtemplate}
class Gen184 extends StatelessWidget {
  /// {@macro Gen184}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen184Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen184Painter}
/// Custom painter for [Gen184].
/// {@endtemplate}
class Gen184Painter extends CustomPainter {
  /// {@macro Gen184Painter}
  const Gen184Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen184Painter oldDelegate) =>

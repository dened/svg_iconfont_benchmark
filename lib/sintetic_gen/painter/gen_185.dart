...
/// Gen185 widget.
/// {@endtemplate}
class Gen185 extends StatelessWidget {
  /// {@macro Gen185}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen185Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen185Painter}
/// Custom painter for [Gen185].
/// {@endtemplate}
class Gen185Painter extends CustomPainter {
  /// {@macro Gen185Painter}
  const Gen185Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen185Painter oldDelegate) =>

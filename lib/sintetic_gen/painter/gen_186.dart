...
/// Gen186 widget.
/// {@endtemplate}
class Gen186 extends StatelessWidget {
  /// {@macro Gen186}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen186Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen186Painter}
/// Custom painter for [Gen186].
/// {@endtemplate}
class Gen186Painter extends CustomPainter {
  /// {@macro Gen186Painter}
  const Gen186Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen186Painter oldDelegate) =>

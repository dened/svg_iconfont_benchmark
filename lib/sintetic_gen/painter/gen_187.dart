...
/// Gen187 widget.
/// {@endtemplate}
class Gen187 extends StatelessWidget {
  /// {@macro Gen187}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen187Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen187Painter}
/// Custom painter for [Gen187].
/// {@endtemplate}
class Gen187Painter extends CustomPainter {
  /// {@macro Gen187Painter}
  const Gen187Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen187Painter oldDelegate) =>

...
/// Gen188 widget.
/// {@endtemplate}
class Gen188 extends StatelessWidget {
  /// {@macro Gen188}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen188Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen188Painter}
/// Custom painter for [Gen188].
/// {@endtemplate}
class Gen188Painter extends CustomPainter {
  /// {@macro Gen188Painter}
  const Gen188Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen188Painter oldDelegate) =>

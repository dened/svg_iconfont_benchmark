...
/// Gen189 widget.
/// {@endtemplate}
class Gen189 extends StatelessWidget {
  /// {@macro Gen189}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen189Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen189Painter}
/// Custom painter for [Gen189].
/// {@endtemplate}
class Gen189Painter extends CustomPainter {
  /// {@macro Gen189Painter}
  const Gen189Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen189Painter oldDelegate) =>

...
/// Gen19 widget.
/// {@endtemplate}
class Gen19 extends StatelessWidget {
  /// {@macro Gen19}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen19Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen19Painter}
/// Custom painter for [Gen19].
/// {@endtemplate}
class Gen19Painter extends CustomPainter {
  /// {@macro Gen19Painter}
  const Gen19Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen19Painter oldDelegate) =>

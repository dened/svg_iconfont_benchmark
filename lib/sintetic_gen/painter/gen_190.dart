...
/// Gen190 widget.
/// {@endtemplate}
class Gen190 extends StatelessWidget {
  /// {@macro Gen190}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen190Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen190Painter}
/// Custom painter for [Gen190].
/// {@endtemplate}
class Gen190Painter extends CustomPainter {
  /// {@macro Gen190Painter}
  const Gen190Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen190Painter oldDelegate) =>

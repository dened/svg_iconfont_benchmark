...
/// Gen192 widget.
/// {@endtemplate}
class Gen192 extends StatelessWidget {
  /// {@macro Gen192}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen192Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen192Painter}
/// Custom painter for [Gen192].
/// {@endtemplate}
class Gen192Painter extends CustomPainter {
  /// {@macro Gen192Painter}
  const Gen192Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen192Painter oldDelegate) =>

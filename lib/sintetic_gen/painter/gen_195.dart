...
/// Gen195 widget.
/// {@endtemplate}
class Gen195 extends StatelessWidget {
  /// {@macro Gen195}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen195Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen195Painter}
/// Custom painter for [Gen195].
/// {@endtemplate}
class Gen195Painter extends CustomPainter {
  /// {@macro Gen195Painter}
  const Gen195Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen195Painter oldDelegate) =>

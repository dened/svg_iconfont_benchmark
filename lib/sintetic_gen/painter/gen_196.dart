...
/// Gen196 widget.
/// {@endtemplate}
class Gen196 extends StatelessWidget {
  /// {@macro Gen196}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen196Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen196Painter}
/// Custom painter for [Gen196].
/// {@endtemplate}
class Gen196Painter extends CustomPainter {
  /// {@macro Gen196Painter}
  const Gen196Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen196Painter oldDelegate) =>

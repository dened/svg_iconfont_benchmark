...
/// Gen199 widget.
/// {@endtemplate}
class Gen199 extends StatelessWidget {
  /// {@macro Gen199}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen199Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen199Painter}
/// Custom painter for [Gen199].
/// {@endtemplate}
class Gen199Painter extends CustomPainter {
  /// {@macro Gen199Painter}
  const Gen199Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen199Painter oldDelegate) =>

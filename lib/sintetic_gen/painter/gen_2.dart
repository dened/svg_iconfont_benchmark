...
class Gen2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen2Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen2Painter}
/// Custom painter for [Gen2].
/// {@endtemplate}
class Gen2Painter extends CustomPainter {
  /// {@macro Gen2Painter}
  const Gen2Painter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(Gen2Painter oldDelegate) =>

...
/// Gen20 widget.
/// {@endtemplate}
class Gen20 extends StatelessWidget {
  /// {@macro Gen20}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen20Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen20Painter}
/// Custom painter for [Gen20].
/// {@endtemplate}
class Gen20Painter extends CustomPainter {
  /// {@macro Gen20Painter}
  const Gen20Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen20Painter oldDelegate) =>

...
/// Gen200 widget.
/// {@endtemplate}
class Gen200 extends StatelessWidget {
  /// {@macro Gen200}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen200Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen200Painter}
/// Custom painter for [Gen200].
/// {@endtemplate}
class Gen200Painter extends CustomPainter {
  /// {@macro Gen200Painter}
  const Gen200Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen200Painter oldDelegate) =>

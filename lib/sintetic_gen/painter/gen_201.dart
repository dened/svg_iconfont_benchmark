...
/// Gen201 widget.
/// {@endtemplate}
class Gen201 extends StatelessWidget {
  /// {@macro Gen201}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen201Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen201Painter}
/// Custom painter for [Gen201].
/// {@endtemplate}
class Gen201Painter extends CustomPainter {
  /// {@macro Gen201Painter}
  const Gen201Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen201Painter oldDelegate) =>

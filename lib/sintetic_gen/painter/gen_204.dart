...
/// Gen204 widget.
/// {@endtemplate}
class Gen204 extends StatelessWidget {
  /// {@macro Gen204}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen204Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen204Painter}
/// Custom painter for [Gen204].
/// {@endtemplate}
class Gen204Painter extends CustomPainter {
  /// {@macro Gen204Painter}
  const Gen204Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen204Painter oldDelegate) =>

...
/// Gen205 widget.
/// {@endtemplate}
class Gen205 extends StatelessWidget {
  /// {@macro Gen205}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen205Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen205Painter}
/// Custom painter for [Gen205].
/// {@endtemplate}
class Gen205Painter extends CustomPainter {
  /// {@macro Gen205Painter}
  const Gen205Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen205Painter oldDelegate) =>

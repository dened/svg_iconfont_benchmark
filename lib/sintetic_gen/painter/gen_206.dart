...
/// Gen206 widget.
/// {@endtemplate}
class Gen206 extends StatelessWidget {
  /// {@macro Gen206}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen206Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen206Painter}
/// Custom painter for [Gen206].
/// {@endtemplate}
class Gen206Painter extends CustomPainter {
  /// {@macro Gen206Painter}
  const Gen206Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen206Painter oldDelegate) =>

...
/// Gen207 widget.
/// {@endtemplate}
class Gen207 extends StatelessWidget {
  /// {@macro Gen207}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen207Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen207Painter}
/// Custom painter for [Gen207].
/// {@endtemplate}
class Gen207Painter extends CustomPainter {
  /// {@macro Gen207Painter}
  const Gen207Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen207Painter oldDelegate) =>

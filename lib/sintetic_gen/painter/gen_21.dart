...
/// Gen21 widget.
/// {@endtemplate}
class Gen21 extends StatelessWidget {
  /// {@macro Gen21}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen21Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen21Painter}
/// Custom painter for [Gen21].
/// {@endtemplate}
class Gen21Painter extends CustomPainter {
  /// {@macro Gen21Painter}
  const Gen21Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen21Painter oldDelegate) =>

...
/// Gen210 widget.
/// {@endtemplate}
class Gen210 extends StatelessWidget {
  /// {@macro Gen210}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen210Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen210Painter}
/// Custom painter for [Gen210].
/// {@endtemplate}
class Gen210Painter extends CustomPainter {
  /// {@macro Gen210Painter}
  const Gen210Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen210Painter oldDelegate) =>

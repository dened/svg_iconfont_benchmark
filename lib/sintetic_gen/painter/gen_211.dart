...
/// Gen211 widget.
/// {@endtemplate}
class Gen211 extends StatelessWidget {
  /// {@macro Gen211}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen211Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen211Painter}
/// Custom painter for [Gen211].
/// {@endtemplate}
class Gen211Painter extends CustomPainter {
  /// {@macro Gen211Painter}
  const Gen211Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen211Painter oldDelegate) =>

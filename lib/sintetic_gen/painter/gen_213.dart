...
/// Gen213 widget.
/// {@endtemplate}
class Gen213 extends StatelessWidget {
  /// {@macro Gen213}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen213Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen213Painter}
/// Custom painter for [Gen213].
/// {@endtemplate}
class Gen213Painter extends CustomPainter {
  /// {@macro Gen213Painter}
  const Gen213Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen213Painter oldDelegate) =>

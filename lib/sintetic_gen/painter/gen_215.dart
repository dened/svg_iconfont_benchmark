...
/// Gen215 widget.
/// {@endtemplate}
class Gen215 extends StatelessWidget {
  /// {@macro Gen215}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen215Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen215Painter}
/// Custom painter for [Gen215].
/// {@endtemplate}
class Gen215Painter extends CustomPainter {
  /// {@macro Gen215Painter}
  const Gen215Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen215Painter oldDelegate) =>

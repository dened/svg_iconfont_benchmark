...
/// Gen216 widget.
/// {@endtemplate}
class Gen216 extends StatelessWidget {
  /// {@macro Gen216}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen216Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen216Painter}
/// Custom painter for [Gen216].
/// {@endtemplate}
class Gen216Painter extends CustomPainter {
  /// {@macro Gen216Painter}
  const Gen216Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen216Painter oldDelegate) =>

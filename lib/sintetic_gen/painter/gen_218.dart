...
/// Gen218 widget.
/// {@endtemplate}
class Gen218 extends StatelessWidget {
  /// {@macro Gen218}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen218Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen218Painter}
/// Custom painter for [Gen218].
/// {@endtemplate}
class Gen218Painter extends CustomPainter {
  /// {@macro Gen218Painter}
  const Gen218Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen218Painter oldDelegate) =>

...
/// Gen219 widget.
/// {@endtemplate}
class Gen219 extends StatelessWidget {
  /// {@macro Gen219}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen219Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen219Painter}
/// Custom painter for [Gen219].
/// {@endtemplate}
class Gen219Painter extends CustomPainter {
  /// {@macro Gen219Painter}
  const Gen219Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen219Painter oldDelegate) =>

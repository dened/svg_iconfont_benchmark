...
/// Gen22 widget.
/// {@endtemplate}
class Gen22 extends StatelessWidget {
  /// {@macro Gen22}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen22Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen22Painter}
/// Custom painter for [Gen22].
/// {@endtemplate}
class Gen22Painter extends CustomPainter {
  /// {@macro Gen22Painter}
  const Gen22Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen22Painter oldDelegate) =>

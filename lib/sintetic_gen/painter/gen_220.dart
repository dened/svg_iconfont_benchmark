...
/// Gen220 widget.
/// {@endtemplate}
class Gen220 extends StatelessWidget {
  /// {@macro Gen220}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen220Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen220Painter}
/// Custom painter for [Gen220].
/// {@endtemplate}
class Gen220Painter extends CustomPainter {
  /// {@macro Gen220Painter}
  const Gen220Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen220Painter oldDelegate) =>

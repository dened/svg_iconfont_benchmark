...
/// Gen221 widget.
/// {@endtemplate}
class Gen221 extends StatelessWidget {
  /// {@macro Gen221}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen221Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen221Painter}
/// Custom painter for [Gen221].
/// {@endtemplate}
class Gen221Painter extends CustomPainter {
  /// {@macro Gen221Painter}
  const Gen221Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen221Painter oldDelegate) =>

...
/// Gen222 widget.
/// {@endtemplate}
class Gen222 extends StatelessWidget {
  /// {@macro Gen222}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen222Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen222Painter}
/// Custom painter for [Gen222].
/// {@endtemplate}
class Gen222Painter extends CustomPainter {
  /// {@macro Gen222Painter}
  const Gen222Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen222Painter oldDelegate) =>

...
/// Gen224 widget.
/// {@endtemplate}
class Gen224 extends StatelessWidget {
  /// {@macro Gen224}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen224Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen224Painter}
/// Custom painter for [Gen224].
/// {@endtemplate}
class Gen224Painter extends CustomPainter {
  /// {@macro Gen224Painter}
  const Gen224Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen224Painter oldDelegate) =>

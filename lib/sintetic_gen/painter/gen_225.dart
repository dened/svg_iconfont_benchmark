...
/// Gen225 widget.
/// {@endtemplate}
class Gen225 extends StatelessWidget {
  /// {@macro Gen225}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen225Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen225Painter}
/// Custom painter for [Gen225].
/// {@endtemplate}
class Gen225Painter extends CustomPainter {
  /// {@macro Gen225Painter}
  const Gen225Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen225Painter oldDelegate) =>

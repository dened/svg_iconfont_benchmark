...
/// Gen226 widget.
/// {@endtemplate}
class Gen226 extends StatelessWidget {
  /// {@macro Gen226}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen226Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen226Painter}
/// Custom painter for [Gen226].
/// {@endtemplate}
class Gen226Painter extends CustomPainter {
  /// {@macro Gen226Painter}
  const Gen226Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen226Painter oldDelegate) =>

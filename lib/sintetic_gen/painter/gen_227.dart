...
/// Gen227 widget.
/// {@endtemplate}
class Gen227 extends StatelessWidget {
  /// {@macro Gen227}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen227Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen227Painter}
/// Custom painter for [Gen227].
/// {@endtemplate}
class Gen227Painter extends CustomPainter {
  /// {@macro Gen227Painter}
  const Gen227Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen227Painter oldDelegate) =>

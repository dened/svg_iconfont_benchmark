...
/// Gen228 widget.
/// {@endtemplate}
class Gen228 extends StatelessWidget {
  /// {@macro Gen228}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen228Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen228Painter}
/// Custom painter for [Gen228].
/// {@endtemplate}
class Gen228Painter extends CustomPainter {
  /// {@macro Gen228Painter}
  const Gen228Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen228Painter oldDelegate) =>

...
/// Gen229 widget.
/// {@endtemplate}
class Gen229 extends StatelessWidget {
  /// {@macro Gen229}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen229Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen229Painter}
/// Custom painter for [Gen229].
/// {@endtemplate}
class Gen229Painter extends CustomPainter {
  /// {@macro Gen229Painter}
  const Gen229Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen229Painter oldDelegate) =>

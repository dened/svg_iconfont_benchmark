...
/// Gen23 widget.
/// {@endtemplate}
class Gen23 extends StatelessWidget {
  /// {@macro Gen23}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen23Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen23Painter}
/// Custom painter for [Gen23].
/// {@endtemplate}
class Gen23Painter extends CustomPainter {
  /// {@macro Gen23Painter}
  const Gen23Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen23Painter oldDelegate) =>

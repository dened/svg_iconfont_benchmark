...
/// Gen230 widget.
/// {@endtemplate}
class Gen230 extends StatelessWidget {
  /// {@macro Gen230}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen230Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen230Painter}
/// Custom painter for [Gen230].
/// {@endtemplate}
class Gen230Painter extends CustomPainter {
  /// {@macro Gen230Painter}
  const Gen230Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen230Painter oldDelegate) =>

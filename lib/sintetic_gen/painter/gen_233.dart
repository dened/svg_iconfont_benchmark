...
/// Gen233 widget.
/// {@endtemplate}
class Gen233 extends StatelessWidget {
  /// {@macro Gen233}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen233Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen233Painter}
/// Custom painter for [Gen233].
/// {@endtemplate}
class Gen233Painter extends CustomPainter {
  /// {@macro Gen233Painter}
  const Gen233Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen233Painter oldDelegate) =>

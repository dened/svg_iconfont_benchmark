...
/// Gen234 widget.
/// {@endtemplate}
class Gen234 extends StatelessWidget {
  /// {@macro Gen234}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen234Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen234Painter}
/// Custom painter for [Gen234].
/// {@endtemplate}
class Gen234Painter extends CustomPainter {
  /// {@macro Gen234Painter}
  const Gen234Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen234Painter oldDelegate) =>

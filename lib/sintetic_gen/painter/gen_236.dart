...
/// Gen236 widget.
/// {@endtemplate}
class Gen236 extends StatelessWidget {
  /// {@macro Gen236}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen236Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen236Painter}
/// Custom painter for [Gen236].
/// {@endtemplate}
class Gen236Painter extends CustomPainter {
  /// {@macro Gen236Painter}
  const Gen236Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen236Painter oldDelegate) =>

...
/// Gen237 widget.
/// {@endtemplate}
class Gen237 extends StatelessWidget {
  /// {@macro Gen237}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen237Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen237Painter}
/// Custom painter for [Gen237].
/// {@endtemplate}
class Gen237Painter extends CustomPainter {
  /// {@macro Gen237Painter}
  const Gen237Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen237Painter oldDelegate) =>

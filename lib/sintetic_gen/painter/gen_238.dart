...
/// Gen238 widget.
/// {@endtemplate}
class Gen238 extends StatelessWidget {
  /// {@macro Gen238}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen238Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen238Painter}
/// Custom painter for [Gen238].
/// {@endtemplate}
class Gen238Painter extends CustomPainter {
  /// {@macro Gen238Painter}
  const Gen238Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen238Painter oldDelegate) =>

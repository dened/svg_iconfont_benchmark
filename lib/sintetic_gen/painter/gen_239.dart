...
/// Gen239 widget.
/// {@endtemplate}
class Gen239 extends StatelessWidget {
  /// {@macro Gen239}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen239Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen239Painter}
/// Custom painter for [Gen239].
/// {@endtemplate}
class Gen239Painter extends CustomPainter {
  /// {@macro Gen239Painter}
  const Gen239Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen239Painter oldDelegate) =>

...
/// Gen240 widget.
/// {@endtemplate}
class Gen240 extends StatelessWidget {
  /// {@macro Gen240}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen240Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen240Painter}
/// Custom painter for [Gen240].
/// {@endtemplate}
class Gen240Painter extends CustomPainter {
  /// {@macro Gen240Painter}
  const Gen240Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen240Painter oldDelegate) =>

...
/// Gen241 widget.
/// {@endtemplate}
class Gen241 extends StatelessWidget {
  /// {@macro Gen241}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen241Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen241Painter}
/// Custom painter for [Gen241].
/// {@endtemplate}
class Gen241Painter extends CustomPainter {
  /// {@macro Gen241Painter}
  const Gen241Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen241Painter oldDelegate) =>

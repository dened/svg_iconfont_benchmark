...
/// Gen242 widget.
/// {@endtemplate}
class Gen242 extends StatelessWidget {
  /// {@macro Gen242}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen242Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen242Painter}
/// Custom painter for [Gen242].
/// {@endtemplate}
class Gen242Painter extends CustomPainter {
  /// {@macro Gen242Painter}
  const Gen242Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen242Painter oldDelegate) =>

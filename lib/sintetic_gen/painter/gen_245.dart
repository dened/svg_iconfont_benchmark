...
/// Gen245 widget.
/// {@endtemplate}
class Gen245 extends StatelessWidget {
  /// {@macro Gen245}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen245Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen245Painter}
/// Custom painter for [Gen245].
/// {@endtemplate}
class Gen245Painter extends CustomPainter {
  /// {@macro Gen245Painter}
  const Gen245Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen245Painter oldDelegate) =>

...
/// Gen246 widget.
/// {@endtemplate}
class Gen246 extends StatelessWidget {
  /// {@macro Gen246}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen246Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen246Painter}
/// Custom painter for [Gen246].
/// {@endtemplate}
class Gen246Painter extends CustomPainter {
  /// {@macro Gen246Painter}
  const Gen246Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen246Painter oldDelegate) =>

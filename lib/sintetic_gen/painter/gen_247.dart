...
/// Gen247 widget.
/// {@endtemplate}
class Gen247 extends StatelessWidget {
  /// {@macro Gen247}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen247Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen247Painter}
/// Custom painter for [Gen247].
/// {@endtemplate}
class Gen247Painter extends CustomPainter {
  /// {@macro Gen247Painter}
  const Gen247Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen247Painter oldDelegate) =>

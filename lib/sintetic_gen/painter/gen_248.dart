...
/// Gen248 widget.
/// {@endtemplate}
class Gen248 extends StatelessWidget {
  /// {@macro Gen248}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen248Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen248Painter}
/// Custom painter for [Gen248].
/// {@endtemplate}
class Gen248Painter extends CustomPainter {
  /// {@macro Gen248Painter}
  const Gen248Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen248Painter oldDelegate) =>

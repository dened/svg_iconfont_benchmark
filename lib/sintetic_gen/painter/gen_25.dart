...
/// Gen25 widget.
/// {@endtemplate}
class Gen25 extends StatelessWidget {
  /// {@macro Gen25}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen25Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen25Painter}
/// Custom painter for [Gen25].
/// {@endtemplate}
class Gen25Painter extends CustomPainter {
  /// {@macro Gen25Painter}
  const Gen25Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen25Painter oldDelegate) =>

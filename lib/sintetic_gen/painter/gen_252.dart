...
/// Gen252 widget.
/// {@endtemplate}
class Gen252 extends StatelessWidget {
  /// {@macro Gen252}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen252Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen252Painter}
/// Custom painter for [Gen252].
/// {@endtemplate}
class Gen252Painter extends CustomPainter {
  /// {@macro Gen252Painter}
  const Gen252Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen252Painter oldDelegate) =>

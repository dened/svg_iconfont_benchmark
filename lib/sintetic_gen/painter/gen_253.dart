...
/// Gen253 widget.
/// {@endtemplate}
class Gen253 extends StatelessWidget {
  /// {@macro Gen253}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen253Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen253Painter}
/// Custom painter for [Gen253].
/// {@endtemplate}
class Gen253Painter extends CustomPainter {
  /// {@macro Gen253Painter}
  const Gen253Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen253Painter oldDelegate) =>

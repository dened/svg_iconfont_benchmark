...
/// Gen254 widget.
/// {@endtemplate}
class Gen254 extends StatelessWidget {
  /// {@macro Gen254}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen254Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen254Painter}
/// Custom painter for [Gen254].
/// {@endtemplate}
class Gen254Painter extends CustomPainter {
  /// {@macro Gen254Painter}
  const Gen254Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen254Painter oldDelegate) =>

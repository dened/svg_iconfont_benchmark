...
/// Gen255 widget.
/// {@endtemplate}
class Gen255 extends StatelessWidget {
  /// {@macro Gen255}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen255Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen255Painter}
/// Custom painter for [Gen255].
/// {@endtemplate}
class Gen255Painter extends CustomPainter {
  /// {@macro Gen255Painter}
  const Gen255Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen255Painter oldDelegate) =>

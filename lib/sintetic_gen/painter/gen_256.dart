...
/// Gen256 widget.
/// {@endtemplate}
class Gen256 extends StatelessWidget {
  /// {@macro Gen256}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen256Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen256Painter}
/// Custom painter for [Gen256].
/// {@endtemplate}
class Gen256Painter extends CustomPainter {
  /// {@macro Gen256Painter}
  const Gen256Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen256Painter oldDelegate) =>

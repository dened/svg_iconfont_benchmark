...
/// Gen258 widget.
/// {@endtemplate}
class Gen258 extends StatelessWidget {
  /// {@macro Gen258}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen258Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen258Painter}
/// Custom painter for [Gen258].
/// {@endtemplate}
class Gen258Painter extends CustomPainter {
  /// {@macro Gen258Painter}
  const Gen258Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen258Painter oldDelegate) =>

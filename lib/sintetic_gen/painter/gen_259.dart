...
/// Gen259 widget.
/// {@endtemplate}
class Gen259 extends StatelessWidget {
  /// {@macro Gen259}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen259Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen259Painter}
/// Custom painter for [Gen259].
/// {@endtemplate}
class Gen259Painter extends CustomPainter {
  /// {@macro Gen259Painter}
  const Gen259Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen259Painter oldDelegate) =>

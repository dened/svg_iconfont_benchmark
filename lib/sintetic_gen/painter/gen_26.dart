...
/// Gen26 widget.
/// {@endtemplate}
class Gen26 extends StatelessWidget {
  /// {@macro Gen26}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen26Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen26Painter}
/// Custom painter for [Gen26].
/// {@endtemplate}
class Gen26Painter extends CustomPainter {
  /// {@macro Gen26Painter}
  const Gen26Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen26Painter oldDelegate) =>

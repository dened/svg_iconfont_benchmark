...
/// Gen260 widget.
/// {@endtemplate}
class Gen260 extends StatelessWidget {
  /// {@macro Gen260}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen260Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen260Painter}
/// Custom painter for [Gen260].
/// {@endtemplate}
class Gen260Painter extends CustomPainter {
  /// {@macro Gen260Painter}
  const Gen260Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen260Painter oldDelegate) =>

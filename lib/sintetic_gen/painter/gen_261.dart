...
/// Gen261 widget.
/// {@endtemplate}
class Gen261 extends StatelessWidget {
  /// {@macro Gen261}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen261Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen261Painter}
/// Custom painter for [Gen261].
/// {@endtemplate}
class Gen261Painter extends CustomPainter {
  /// {@macro Gen261Painter}
  const Gen261Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen261Painter oldDelegate) =>

...
/// Gen263 widget.
/// {@endtemplate}
class Gen263 extends StatelessWidget {
  /// {@macro Gen263}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen263Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen263Painter}
/// Custom painter for [Gen263].
/// {@endtemplate}
class Gen263Painter extends CustomPainter {
  /// {@macro Gen263Painter}
  const Gen263Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen263Painter oldDelegate) =>

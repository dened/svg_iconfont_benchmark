...
/// Gen264 widget.
/// {@endtemplate}
class Gen264 extends StatelessWidget {
  /// {@macro Gen264}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen264Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen264Painter}
/// Custom painter for [Gen264].
/// {@endtemplate}
class Gen264Painter extends CustomPainter {
  /// {@macro Gen264Painter}
  const Gen264Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen264Painter oldDelegate) =>

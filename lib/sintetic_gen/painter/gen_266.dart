...
/// Gen266 widget.
/// {@endtemplate}
class Gen266 extends StatelessWidget {
  /// {@macro Gen266}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen266Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen266Painter}
/// Custom painter for [Gen266].
/// {@endtemplate}
class Gen266Painter extends CustomPainter {
  /// {@macro Gen266Painter}
  const Gen266Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen266Painter oldDelegate) =>

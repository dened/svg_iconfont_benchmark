...
/// Gen268 widget.
/// {@endtemplate}
class Gen268 extends StatelessWidget {
  /// {@macro Gen268}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen268Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen268Painter}
/// Custom painter for [Gen268].
/// {@endtemplate}
class Gen268Painter extends CustomPainter {
  /// {@macro Gen268Painter}
  const Gen268Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen268Painter oldDelegate) =>

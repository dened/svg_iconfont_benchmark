...
/// Gen27 widget.
/// {@endtemplate}
class Gen27 extends StatelessWidget {
  /// {@macro Gen27}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen27Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen27Painter}
/// Custom painter for [Gen27].
/// {@endtemplate}
class Gen27Painter extends CustomPainter {
  /// {@macro Gen27Painter}
  const Gen27Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen27Painter oldDelegate) =>

...
/// Gen270 widget.
/// {@endtemplate}
class Gen270 extends StatelessWidget {
  /// {@macro Gen270}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen270Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen270Painter}
/// Custom painter for [Gen270].
/// {@endtemplate}
class Gen270Painter extends CustomPainter {
  /// {@macro Gen270Painter}
  const Gen270Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen270Painter oldDelegate) =>

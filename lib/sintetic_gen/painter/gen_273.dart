...
/// Gen273 widget.
/// {@endtemplate}
class Gen273 extends StatelessWidget {
  /// {@macro Gen273}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen273Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen273Painter}
/// Custom painter for [Gen273].
/// {@endtemplate}
class Gen273Painter extends CustomPainter {
  /// {@macro Gen273Painter}
  const Gen273Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen273Painter oldDelegate) =>

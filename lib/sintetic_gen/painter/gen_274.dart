...
/// Gen274 widget.
/// {@endtemplate}
class Gen274 extends StatelessWidget {
  /// {@macro Gen274}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen274Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen274Painter}
/// Custom painter for [Gen274].
/// {@endtemplate}
class Gen274Painter extends CustomPainter {
  /// {@macro Gen274Painter}
  const Gen274Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen274Painter oldDelegate) =>

...
/// Gen275 widget.
/// {@endtemplate}
class Gen275 extends StatelessWidget {
  /// {@macro Gen275}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen275Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen275Painter}
/// Custom painter for [Gen275].
/// {@endtemplate}
class Gen275Painter extends CustomPainter {
  /// {@macro Gen275Painter}
  const Gen275Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen275Painter oldDelegate) =>

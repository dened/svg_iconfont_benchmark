...
/// Gen276 widget.
/// {@endtemplate}
class Gen276 extends StatelessWidget {
  /// {@macro Gen276}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen276Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen276Painter}
/// Custom painter for [Gen276].
/// {@endtemplate}
class Gen276Painter extends CustomPainter {
  /// {@macro Gen276Painter}
  const Gen276Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen276Painter oldDelegate) =>

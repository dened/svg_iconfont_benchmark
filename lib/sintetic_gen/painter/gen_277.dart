...
/// Gen277 widget.
/// {@endtemplate}
class Gen277 extends StatelessWidget {
  /// {@macro Gen277}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen277Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen277Painter}
/// Custom painter for [Gen277].
/// {@endtemplate}
class Gen277Painter extends CustomPainter {
  /// {@macro Gen277Painter}
  const Gen277Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen277Painter oldDelegate) =>

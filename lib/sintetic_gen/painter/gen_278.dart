...
/// Gen278 widget.
/// {@endtemplate}
class Gen278 extends StatelessWidget {
  /// {@macro Gen278}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen278Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen278Painter}
/// Custom painter for [Gen278].
/// {@endtemplate}
class Gen278Painter extends CustomPainter {
  /// {@macro Gen278Painter}
  const Gen278Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen278Painter oldDelegate) =>

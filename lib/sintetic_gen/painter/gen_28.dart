...
/// Gen28 widget.
/// {@endtemplate}
class Gen28 extends StatelessWidget {
  /// {@macro Gen28}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen28Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen28Painter}
/// Custom painter for [Gen28].
/// {@endtemplate}
class Gen28Painter extends CustomPainter {
  /// {@macro Gen28Painter}
  const Gen28Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen28Painter oldDelegate) =>

...
/// Gen280 widget.
/// {@endtemplate}
class Gen280 extends StatelessWidget {
  /// {@macro Gen280}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen280Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen280Painter}
/// Custom painter for [Gen280].
/// {@endtemplate}
class Gen280Painter extends CustomPainter {
  /// {@macro Gen280Painter}
  const Gen280Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen280Painter oldDelegate) =>

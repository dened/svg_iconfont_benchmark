...
/// Gen281 widget.
/// {@endtemplate}
class Gen281 extends StatelessWidget {
  /// {@macro Gen281}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen281Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen281Painter}
/// Custom painter for [Gen281].
/// {@endtemplate}
class Gen281Painter extends CustomPainter {
  /// {@macro Gen281Painter}
  const Gen281Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen281Painter oldDelegate) =>

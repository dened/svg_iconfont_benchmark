...
/// Gen282 widget.
/// {@endtemplate}
class Gen282 extends StatelessWidget {
  /// {@macro Gen282}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen282Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen282Painter}
/// Custom painter for [Gen282].
/// {@endtemplate}
class Gen282Painter extends CustomPainter {
  /// {@macro Gen282Painter}
  const Gen282Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen282Painter oldDelegate) =>

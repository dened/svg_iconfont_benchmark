...
/// Gen283 widget.
/// {@endtemplate}
class Gen283 extends StatelessWidget {
  /// {@macro Gen283}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen283Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen283Painter}
/// Custom painter for [Gen283].
/// {@endtemplate}
class Gen283Painter extends CustomPainter {
  /// {@macro Gen283Painter}
  const Gen283Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen283Painter oldDelegate) =>

...
/// Gen284 widget.
/// {@endtemplate}
class Gen284 extends StatelessWidget {
  /// {@macro Gen284}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen284Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen284Painter}
/// Custom painter for [Gen284].
/// {@endtemplate}
class Gen284Painter extends CustomPainter {
  /// {@macro Gen284Painter}
  const Gen284Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen284Painter oldDelegate) =>

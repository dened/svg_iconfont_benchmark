...
/// Gen285 widget.
/// {@endtemplate}
class Gen285 extends StatelessWidget {
  /// {@macro Gen285}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen285Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen285Painter}
/// Custom painter for [Gen285].
/// {@endtemplate}
class Gen285Painter extends CustomPainter {
  /// {@macro Gen285Painter}
  const Gen285Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen285Painter oldDelegate) =>

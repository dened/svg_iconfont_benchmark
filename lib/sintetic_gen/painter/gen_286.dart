...
/// Gen286 widget.
/// {@endtemplate}
class Gen286 extends StatelessWidget {
  /// {@macro Gen286}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen286Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen286Painter}
/// Custom painter for [Gen286].
/// {@endtemplate}
class Gen286Painter extends CustomPainter {
  /// {@macro Gen286Painter}
  const Gen286Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen286Painter oldDelegate) =>

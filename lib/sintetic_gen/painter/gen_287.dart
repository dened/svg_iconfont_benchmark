...
/// Gen287 widget.
/// {@endtemplate}
class Gen287 extends StatelessWidget {
  /// {@macro Gen287}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen287Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen287Painter}
/// Custom painter for [Gen287].
/// {@endtemplate}
class Gen287Painter extends CustomPainter {
  /// {@macro Gen287Painter}
  const Gen287Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen287Painter oldDelegate) =>

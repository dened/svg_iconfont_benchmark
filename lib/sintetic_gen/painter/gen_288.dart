...
/// Gen288 widget.
/// {@endtemplate}
class Gen288 extends StatelessWidget {
  /// {@macro Gen288}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen288Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen288Painter}
/// Custom painter for [Gen288].
/// {@endtemplate}
class Gen288Painter extends CustomPainter {
  /// {@macro Gen288Painter}
  const Gen288Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen288Painter oldDelegate) =>

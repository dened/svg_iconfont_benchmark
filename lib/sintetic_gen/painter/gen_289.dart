...
/// Gen289 widget.
/// {@endtemplate}
class Gen289 extends StatelessWidget {
  /// {@macro Gen289}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen289Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen289Painter}
/// Custom painter for [Gen289].
/// {@endtemplate}
class Gen289Painter extends CustomPainter {
  /// {@macro Gen289Painter}
  const Gen289Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen289Painter oldDelegate) =>

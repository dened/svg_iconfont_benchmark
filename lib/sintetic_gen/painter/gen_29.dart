...
/// Gen29 widget.
/// {@endtemplate}
class Gen29 extends StatelessWidget {
  /// {@macro Gen29}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen29Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen29Painter}
/// Custom painter for [Gen29].
/// {@endtemplate}
class Gen29Painter extends CustomPainter {
  /// {@macro Gen29Painter}
  const Gen29Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen29Painter oldDelegate) =>

...
/// Gen290 widget.
/// {@endtemplate}
class Gen290 extends StatelessWidget {
  /// {@macro Gen290}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen290Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen290Painter}
/// Custom painter for [Gen290].
/// {@endtemplate}
class Gen290Painter extends CustomPainter {
  /// {@macro Gen290Painter}
  const Gen290Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen290Painter oldDelegate) =>

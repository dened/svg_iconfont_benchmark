...
/// Gen291 widget.
/// {@endtemplate}
class Gen291 extends StatelessWidget {
  /// {@macro Gen291}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen291Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen291Painter}
/// Custom painter for [Gen291].
/// {@endtemplate}
class Gen291Painter extends CustomPainter {
  /// {@macro Gen291Painter}
  const Gen291Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen291Painter oldDelegate) =>

...
/// Gen292 widget.
/// {@endtemplate}
class Gen292 extends StatelessWidget {
  /// {@macro Gen292}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen292Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen292Painter}
/// Custom painter for [Gen292].
/// {@endtemplate}
class Gen292Painter extends CustomPainter {
  /// {@macro Gen292Painter}
  const Gen292Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen292Painter oldDelegate) =>

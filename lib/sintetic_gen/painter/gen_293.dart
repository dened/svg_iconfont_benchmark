...
/// Gen293 widget.
/// {@endtemplate}
class Gen293 extends StatelessWidget {
  /// {@macro Gen293}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen293Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen293Painter}
/// Custom painter for [Gen293].
/// {@endtemplate}
class Gen293Painter extends CustomPainter {
  /// {@macro Gen293Painter}
  const Gen293Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen293Painter oldDelegate) =>

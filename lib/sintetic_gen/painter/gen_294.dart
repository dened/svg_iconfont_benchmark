...
/// Gen294 widget.
/// {@endtemplate}
class Gen294 extends StatelessWidget {
  /// {@macro Gen294}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen294Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen294Painter}
/// Custom painter for [Gen294].
/// {@endtemplate}
class Gen294Painter extends CustomPainter {
  /// {@macro Gen294Painter}
  const Gen294Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen294Painter oldDelegate) =>

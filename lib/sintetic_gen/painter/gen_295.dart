...
/// Gen295 widget.
/// {@endtemplate}
class Gen295 extends StatelessWidget {
  /// {@macro Gen295}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen295Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen295Painter}
/// Custom painter for [Gen295].
/// {@endtemplate}
class Gen295Painter extends CustomPainter {
  /// {@macro Gen295Painter}
  const Gen295Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen295Painter oldDelegate) =>

...
/// Gen296 widget.
/// {@endtemplate}
class Gen296 extends StatelessWidget {
  /// {@macro Gen296}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen296Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen296Painter}
/// Custom painter for [Gen296].
/// {@endtemplate}
class Gen296Painter extends CustomPainter {
  /// {@macro Gen296Painter}
  const Gen296Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen296Painter oldDelegate) =>

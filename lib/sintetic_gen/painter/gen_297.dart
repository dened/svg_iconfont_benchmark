...
/// Gen297 widget.
/// {@endtemplate}
class Gen297 extends StatelessWidget {
  /// {@macro Gen297}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen297Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen297Painter}
/// Custom painter for [Gen297].
/// {@endtemplate}
class Gen297Painter extends CustomPainter {
  /// {@macro Gen297Painter}
  const Gen297Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen297Painter oldDelegate) =>

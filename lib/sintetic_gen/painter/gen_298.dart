...
/// Gen298 widget.
/// {@endtemplate}
class Gen298 extends StatelessWidget {
  /// {@macro Gen298}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen298Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen298Painter}
/// Custom painter for [Gen298].
/// {@endtemplate}
class Gen298Painter extends CustomPainter {
  /// {@macro Gen298Painter}
  const Gen298Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen298Painter oldDelegate) =>

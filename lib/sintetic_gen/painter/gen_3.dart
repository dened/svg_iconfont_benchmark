...
/// Gen3 widget.
/// {@endtemplate}
class Gen3 extends StatelessWidget {
  /// {@macro Gen3}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen3Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen3Painter}
/// Custom painter for [Gen3].
/// {@endtemplate}
class Gen3Painter extends CustomPainter {
  /// {@macro Gen3Painter}
  const Gen3Painter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(Gen3Painter oldDelegate) =>

...
/// Gen30 widget.
/// {@endtemplate}
class Gen30 extends StatelessWidget {
  /// {@macro Gen30}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen30Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen30Painter}
/// Custom painter for [Gen30].
/// {@endtemplate}
class Gen30Painter extends CustomPainter {
  /// {@macro Gen30Painter}
  const Gen30Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen30Painter oldDelegate) =>

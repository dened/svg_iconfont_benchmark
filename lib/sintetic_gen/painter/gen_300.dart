...
/// Gen300 widget.
/// {@endtemplate}
class Gen300 extends StatelessWidget {
  /// {@macro Gen300}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen300Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen300Painter}
/// Custom painter for [Gen300].
/// {@endtemplate}
class Gen300Painter extends CustomPainter {
  /// {@macro Gen300Painter}
  const Gen300Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen300Painter oldDelegate) =>

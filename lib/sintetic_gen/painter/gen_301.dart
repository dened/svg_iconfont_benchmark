...
/// Gen301 widget.
/// {@endtemplate}
class Gen301 extends StatelessWidget {
  /// {@macro Gen301}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen301Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen301Painter}
/// Custom painter for [Gen301].
/// {@endtemplate}
class Gen301Painter extends CustomPainter {
  /// {@macro Gen301Painter}
  const Gen301Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen301Painter oldDelegate) =>

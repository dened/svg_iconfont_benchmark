...
/// Gen303 widget.
/// {@endtemplate}
class Gen303 extends StatelessWidget {
  /// {@macro Gen303}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen303Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen303Painter}
/// Custom painter for [Gen303].
/// {@endtemplate}
class Gen303Painter extends CustomPainter {
  /// {@macro Gen303Painter}
  const Gen303Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen303Painter oldDelegate) =>

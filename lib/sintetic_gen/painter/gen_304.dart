...
/// Gen304 widget.
/// {@endtemplate}
class Gen304 extends StatelessWidget {
  /// {@macro Gen304}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen304Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen304Painter}
/// Custom painter for [Gen304].
/// {@endtemplate}
class Gen304Painter extends CustomPainter {
  /// {@macro Gen304Painter}
  const Gen304Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen304Painter oldDelegate) =>

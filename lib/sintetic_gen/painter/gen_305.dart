...
/// Gen305 widget.
/// {@endtemplate}
class Gen305 extends StatelessWidget {
  /// {@macro Gen305}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen305Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen305Painter}
/// Custom painter for [Gen305].
/// {@endtemplate}
class Gen305Painter extends CustomPainter {
  /// {@macro Gen305Painter}
  const Gen305Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen305Painter oldDelegate) =>

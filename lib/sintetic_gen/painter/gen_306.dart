...
/// Gen306 widget.
/// {@endtemplate}
class Gen306 extends StatelessWidget {
  /// {@macro Gen306}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen306Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen306Painter}
/// Custom painter for [Gen306].
/// {@endtemplate}
class Gen306Painter extends CustomPainter {
  /// {@macro Gen306Painter}
  const Gen306Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen306Painter oldDelegate) =>

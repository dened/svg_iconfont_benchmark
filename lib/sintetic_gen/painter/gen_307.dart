...
/// Gen307 widget.
/// {@endtemplate}
class Gen307 extends StatelessWidget {
  /// {@macro Gen307}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen307Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen307Painter}
/// Custom painter for [Gen307].
/// {@endtemplate}
class Gen307Painter extends CustomPainter {
  /// {@macro Gen307Painter}
  const Gen307Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen307Painter oldDelegate) =>

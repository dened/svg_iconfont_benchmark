...
/// Gen309 widget.
/// {@endtemplate}
class Gen309 extends StatelessWidget {
  /// {@macro Gen309}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen309Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen309Painter}
/// Custom painter for [Gen309].
/// {@endtemplate}
class Gen309Painter extends CustomPainter {
  /// {@macro Gen309Painter}
  const Gen309Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen309Painter oldDelegate) =>

...
/// Gen31 widget.
/// {@endtemplate}
class Gen31 extends StatelessWidget {
  /// {@macro Gen31}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen31Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen31Painter}
/// Custom painter for [Gen31].
/// {@endtemplate}
class Gen31Painter extends CustomPainter {
  /// {@macro Gen31Painter}
  const Gen31Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen31Painter oldDelegate) =>

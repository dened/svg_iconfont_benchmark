...
/// Gen310 widget.
/// {@endtemplate}
class Gen310 extends StatelessWidget {
  /// {@macro Gen310}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen310Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen310Painter}
/// Custom painter for [Gen310].
/// {@endtemplate}
class Gen310Painter extends CustomPainter {
  /// {@macro Gen310Painter}
  const Gen310Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen310Painter oldDelegate) =>

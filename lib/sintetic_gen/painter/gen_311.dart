...
/// Gen311 widget.
/// {@endtemplate}
class Gen311 extends StatelessWidget {
  /// {@macro Gen311}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen311Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen311Painter}
/// Custom painter for [Gen311].
/// {@endtemplate}
class Gen311Painter extends CustomPainter {
  /// {@macro Gen311Painter}
  const Gen311Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen311Painter oldDelegate) =>

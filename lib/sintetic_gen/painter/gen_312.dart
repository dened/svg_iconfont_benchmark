...
/// Gen312 widget.
/// {@endtemplate}
class Gen312 extends StatelessWidget {
  /// {@macro Gen312}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen312Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen312Painter}
/// Custom painter for [Gen312].
/// {@endtemplate}
class Gen312Painter extends CustomPainter {
  /// {@macro Gen312Painter}
  const Gen312Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen312Painter oldDelegate) =>

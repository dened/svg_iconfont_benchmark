...
/// Gen316 widget.
/// {@endtemplate}
class Gen316 extends StatelessWidget {
  /// {@macro Gen316}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen316Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen316Painter}
/// Custom painter for [Gen316].
/// {@endtemplate}
class Gen316Painter extends CustomPainter {
  /// {@macro Gen316Painter}
  const Gen316Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen316Painter oldDelegate) =>

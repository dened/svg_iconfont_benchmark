...
/// Gen317 widget.
/// {@endtemplate}
class Gen317 extends StatelessWidget {
  /// {@macro Gen317}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen317Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen317Painter}
/// Custom painter for [Gen317].
/// {@endtemplate}
class Gen317Painter extends CustomPainter {
  /// {@macro Gen317Painter}
  const Gen317Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen317Painter oldDelegate) =>

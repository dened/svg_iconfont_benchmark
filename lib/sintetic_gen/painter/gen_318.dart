...
/// Gen318 widget.
/// {@endtemplate}
class Gen318 extends StatelessWidget {
  /// {@macro Gen318}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen318Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen318Painter}
/// Custom painter for [Gen318].
/// {@endtemplate}
class Gen318Painter extends CustomPainter {
  /// {@macro Gen318Painter}
  const Gen318Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen318Painter oldDelegate) =>

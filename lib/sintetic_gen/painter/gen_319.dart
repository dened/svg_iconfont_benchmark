...
/// Gen319 widget.
/// {@endtemplate}
class Gen319 extends StatelessWidget {
  /// {@macro Gen319}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen319Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen319Painter}
/// Custom painter for [Gen319].
/// {@endtemplate}
class Gen319Painter extends CustomPainter {
  /// {@macro Gen319Painter}
  const Gen319Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen319Painter oldDelegate) =>

...
/// Gen32 widget.
/// {@endtemplate}
class Gen32 extends StatelessWidget {
  /// {@macro Gen32}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen32Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen32Painter}
/// Custom painter for [Gen32].
/// {@endtemplate}
class Gen32Painter extends CustomPainter {
  /// {@macro Gen32Painter}
  const Gen32Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen32Painter oldDelegate) =>

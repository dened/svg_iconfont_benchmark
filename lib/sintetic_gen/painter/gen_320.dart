...
/// Gen320 widget.
/// {@endtemplate}
class Gen320 extends StatelessWidget {
  /// {@macro Gen320}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen320Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen320Painter}
/// Custom painter for [Gen320].
/// {@endtemplate}
class Gen320Painter extends CustomPainter {
  /// {@macro Gen320Painter}
  const Gen320Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen320Painter oldDelegate) =>

...
/// Gen324 widget.
/// {@endtemplate}
class Gen324 extends StatelessWidget {
  /// {@macro Gen324}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen324Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen324Painter}
/// Custom painter for [Gen324].
/// {@endtemplate}
class Gen324Painter extends CustomPainter {
  /// {@macro Gen324Painter}
  const Gen324Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen324Painter oldDelegate) =>

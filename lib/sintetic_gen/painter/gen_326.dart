...
/// Gen326 widget.
/// {@endtemplate}
class Gen326 extends StatelessWidget {
  /// {@macro Gen326}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen326Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen326Painter}
/// Custom painter for [Gen326].
/// {@endtemplate}
class Gen326Painter extends CustomPainter {
  /// {@macro Gen326Painter}
  const Gen326Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen326Painter oldDelegate) =>

...
/// Gen328 widget.
/// {@endtemplate}
class Gen328 extends StatelessWidget {
  /// {@macro Gen328}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen328Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen328Painter}
/// Custom painter for [Gen328].
/// {@endtemplate}
class Gen328Painter extends CustomPainter {
  /// {@macro Gen328Painter}
  const Gen328Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen328Painter oldDelegate) =>

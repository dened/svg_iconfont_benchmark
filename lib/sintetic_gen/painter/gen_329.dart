...
/// Gen329 widget.
/// {@endtemplate}
class Gen329 extends StatelessWidget {
  /// {@macro Gen329}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen329Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen329Painter}
/// Custom painter for [Gen329].
/// {@endtemplate}
class Gen329Painter extends CustomPainter {
  /// {@macro Gen329Painter}
  const Gen329Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen329Painter oldDelegate) =>

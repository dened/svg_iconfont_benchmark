...
/// Gen33 widget.
/// {@endtemplate}
class Gen33 extends StatelessWidget {
  /// {@macro Gen33}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen33Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen33Painter}
/// Custom painter for [Gen33].
/// {@endtemplate}
class Gen33Painter extends CustomPainter {
  /// {@macro Gen33Painter}
  const Gen33Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen33Painter oldDelegate) =>

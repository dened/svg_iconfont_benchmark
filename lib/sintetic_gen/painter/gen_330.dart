...
/// Gen330 widget.
/// {@endtemplate}
class Gen330 extends StatelessWidget {
  /// {@macro Gen330}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen330Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen330Painter}
/// Custom painter for [Gen330].
/// {@endtemplate}
class Gen330Painter extends CustomPainter {
  /// {@macro Gen330Painter}
  const Gen330Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen330Painter oldDelegate) =>

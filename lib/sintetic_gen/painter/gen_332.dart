...
/// Gen332 widget.
/// {@endtemplate}
class Gen332 extends StatelessWidget {
  /// {@macro Gen332}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen332Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen332Painter}
/// Custom painter for [Gen332].
/// {@endtemplate}
class Gen332Painter extends CustomPainter {
  /// {@macro Gen332Painter}
  const Gen332Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen332Painter oldDelegate) =>

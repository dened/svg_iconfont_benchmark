...
/// Gen333 widget.
/// {@endtemplate}
class Gen333 extends StatelessWidget {
  /// {@macro Gen333}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen333Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen333Painter}
/// Custom painter for [Gen333].
/// {@endtemplate}
class Gen333Painter extends CustomPainter {
  /// {@macro Gen333Painter}
  const Gen333Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen333Painter oldDelegate) =>

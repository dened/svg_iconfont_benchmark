...
/// Gen334 widget.
/// {@endtemplate}
class Gen334 extends StatelessWidget {
  /// {@macro Gen334}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen334Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen334Painter}
/// Custom painter for [Gen334].
/// {@endtemplate}
class Gen334Painter extends CustomPainter {
  /// {@macro Gen334Painter}
  const Gen334Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen334Painter oldDelegate) =>

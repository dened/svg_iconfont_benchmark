...
/// Gen336 widget.
/// {@endtemplate}
class Gen336 extends StatelessWidget {
  /// {@macro Gen336}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen336Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen336Painter}
/// Custom painter for [Gen336].
/// {@endtemplate}
class Gen336Painter extends CustomPainter {
  /// {@macro Gen336Painter}
  const Gen336Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen336Painter oldDelegate) =>

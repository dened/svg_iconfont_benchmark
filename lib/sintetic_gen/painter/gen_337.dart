...
/// Gen337 widget.
/// {@endtemplate}
class Gen337 extends StatelessWidget {
  /// {@macro Gen337}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen337Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen337Painter}
/// Custom painter for [Gen337].
/// {@endtemplate}
class Gen337Painter extends CustomPainter {
  /// {@macro Gen337Painter}
  const Gen337Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen337Painter oldDelegate) =>

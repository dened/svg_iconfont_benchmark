...
/// Gen339 widget.
/// {@endtemplate}
class Gen339 extends StatelessWidget {
  /// {@macro Gen339}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen339Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen339Painter}
/// Custom painter for [Gen339].
/// {@endtemplate}
class Gen339Painter extends CustomPainter {
  /// {@macro Gen339Painter}
  const Gen339Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen339Painter oldDelegate) =>

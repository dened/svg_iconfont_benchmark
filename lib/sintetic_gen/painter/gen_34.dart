...
/// Gen34 widget.
/// {@endtemplate}
class Gen34 extends StatelessWidget {
  /// {@macro Gen34}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen34Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen34Painter}
/// Custom painter for [Gen34].
/// {@endtemplate}
class Gen34Painter extends CustomPainter {
  /// {@macro Gen34Painter}
  const Gen34Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen34Painter oldDelegate) =>

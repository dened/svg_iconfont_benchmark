...
/// Gen342 widget.
/// {@endtemplate}
class Gen342 extends StatelessWidget {
  /// {@macro Gen342}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen342Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen342Painter}
/// Custom painter for [Gen342].
/// {@endtemplate}
class Gen342Painter extends CustomPainter {
  /// {@macro Gen342Painter}
  const Gen342Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen342Painter oldDelegate) =>

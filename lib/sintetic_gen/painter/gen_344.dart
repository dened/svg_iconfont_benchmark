...
/// Gen344 widget.
/// {@endtemplate}
class Gen344 extends StatelessWidget {
  /// {@macro Gen344}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen344Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen344Painter}
/// Custom painter for [Gen344].
/// {@endtemplate}
class Gen344Painter extends CustomPainter {
  /// {@macro Gen344Painter}
  const Gen344Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen344Painter oldDelegate) =>

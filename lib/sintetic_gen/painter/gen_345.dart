...
/// Gen345 widget.
/// {@endtemplate}
class Gen345 extends StatelessWidget {
  /// {@macro Gen345}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen345Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen345Painter}
/// Custom painter for [Gen345].
/// {@endtemplate}
class Gen345Painter extends CustomPainter {
  /// {@macro Gen345Painter}
  const Gen345Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen345Painter oldDelegate) =>

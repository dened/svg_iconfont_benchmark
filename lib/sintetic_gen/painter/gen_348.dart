...
/// Gen348 widget.
/// {@endtemplate}
class Gen348 extends StatelessWidget {
  /// {@macro Gen348}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen348Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen348Painter}
/// Custom painter for [Gen348].
/// {@endtemplate}
class Gen348Painter extends CustomPainter {
  /// {@macro Gen348Painter}
  const Gen348Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen348Painter oldDelegate) =>

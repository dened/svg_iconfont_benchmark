...
/// Gen349 widget.
/// {@endtemplate}
class Gen349 extends StatelessWidget {
  /// {@macro Gen349}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen349Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen349Painter}
/// Custom painter for [Gen349].
/// {@endtemplate}
class Gen349Painter extends CustomPainter {
  /// {@macro Gen349Painter}
  const Gen349Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen349Painter oldDelegate) =>

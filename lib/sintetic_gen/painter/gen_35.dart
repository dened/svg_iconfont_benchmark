...
/// Gen35 widget.
/// {@endtemplate}
class Gen35 extends StatelessWidget {
  /// {@macro Gen35}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen35Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen35Painter}
/// Custom painter for [Gen35].
/// {@endtemplate}
class Gen35Painter extends CustomPainter {
  /// {@macro Gen35Painter}
  const Gen35Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen35Painter oldDelegate) =>

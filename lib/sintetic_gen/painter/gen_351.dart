...
/// Gen351 widget.
/// {@endtemplate}
class Gen351 extends StatelessWidget {
  /// {@macro Gen351}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen351Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen351Painter}
/// Custom painter for [Gen351].
/// {@endtemplate}
class Gen351Painter extends CustomPainter {
  /// {@macro Gen351Painter}
  const Gen351Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen351Painter oldDelegate) =>

...
/// Gen352 widget.
/// {@endtemplate}
class Gen352 extends StatelessWidget {
  /// {@macro Gen352}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen352Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen352Painter}
/// Custom painter for [Gen352].
/// {@endtemplate}
class Gen352Painter extends CustomPainter {
  /// {@macro Gen352Painter}
  const Gen352Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen352Painter oldDelegate) =>

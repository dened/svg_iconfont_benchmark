...
/// Gen353 widget.
/// {@endtemplate}
class Gen353 extends StatelessWidget {
  /// {@macro Gen353}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen353Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen353Painter}
/// Custom painter for [Gen353].
/// {@endtemplate}
class Gen353Painter extends CustomPainter {
  /// {@macro Gen353Painter}
  const Gen353Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen353Painter oldDelegate) =>

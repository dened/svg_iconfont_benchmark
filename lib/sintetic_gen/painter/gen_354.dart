...
/// Gen354 widget.
/// {@endtemplate}
class Gen354 extends StatelessWidget {
  /// {@macro Gen354}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen354Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen354Painter}
/// Custom painter for [Gen354].
/// {@endtemplate}
class Gen354Painter extends CustomPainter {
  /// {@macro Gen354Painter}
  const Gen354Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen354Painter oldDelegate) =>

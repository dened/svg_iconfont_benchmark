...
/// Gen355 widget.
/// {@endtemplate}
class Gen355 extends StatelessWidget {
  /// {@macro Gen355}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen355Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen355Painter}
/// Custom painter for [Gen355].
/// {@endtemplate}
class Gen355Painter extends CustomPainter {
  /// {@macro Gen355Painter}
  const Gen355Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen355Painter oldDelegate) =>

...
/// Gen357 widget.
/// {@endtemplate}
class Gen357 extends StatelessWidget {
  /// {@macro Gen357}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen357Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen357Painter}
/// Custom painter for [Gen357].
/// {@endtemplate}
class Gen357Painter extends CustomPainter {
  /// {@macro Gen357Painter}
  const Gen357Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen357Painter oldDelegate) =>

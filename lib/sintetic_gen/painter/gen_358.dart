...
/// Gen358 widget.
/// {@endtemplate}
class Gen358 extends StatelessWidget {
  /// {@macro Gen358}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen358Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen358Painter}
/// Custom painter for [Gen358].
/// {@endtemplate}
class Gen358Painter extends CustomPainter {
  /// {@macro Gen358Painter}
  const Gen358Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen358Painter oldDelegate) =>

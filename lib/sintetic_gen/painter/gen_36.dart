...
/// Gen36 widget.
/// {@endtemplate}
class Gen36 extends StatelessWidget {
  /// {@macro Gen36}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen36Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen36Painter}
/// Custom painter for [Gen36].
/// {@endtemplate}
class Gen36Painter extends CustomPainter {
  /// {@macro Gen36Painter}
  const Gen36Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen36Painter oldDelegate) =>

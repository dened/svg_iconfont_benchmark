...
/// Gen361 widget.
/// {@endtemplate}
class Gen361 extends StatelessWidget {
  /// {@macro Gen361}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen361Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen361Painter}
/// Custom painter for [Gen361].
/// {@endtemplate}
class Gen361Painter extends CustomPainter {
  /// {@macro Gen361Painter}
  const Gen361Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen361Painter oldDelegate) =>

...
/// Gen363 widget.
/// {@endtemplate}
class Gen363 extends StatelessWidget {
  /// {@macro Gen363}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen363Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen363Painter}
/// Custom painter for [Gen363].
/// {@endtemplate}
class Gen363Painter extends CustomPainter {
  /// {@macro Gen363Painter}
  const Gen363Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen363Painter oldDelegate) =>

...
/// Gen365 widget.
/// {@endtemplate}
class Gen365 extends StatelessWidget {
  /// {@macro Gen365}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen365Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen365Painter}
/// Custom painter for [Gen365].
/// {@endtemplate}
class Gen365Painter extends CustomPainter {
  /// {@macro Gen365Painter}
  const Gen365Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen365Painter oldDelegate) =>

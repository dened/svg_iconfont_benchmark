...
/// Gen366 widget.
/// {@endtemplate}
class Gen366 extends StatelessWidget {
  /// {@macro Gen366}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen366Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen366Painter}
/// Custom painter for [Gen366].
/// {@endtemplate}
class Gen366Painter extends CustomPainter {
  /// {@macro Gen366Painter}
  const Gen366Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen366Painter oldDelegate) =>

...
/// Gen367 widget.
/// {@endtemplate}
class Gen367 extends StatelessWidget {
  /// {@macro Gen367}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen367Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen367Painter}
/// Custom painter for [Gen367].
/// {@endtemplate}
class Gen367Painter extends CustomPainter {
  /// {@macro Gen367Painter}
  const Gen367Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen367Painter oldDelegate) =>

...
/// Gen368 widget.
/// {@endtemplate}
class Gen368 extends StatelessWidget {
  /// {@macro Gen368}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen368Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen368Painter}
/// Custom painter for [Gen368].
/// {@endtemplate}
class Gen368Painter extends CustomPainter {
  /// {@macro Gen368Painter}
  const Gen368Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen368Painter oldDelegate) =>

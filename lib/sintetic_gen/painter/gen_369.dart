...
/// Gen369 widget.
/// {@endtemplate}
class Gen369 extends StatelessWidget {
  /// {@macro Gen369}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen369Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen369Painter}
/// Custom painter for [Gen369].
/// {@endtemplate}
class Gen369Painter extends CustomPainter {
  /// {@macro Gen369Painter}
  const Gen369Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen369Painter oldDelegate) =>

...
/// Gen37 widget.
/// {@endtemplate}
class Gen37 extends StatelessWidget {
  /// {@macro Gen37}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen37Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen37Painter}
/// Custom painter for [Gen37].
/// {@endtemplate}
class Gen37Painter extends CustomPainter {
  /// {@macro Gen37Painter}
  const Gen37Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen37Painter oldDelegate) =>

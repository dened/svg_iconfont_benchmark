...
/// Gen370 widget.
/// {@endtemplate}
class Gen370 extends StatelessWidget {
  /// {@macro Gen370}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen370Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen370Painter}
/// Custom painter for [Gen370].
/// {@endtemplate}
class Gen370Painter extends CustomPainter {
  /// {@macro Gen370Painter}
  const Gen370Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen370Painter oldDelegate) =>

...
/// Gen371 widget.
/// {@endtemplate}
class Gen371 extends StatelessWidget {
  /// {@macro Gen371}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen371Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen371Painter}
/// Custom painter for [Gen371].
/// {@endtemplate}
class Gen371Painter extends CustomPainter {
  /// {@macro Gen371Painter}
  const Gen371Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen371Painter oldDelegate) =>

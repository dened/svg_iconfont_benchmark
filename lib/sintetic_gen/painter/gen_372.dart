...
/// Gen372 widget.
/// {@endtemplate}
class Gen372 extends StatelessWidget {
  /// {@macro Gen372}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen372Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen372Painter}
/// Custom painter for [Gen372].
/// {@endtemplate}
class Gen372Painter extends CustomPainter {
  /// {@macro Gen372Painter}
  const Gen372Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen372Painter oldDelegate) =>

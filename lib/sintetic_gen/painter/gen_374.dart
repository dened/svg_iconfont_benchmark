...
/// Gen374 widget.
/// {@endtemplate}
class Gen374 extends StatelessWidget {
  /// {@macro Gen374}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen374Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen374Painter}
/// Custom painter for [Gen374].
/// {@endtemplate}
class Gen374Painter extends CustomPainter {
  /// {@macro Gen374Painter}
  const Gen374Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen374Painter oldDelegate) =>

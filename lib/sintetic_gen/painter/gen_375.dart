...
/// Gen375 widget.
/// {@endtemplate}
class Gen375 extends StatelessWidget {
  /// {@macro Gen375}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen375Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen375Painter}
/// Custom painter for [Gen375].
/// {@endtemplate}
class Gen375Painter extends CustomPainter {
  /// {@macro Gen375Painter}
  const Gen375Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen375Painter oldDelegate) =>

...
/// Gen376 widget.
/// {@endtemplate}
class Gen376 extends StatelessWidget {
  /// {@macro Gen376}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen376Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen376Painter}
/// Custom painter for [Gen376].
/// {@endtemplate}
class Gen376Painter extends CustomPainter {
  /// {@macro Gen376Painter}
  const Gen376Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen376Painter oldDelegate) =>

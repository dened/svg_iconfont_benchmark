...
/// Gen377 widget.
/// {@endtemplate}
class Gen377 extends StatelessWidget {
  /// {@macro Gen377}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen377Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen377Painter}
/// Custom painter for [Gen377].
/// {@endtemplate}
class Gen377Painter extends CustomPainter {
  /// {@macro Gen377Painter}
  const Gen377Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen377Painter oldDelegate) =>

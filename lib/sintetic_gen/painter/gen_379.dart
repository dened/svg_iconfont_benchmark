...
/// Gen379 widget.
/// {@endtemplate}
class Gen379 extends StatelessWidget {
  /// {@macro Gen379}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen379Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen379Painter}
/// Custom painter for [Gen379].
/// {@endtemplate}
class Gen379Painter extends CustomPainter {
  /// {@macro Gen379Painter}
  const Gen379Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen379Painter oldDelegate) =>

...
/// Gen38 widget.
/// {@endtemplate}
class Gen38 extends StatelessWidget {
  /// {@macro Gen38}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen38Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen38Painter}
/// Custom painter for [Gen38].
/// {@endtemplate}
class Gen38Painter extends CustomPainter {
  /// {@macro Gen38Painter}
  const Gen38Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen38Painter oldDelegate) =>

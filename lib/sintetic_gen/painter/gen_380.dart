...
/// Gen380 widget.
/// {@endtemplate}
class Gen380 extends StatelessWidget {
  /// {@macro Gen380}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen380Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen380Painter}
/// Custom painter for [Gen380].
/// {@endtemplate}
class Gen380Painter extends CustomPainter {
  /// {@macro Gen380Painter}
  const Gen380Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen380Painter oldDelegate) =>

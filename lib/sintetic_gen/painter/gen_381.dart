...
/// Gen381 widget.
/// {@endtemplate}
class Gen381 extends StatelessWidget {
  /// {@macro Gen381}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen381Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen381Painter}
/// Custom painter for [Gen381].
/// {@endtemplate}
class Gen381Painter extends CustomPainter {
  /// {@macro Gen381Painter}
  const Gen381Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen381Painter oldDelegate) =>

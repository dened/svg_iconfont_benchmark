...
/// Gen382 widget.
/// {@endtemplate}
class Gen382 extends StatelessWidget {
  /// {@macro Gen382}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen382Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen382Painter}
/// Custom painter for [Gen382].
/// {@endtemplate}
class Gen382Painter extends CustomPainter {
  /// {@macro Gen382Painter}
  const Gen382Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen382Painter oldDelegate) =>

...
/// Gen383 widget.
/// {@endtemplate}
class Gen383 extends StatelessWidget {
  /// {@macro Gen383}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen383Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen383Painter}
/// Custom painter for [Gen383].
/// {@endtemplate}
class Gen383Painter extends CustomPainter {
  /// {@macro Gen383Painter}
  const Gen383Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen383Painter oldDelegate) =>

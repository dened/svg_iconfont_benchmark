...
/// Gen384 widget.
/// {@endtemplate}
class Gen384 extends StatelessWidget {
  /// {@macro Gen384}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen384Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen384Painter}
/// Custom painter for [Gen384].
/// {@endtemplate}
class Gen384Painter extends CustomPainter {
  /// {@macro Gen384Painter}
  const Gen384Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen384Painter oldDelegate) =>

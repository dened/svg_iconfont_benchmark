...
/// Gen385 widget.
/// {@endtemplate}
class Gen385 extends StatelessWidget {
  /// {@macro Gen385}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen385Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen385Painter}
/// Custom painter for [Gen385].
/// {@endtemplate}
class Gen385Painter extends CustomPainter {
  /// {@macro Gen385Painter}
  const Gen385Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen385Painter oldDelegate) =>

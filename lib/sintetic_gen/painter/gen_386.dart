...
/// Gen386 widget.
/// {@endtemplate}
class Gen386 extends StatelessWidget {
  /// {@macro Gen386}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen386Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen386Painter}
/// Custom painter for [Gen386].
/// {@endtemplate}
class Gen386Painter extends CustomPainter {
  /// {@macro Gen386Painter}
  const Gen386Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen386Painter oldDelegate) =>

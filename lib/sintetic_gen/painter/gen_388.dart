...
/// Gen388 widget.
/// {@endtemplate}
class Gen388 extends StatelessWidget {
  /// {@macro Gen388}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen388Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen388Painter}
/// Custom painter for [Gen388].
/// {@endtemplate}
class Gen388Painter extends CustomPainter {
  /// {@macro Gen388Painter}
  const Gen388Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen388Painter oldDelegate) =>

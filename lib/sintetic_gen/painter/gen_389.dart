...
/// Gen389 widget.
/// {@endtemplate}
class Gen389 extends StatelessWidget {
  /// {@macro Gen389}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen389Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen389Painter}
/// Custom painter for [Gen389].
/// {@endtemplate}
class Gen389Painter extends CustomPainter {
  /// {@macro Gen389Painter}
  const Gen389Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen389Painter oldDelegate) =>

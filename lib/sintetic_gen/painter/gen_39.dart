...
/// Gen39 widget.
/// {@endtemplate}
class Gen39 extends StatelessWidget {
  /// {@macro Gen39}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen39Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen39Painter}
/// Custom painter for [Gen39].
/// {@endtemplate}
class Gen39Painter extends CustomPainter {
  /// {@macro Gen39Painter}
  const Gen39Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen39Painter oldDelegate) =>

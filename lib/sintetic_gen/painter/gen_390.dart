...
/// Gen390 widget.
/// {@endtemplate}
class Gen390 extends StatelessWidget {
  /// {@macro Gen390}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen390Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen390Painter}
/// Custom painter for [Gen390].
/// {@endtemplate}
class Gen390Painter extends CustomPainter {
  /// {@macro Gen390Painter}
  const Gen390Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen390Painter oldDelegate) =>

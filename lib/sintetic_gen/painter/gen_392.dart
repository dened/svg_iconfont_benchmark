...
/// Gen392 widget.
/// {@endtemplate}
class Gen392 extends StatelessWidget {
  /// {@macro Gen392}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen392Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen392Painter}
/// Custom painter for [Gen392].
/// {@endtemplate}
class Gen392Painter extends CustomPainter {
  /// {@macro Gen392Painter}
  const Gen392Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen392Painter oldDelegate) =>

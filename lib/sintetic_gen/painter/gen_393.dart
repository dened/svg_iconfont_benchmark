...
/// Gen393 widget.
/// {@endtemplate}
class Gen393 extends StatelessWidget {
  /// {@macro Gen393}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen393Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen393Painter}
/// Custom painter for [Gen393].
/// {@endtemplate}
class Gen393Painter extends CustomPainter {
  /// {@macro Gen393Painter}
  const Gen393Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen393Painter oldDelegate) =>

...
/// Gen394 widget.
/// {@endtemplate}
class Gen394 extends StatelessWidget {
  /// {@macro Gen394}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen394Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen394Painter}
/// Custom painter for [Gen394].
/// {@endtemplate}
class Gen394Painter extends CustomPainter {
  /// {@macro Gen394Painter}
  const Gen394Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen394Painter oldDelegate) =>

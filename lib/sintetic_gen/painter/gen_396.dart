...
/// Gen396 widget.
/// {@endtemplate}
class Gen396 extends StatelessWidget {
  /// {@macro Gen396}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen396Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen396Painter}
/// Custom painter for [Gen396].
/// {@endtemplate}
class Gen396Painter extends CustomPainter {
  /// {@macro Gen396Painter}
  const Gen396Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen396Painter oldDelegate) =>

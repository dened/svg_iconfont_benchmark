...
/// Gen40 widget.
/// {@endtemplate}
class Gen40 extends StatelessWidget {
  /// {@macro Gen40}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen40Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen40Painter}
/// Custom painter for [Gen40].
/// {@endtemplate}
class Gen40Painter extends CustomPainter {
  /// {@macro Gen40Painter}
  const Gen40Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen40Painter oldDelegate) =>

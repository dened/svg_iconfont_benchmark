...
/// Gen400 widget.
/// {@endtemplate}
class Gen400 extends StatelessWidget {
  /// {@macro Gen400}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen400Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen400Painter}
/// Custom painter for [Gen400].
/// {@endtemplate}
class Gen400Painter extends CustomPainter {
  /// {@macro Gen400Painter}
  const Gen400Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen400Painter oldDelegate) =>

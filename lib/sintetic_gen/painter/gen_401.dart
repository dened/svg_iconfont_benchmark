...
/// Gen401 widget.
/// {@endtemplate}
class Gen401 extends StatelessWidget {
  /// {@macro Gen401}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen401Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen401Painter}
/// Custom painter for [Gen401].
/// {@endtemplate}
class Gen401Painter extends CustomPainter {
  /// {@macro Gen401Painter}
  const Gen401Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen401Painter oldDelegate) =>

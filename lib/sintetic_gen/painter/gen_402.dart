...
/// Gen402 widget.
/// {@endtemplate}
class Gen402 extends StatelessWidget {
  /// {@macro Gen402}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen402Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen402Painter}
/// Custom painter for [Gen402].
/// {@endtemplate}
class Gen402Painter extends CustomPainter {
  /// {@macro Gen402Painter}
  const Gen402Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen402Painter oldDelegate) =>

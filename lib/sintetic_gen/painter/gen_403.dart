...
/// Gen403 widget.
/// {@endtemplate}
class Gen403 extends StatelessWidget {
  /// {@macro Gen403}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen403Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen403Painter}
/// Custom painter for [Gen403].
/// {@endtemplate}
class Gen403Painter extends CustomPainter {
  /// {@macro Gen403Painter}
  const Gen403Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen403Painter oldDelegate) =>

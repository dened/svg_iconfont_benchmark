...
/// Gen404 widget.
/// {@endtemplate}
class Gen404 extends StatelessWidget {
  /// {@macro Gen404}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen404Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen404Painter}
/// Custom painter for [Gen404].
/// {@endtemplate}
class Gen404Painter extends CustomPainter {
  /// {@macro Gen404Painter}
  const Gen404Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen404Painter oldDelegate) =>

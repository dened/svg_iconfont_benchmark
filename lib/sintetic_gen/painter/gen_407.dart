...
/// Gen407 widget.
/// {@endtemplate}
class Gen407 extends StatelessWidget {
  /// {@macro Gen407}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen407Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen407Painter}
/// Custom painter for [Gen407].
/// {@endtemplate}
class Gen407Painter extends CustomPainter {
  /// {@macro Gen407Painter}
  const Gen407Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen407Painter oldDelegate) =>

...
/// Gen408 widget.
/// {@endtemplate}
class Gen408 extends StatelessWidget {
  /// {@macro Gen408}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen408Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen408Painter}
/// Custom painter for [Gen408].
/// {@endtemplate}
class Gen408Painter extends CustomPainter {
  /// {@macro Gen408Painter}
  const Gen408Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen408Painter oldDelegate) =>

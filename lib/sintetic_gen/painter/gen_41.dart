...
/// Gen41 widget.
/// {@endtemplate}
class Gen41 extends StatelessWidget {
  /// {@macro Gen41}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen41Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen41Painter}
/// Custom painter for [Gen41].
/// {@endtemplate}
class Gen41Painter extends CustomPainter {
  /// {@macro Gen41Painter}
  const Gen41Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen41Painter oldDelegate) =>

...
/// Gen410 widget.
/// {@endtemplate}
class Gen410 extends StatelessWidget {
  /// {@macro Gen410}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen410Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen410Painter}
/// Custom painter for [Gen410].
/// {@endtemplate}
class Gen410Painter extends CustomPainter {
  /// {@macro Gen410Painter}
  const Gen410Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen410Painter oldDelegate) =>

...
/// Gen411 widget.
/// {@endtemplate}
class Gen411 extends StatelessWidget {
  /// {@macro Gen411}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen411Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen411Painter}
/// Custom painter for [Gen411].
/// {@endtemplate}
class Gen411Painter extends CustomPainter {
  /// {@macro Gen411Painter}
  const Gen411Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen411Painter oldDelegate) =>

...
/// Gen413 widget.
/// {@endtemplate}
class Gen413 extends StatelessWidget {
  /// {@macro Gen413}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen413Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen413Painter}
/// Custom painter for [Gen413].
/// {@endtemplate}
class Gen413Painter extends CustomPainter {
  /// {@macro Gen413Painter}
  const Gen413Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen413Painter oldDelegate) =>

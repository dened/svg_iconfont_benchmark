...
/// Gen414 widget.
/// {@endtemplate}
class Gen414 extends StatelessWidget {
  /// {@macro Gen414}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen414Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen414Painter}
/// Custom painter for [Gen414].
/// {@endtemplate}
class Gen414Painter extends CustomPainter {
  /// {@macro Gen414Painter}
  const Gen414Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen414Painter oldDelegate) =>

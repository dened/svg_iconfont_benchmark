...
/// Gen415 widget.
/// {@endtemplate}
class Gen415 extends StatelessWidget {
  /// {@macro Gen415}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen415Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen415Painter}
/// Custom painter for [Gen415].
/// {@endtemplate}
class Gen415Painter extends CustomPainter {
  /// {@macro Gen415Painter}
  const Gen415Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen415Painter oldDelegate) =>

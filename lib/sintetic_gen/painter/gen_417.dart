...
/// Gen417 widget.
/// {@endtemplate}
class Gen417 extends StatelessWidget {
  /// {@macro Gen417}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen417Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen417Painter}
/// Custom painter for [Gen417].
/// {@endtemplate}
class Gen417Painter extends CustomPainter {
  /// {@macro Gen417Painter}
  const Gen417Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen417Painter oldDelegate) =>

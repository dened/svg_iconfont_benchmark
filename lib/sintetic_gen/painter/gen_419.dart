...
/// Gen419 widget.
/// {@endtemplate}
class Gen419 extends StatelessWidget {
  /// {@macro Gen419}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen419Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen419Painter}
/// Custom painter for [Gen419].
/// {@endtemplate}
class Gen419Painter extends CustomPainter {
  /// {@macro Gen419Painter}
  const Gen419Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen419Painter oldDelegate) =>

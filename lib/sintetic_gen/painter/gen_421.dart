...
/// Gen421 widget.
/// {@endtemplate}
class Gen421 extends StatelessWidget {
  /// {@macro Gen421}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen421Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen421Painter}
/// Custom painter for [Gen421].
/// {@endtemplate}
class Gen421Painter extends CustomPainter {
  /// {@macro Gen421Painter}
  const Gen421Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen421Painter oldDelegate) =>

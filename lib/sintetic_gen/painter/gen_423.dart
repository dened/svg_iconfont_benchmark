...
/// Gen423 widget.
/// {@endtemplate}
class Gen423 extends StatelessWidget {
  /// {@macro Gen423}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen423Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen423Painter}
/// Custom painter for [Gen423].
/// {@endtemplate}
class Gen423Painter extends CustomPainter {
  /// {@macro Gen423Painter}
  const Gen423Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen423Painter oldDelegate) =>

...
/// Gen425 widget.
/// {@endtemplate}
class Gen425 extends StatelessWidget {
  /// {@macro Gen425}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen425Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen425Painter}
/// Custom painter for [Gen425].
/// {@endtemplate}
class Gen425Painter extends CustomPainter {
  /// {@macro Gen425Painter}
  const Gen425Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen425Painter oldDelegate) =>

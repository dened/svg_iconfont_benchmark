...
/// Gen427 widget.
/// {@endtemplate}
class Gen427 extends StatelessWidget {
  /// {@macro Gen427}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen427Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen427Painter}
/// Custom painter for [Gen427].
/// {@endtemplate}
class Gen427Painter extends CustomPainter {
  /// {@macro Gen427Painter}
  const Gen427Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen427Painter oldDelegate) =>

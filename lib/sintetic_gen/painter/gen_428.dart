...
/// Gen428 widget.
/// {@endtemplate}
class Gen428 extends StatelessWidget {
  /// {@macro Gen428}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen428Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen428Painter}
/// Custom painter for [Gen428].
/// {@endtemplate}
class Gen428Painter extends CustomPainter {
  /// {@macro Gen428Painter}
  const Gen428Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen428Painter oldDelegate) =>

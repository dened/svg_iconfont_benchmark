...
/// Gen429 widget.
/// {@endtemplate}
class Gen429 extends StatelessWidget {
  /// {@macro Gen429}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen429Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen429Painter}
/// Custom painter for [Gen429].
/// {@endtemplate}
class Gen429Painter extends CustomPainter {
  /// {@macro Gen429Painter}
  const Gen429Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen429Painter oldDelegate) =>

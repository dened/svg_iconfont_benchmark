...
/// Gen430 widget.
/// {@endtemplate}
class Gen430 extends StatelessWidget {
  /// {@macro Gen430}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen430Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen430Painter}
/// Custom painter for [Gen430].
/// {@endtemplate}
class Gen430Painter extends CustomPainter {
  /// {@macro Gen430Painter}
  const Gen430Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen430Painter oldDelegate) =>

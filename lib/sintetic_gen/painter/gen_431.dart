...
/// Gen431 widget.
/// {@endtemplate}
class Gen431 extends StatelessWidget {
  /// {@macro Gen431}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen431Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen431Painter}
/// Custom painter for [Gen431].
/// {@endtemplate}
class Gen431Painter extends CustomPainter {
  /// {@macro Gen431Painter}
  const Gen431Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen431Painter oldDelegate) =>

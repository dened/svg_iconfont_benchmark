...
/// Gen432 widget.
/// {@endtemplate}
class Gen432 extends StatelessWidget {
  /// {@macro Gen432}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen432Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen432Painter}
/// Custom painter for [Gen432].
/// {@endtemplate}
class Gen432Painter extends CustomPainter {
  /// {@macro Gen432Painter}
  const Gen432Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen432Painter oldDelegate) =>

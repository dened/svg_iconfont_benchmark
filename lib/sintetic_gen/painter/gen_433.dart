...
/// Gen433 widget.
/// {@endtemplate}
class Gen433 extends StatelessWidget {
  /// {@macro Gen433}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen433Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen433Painter}
/// Custom painter for [Gen433].
/// {@endtemplate}
class Gen433Painter extends CustomPainter {
  /// {@macro Gen433Painter}
  const Gen433Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen433Painter oldDelegate) =>

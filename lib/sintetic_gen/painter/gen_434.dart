...
/// Gen434 widget.
/// {@endtemplate}
class Gen434 extends StatelessWidget {
  /// {@macro Gen434}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen434Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen434Painter}
/// Custom painter for [Gen434].
/// {@endtemplate}
class Gen434Painter extends CustomPainter {
  /// {@macro Gen434Painter}
  const Gen434Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen434Painter oldDelegate) =>

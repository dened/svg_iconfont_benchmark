...
/// Gen435 widget.
/// {@endtemplate}
class Gen435 extends StatelessWidget {
  /// {@macro Gen435}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen435Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen435Painter}
/// Custom painter for [Gen435].
/// {@endtemplate}
class Gen435Painter extends CustomPainter {
  /// {@macro Gen435Painter}
  const Gen435Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen435Painter oldDelegate) =>

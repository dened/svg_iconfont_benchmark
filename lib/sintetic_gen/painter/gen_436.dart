...
/// Gen436 widget.
/// {@endtemplate}
class Gen436 extends StatelessWidget {
  /// {@macro Gen436}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen436Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen436Painter}
/// Custom painter for [Gen436].
/// {@endtemplate}
class Gen436Painter extends CustomPainter {
  /// {@macro Gen436Painter}
  const Gen436Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen436Painter oldDelegate) =>

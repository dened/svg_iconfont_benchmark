...
/// Gen437 widget.
/// {@endtemplate}
class Gen437 extends StatelessWidget {
  /// {@macro Gen437}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen437Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen437Painter}
/// Custom painter for [Gen437].
/// {@endtemplate}
class Gen437Painter extends CustomPainter {
  /// {@macro Gen437Painter}
  const Gen437Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen437Painter oldDelegate) =>

...
/// Gen439 widget.
/// {@endtemplate}
class Gen439 extends StatelessWidget {
  /// {@macro Gen439}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen439Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen439Painter}
/// Custom painter for [Gen439].
/// {@endtemplate}
class Gen439Painter extends CustomPainter {
  /// {@macro Gen439Painter}
  const Gen439Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen439Painter oldDelegate) =>

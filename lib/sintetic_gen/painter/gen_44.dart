...
/// Gen44 widget.
/// {@endtemplate}
class Gen44 extends StatelessWidget {
  /// {@macro Gen44}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen44Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen44Painter}
/// Custom painter for [Gen44].
/// {@endtemplate}
class Gen44Painter extends CustomPainter {
  /// {@macro Gen44Painter}
  const Gen44Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen44Painter oldDelegate) =>

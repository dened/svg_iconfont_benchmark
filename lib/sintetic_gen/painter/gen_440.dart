...
/// Gen440 widget.
/// {@endtemplate}
class Gen440 extends StatelessWidget {
  /// {@macro Gen440}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen440Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen440Painter}
/// Custom painter for [Gen440].
/// {@endtemplate}
class Gen440Painter extends CustomPainter {
  /// {@macro Gen440Painter}
  const Gen440Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen440Painter oldDelegate) =>

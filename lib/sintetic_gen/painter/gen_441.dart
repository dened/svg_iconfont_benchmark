...
/// Gen441 widget.
/// {@endtemplate}
class Gen441 extends StatelessWidget {
  /// {@macro Gen441}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen441Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen441Painter}
/// Custom painter for [Gen441].
/// {@endtemplate}
class Gen441Painter extends CustomPainter {
  /// {@macro Gen441Painter}
  const Gen441Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen441Painter oldDelegate) =>

...
/// Gen442 widget.
/// {@endtemplate}
class Gen442 extends StatelessWidget {
  /// {@macro Gen442}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen442Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen442Painter}
/// Custom painter for [Gen442].
/// {@endtemplate}
class Gen442Painter extends CustomPainter {
  /// {@macro Gen442Painter}
  const Gen442Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen442Painter oldDelegate) =>

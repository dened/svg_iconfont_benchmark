...
/// Gen443 widget.
/// {@endtemplate}
class Gen443 extends StatelessWidget {
  /// {@macro Gen443}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen443Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen443Painter}
/// Custom painter for [Gen443].
/// {@endtemplate}
class Gen443Painter extends CustomPainter {
  /// {@macro Gen443Painter}
  const Gen443Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen443Painter oldDelegate) =>

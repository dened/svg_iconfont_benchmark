...
/// Gen444 widget.
/// {@endtemplate}
class Gen444 extends StatelessWidget {
  /// {@macro Gen444}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen444Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen444Painter}
/// Custom painter for [Gen444].
/// {@endtemplate}
class Gen444Painter extends CustomPainter {
  /// {@macro Gen444Painter}
  const Gen444Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen444Painter oldDelegate) =>

...
/// Gen446 widget.
/// {@endtemplate}
class Gen446 extends StatelessWidget {
  /// {@macro Gen446}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen446Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen446Painter}
/// Custom painter for [Gen446].
/// {@endtemplate}
class Gen446Painter extends CustomPainter {
  /// {@macro Gen446Painter}
  const Gen446Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen446Painter oldDelegate) =>

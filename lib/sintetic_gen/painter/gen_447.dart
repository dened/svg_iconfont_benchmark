...
/// Gen447 widget.
/// {@endtemplate}
class Gen447 extends StatelessWidget {
  /// {@macro Gen447}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen447Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen447Painter}
/// Custom painter for [Gen447].
/// {@endtemplate}
class Gen447Painter extends CustomPainter {
  /// {@macro Gen447Painter}
  const Gen447Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen447Painter oldDelegate) =>

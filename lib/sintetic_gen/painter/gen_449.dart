...
/// Gen449 widget.
/// {@endtemplate}
class Gen449 extends StatelessWidget {
  /// {@macro Gen449}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen449Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen449Painter}
/// Custom painter for [Gen449].
/// {@endtemplate}
class Gen449Painter extends CustomPainter {
  /// {@macro Gen449Painter}
  const Gen449Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen449Painter oldDelegate) =>

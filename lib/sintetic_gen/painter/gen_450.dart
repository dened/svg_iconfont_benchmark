...
/// Gen450 widget.
/// {@endtemplate}
class Gen450 extends StatelessWidget {
  /// {@macro Gen450}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen450Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen450Painter}
/// Custom painter for [Gen450].
/// {@endtemplate}
class Gen450Painter extends CustomPainter {
  /// {@macro Gen450Painter}
  const Gen450Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen450Painter oldDelegate) =>

...
/// Gen452 widget.
/// {@endtemplate}
class Gen452 extends StatelessWidget {
  /// {@macro Gen452}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen452Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen452Painter}
/// Custom painter for [Gen452].
/// {@endtemplate}
class Gen452Painter extends CustomPainter {
  /// {@macro Gen452Painter}
  const Gen452Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen452Painter oldDelegate) =>

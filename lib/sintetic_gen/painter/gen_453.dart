...
/// Gen453 widget.
/// {@endtemplate}
class Gen453 extends StatelessWidget {
  /// {@macro Gen453}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen453Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen453Painter}
/// Custom painter for [Gen453].
/// {@endtemplate}
class Gen453Painter extends CustomPainter {
  /// {@macro Gen453Painter}
  const Gen453Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen453Painter oldDelegate) =>

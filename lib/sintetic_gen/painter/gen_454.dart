...
/// Gen454 widget.
/// {@endtemplate}
class Gen454 extends StatelessWidget {
  /// {@macro Gen454}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen454Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen454Painter}
/// Custom painter for [Gen454].
/// {@endtemplate}
class Gen454Painter extends CustomPainter {
  /// {@macro Gen454Painter}
  const Gen454Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen454Painter oldDelegate) =>

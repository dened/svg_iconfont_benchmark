...
/// Gen455 widget.
/// {@endtemplate}
class Gen455 extends StatelessWidget {
  /// {@macro Gen455}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen455Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen455Painter}
/// Custom painter for [Gen455].
/// {@endtemplate}
class Gen455Painter extends CustomPainter {
  /// {@macro Gen455Painter}
  const Gen455Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen455Painter oldDelegate) =>

...
/// Gen457 widget.
/// {@endtemplate}
class Gen457 extends StatelessWidget {
  /// {@macro Gen457}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen457Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen457Painter}
/// Custom painter for [Gen457].
/// {@endtemplate}
class Gen457Painter extends CustomPainter {
  /// {@macro Gen457Painter}
  const Gen457Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen457Painter oldDelegate) =>

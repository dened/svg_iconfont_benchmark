...
/// Gen461 widget.
/// {@endtemplate}
class Gen461 extends StatelessWidget {
  /// {@macro Gen461}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen461Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen461Painter}
/// Custom painter for [Gen461].
/// {@endtemplate}
class Gen461Painter extends CustomPainter {
  /// {@macro Gen461Painter}
  const Gen461Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen461Painter oldDelegate) =>

...
/// Gen463 widget.
/// {@endtemplate}
class Gen463 extends StatelessWidget {
  /// {@macro Gen463}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen463Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen463Painter}
/// Custom painter for [Gen463].
/// {@endtemplate}
class Gen463Painter extends CustomPainter {
  /// {@macro Gen463Painter}
  const Gen463Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen463Painter oldDelegate) =>

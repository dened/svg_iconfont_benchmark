...
/// Gen464 widget.
/// {@endtemplate}
class Gen464 extends StatelessWidget {
  /// {@macro Gen464}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen464Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen464Painter}
/// Custom painter for [Gen464].
/// {@endtemplate}
class Gen464Painter extends CustomPainter {
  /// {@macro Gen464Painter}
  const Gen464Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen464Painter oldDelegate) =>

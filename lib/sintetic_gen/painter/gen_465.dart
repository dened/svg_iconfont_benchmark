...
/// Gen465 widget.
/// {@endtemplate}
class Gen465 extends StatelessWidget {
  /// {@macro Gen465}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen465Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen465Painter}
/// Custom painter for [Gen465].
/// {@endtemplate}
class Gen465Painter extends CustomPainter {
  /// {@macro Gen465Painter}
  const Gen465Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen465Painter oldDelegate) =>

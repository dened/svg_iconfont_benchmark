...
/// Gen466 widget.
/// {@endtemplate}
class Gen466 extends StatelessWidget {
  /// {@macro Gen466}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen466Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen466Painter}
/// Custom painter for [Gen466].
/// {@endtemplate}
class Gen466Painter extends CustomPainter {
  /// {@macro Gen466Painter}
  const Gen466Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen466Painter oldDelegate) =>

...
/// Gen469 widget.
/// {@endtemplate}
class Gen469 extends StatelessWidget {
  /// {@macro Gen469}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen469Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen469Painter}
/// Custom painter for [Gen469].
/// {@endtemplate}
class Gen469Painter extends CustomPainter {
  /// {@macro Gen469Painter}
  const Gen469Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen469Painter oldDelegate) =>

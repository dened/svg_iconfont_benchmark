...
/// Gen470 widget.
/// {@endtemplate}
class Gen470 extends StatelessWidget {
  /// {@macro Gen470}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen470Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen470Painter}
/// Custom painter for [Gen470].
/// {@endtemplate}
class Gen470Painter extends CustomPainter {
  /// {@macro Gen470Painter}
  const Gen470Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen470Painter oldDelegate) =>

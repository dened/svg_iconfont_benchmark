...
/// Gen474 widget.
/// {@endtemplate}
class Gen474 extends StatelessWidget {
  /// {@macro Gen474}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen474Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen474Painter}
/// Custom painter for [Gen474].
/// {@endtemplate}
class Gen474Painter extends CustomPainter {
  /// {@macro Gen474Painter}
  const Gen474Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen474Painter oldDelegate) =>

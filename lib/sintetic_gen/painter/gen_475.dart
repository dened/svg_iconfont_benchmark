...
/// Gen475 widget.
/// {@endtemplate}
class Gen475 extends StatelessWidget {
  /// {@macro Gen475}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen475Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen475Painter}
/// Custom painter for [Gen475].
/// {@endtemplate}
class Gen475Painter extends CustomPainter {
  /// {@macro Gen475Painter}
  const Gen475Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen475Painter oldDelegate) =>

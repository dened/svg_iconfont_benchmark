...
/// Gen476 widget.
/// {@endtemplate}
class Gen476 extends StatelessWidget {
  /// {@macro Gen476}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen476Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen476Painter}
/// Custom painter for [Gen476].
/// {@endtemplate}
class Gen476Painter extends CustomPainter {
  /// {@macro Gen476Painter}
  const Gen476Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen476Painter oldDelegate) =>

...
/// Gen477 widget.
/// {@endtemplate}
class Gen477 extends StatelessWidget {
  /// {@macro Gen477}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen477Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen477Painter}
/// Custom painter for [Gen477].
/// {@endtemplate}
class Gen477Painter extends CustomPainter {
  /// {@macro Gen477Painter}
  const Gen477Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen477Painter oldDelegate) =>

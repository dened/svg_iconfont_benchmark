...
/// Gen478 widget.
/// {@endtemplate}
class Gen478 extends StatelessWidget {
  /// {@macro Gen478}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen478Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen478Painter}
/// Custom painter for [Gen478].
/// {@endtemplate}
class Gen478Painter extends CustomPainter {
  /// {@macro Gen478Painter}
  const Gen478Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen478Painter oldDelegate) =>

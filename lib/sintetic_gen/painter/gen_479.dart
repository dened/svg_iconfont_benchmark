...
/// Gen479 widget.
/// {@endtemplate}
class Gen479 extends StatelessWidget {
  /// {@macro Gen479}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen479Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen479Painter}
/// Custom painter for [Gen479].
/// {@endtemplate}
class Gen479Painter extends CustomPainter {
  /// {@macro Gen479Painter}
  const Gen479Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen479Painter oldDelegate) =>

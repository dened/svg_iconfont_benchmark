...
/// Gen481 widget.
/// {@endtemplate}
class Gen481 extends StatelessWidget {
  /// {@macro Gen481}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen481Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen481Painter}
/// Custom painter for [Gen481].
/// {@endtemplate}
class Gen481Painter extends CustomPainter {
  /// {@macro Gen481Painter}
  const Gen481Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen481Painter oldDelegate) =>

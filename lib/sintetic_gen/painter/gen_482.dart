...
/// Gen482 widget.
/// {@endtemplate}
class Gen482 extends StatelessWidget {
  /// {@macro Gen482}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen482Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen482Painter}
/// Custom painter for [Gen482].
/// {@endtemplate}
class Gen482Painter extends CustomPainter {
  /// {@macro Gen482Painter}
  const Gen482Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen482Painter oldDelegate) =>

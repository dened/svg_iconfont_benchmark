...
/// Gen483 widget.
/// {@endtemplate}
class Gen483 extends StatelessWidget {
  /// {@macro Gen483}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen483Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen483Painter}
/// Custom painter for [Gen483].
/// {@endtemplate}
class Gen483Painter extends CustomPainter {
  /// {@macro Gen483Painter}
  const Gen483Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen483Painter oldDelegate) =>

...
/// Gen485 widget.
/// {@endtemplate}
class Gen485 extends StatelessWidget {
  /// {@macro Gen485}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen485Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen485Painter}
/// Custom painter for [Gen485].
/// {@endtemplate}
class Gen485Painter extends CustomPainter {
  /// {@macro Gen485Painter}
  const Gen485Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen485Painter oldDelegate) =>

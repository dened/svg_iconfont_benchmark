...
/// Gen486 widget.
/// {@endtemplate}
class Gen486 extends StatelessWidget {
  /// {@macro Gen486}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen486Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen486Painter}
/// Custom painter for [Gen486].
/// {@endtemplate}
class Gen486Painter extends CustomPainter {
  /// {@macro Gen486Painter}
  const Gen486Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen486Painter oldDelegate) =>

...
/// Gen487 widget.
/// {@endtemplate}
class Gen487 extends StatelessWidget {
  /// {@macro Gen487}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen487Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen487Painter}
/// Custom painter for [Gen487].
/// {@endtemplate}
class Gen487Painter extends CustomPainter {
  /// {@macro Gen487Painter}
  const Gen487Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen487Painter oldDelegate) =>

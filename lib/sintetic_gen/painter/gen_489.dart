...
/// Gen489 widget.
/// {@endtemplate}
class Gen489 extends StatelessWidget {
  /// {@macro Gen489}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen489Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen489Painter}
/// Custom painter for [Gen489].
/// {@endtemplate}
class Gen489Painter extends CustomPainter {
  /// {@macro Gen489Painter}
  const Gen489Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen489Painter oldDelegate) =>

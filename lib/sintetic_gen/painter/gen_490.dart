...
/// Gen490 widget.
/// {@endtemplate}
class Gen490 extends StatelessWidget {
  /// {@macro Gen490}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen490Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen490Painter}
/// Custom painter for [Gen490].
/// {@endtemplate}
class Gen490Painter extends CustomPainter {
  /// {@macro Gen490Painter}
  const Gen490Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen490Painter oldDelegate) =>

...
/// Gen491 widget.
/// {@endtemplate}
class Gen491 extends StatelessWidget {
  /// {@macro Gen491}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen491Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen491Painter}
/// Custom painter for [Gen491].
/// {@endtemplate}
class Gen491Painter extends CustomPainter {
  /// {@macro Gen491Painter}
  const Gen491Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen491Painter oldDelegate) =>

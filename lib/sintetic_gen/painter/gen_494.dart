...
/// Gen494 widget.
/// {@endtemplate}
class Gen494 extends StatelessWidget {
  /// {@macro Gen494}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen494Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen494Painter}
/// Custom painter for [Gen494].
/// {@endtemplate}
class Gen494Painter extends CustomPainter {
  /// {@macro Gen494Painter}
  const Gen494Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen494Painter oldDelegate) =>

...
/// Gen495 widget.
/// {@endtemplate}
class Gen495 extends StatelessWidget {
  /// {@macro Gen495}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen495Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen495Painter}
/// Custom painter for [Gen495].
/// {@endtemplate}
class Gen495Painter extends CustomPainter {
  /// {@macro Gen495Painter}
  const Gen495Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen495Painter oldDelegate) =>

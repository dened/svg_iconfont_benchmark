...
/// Gen496 widget.
/// {@endtemplate}
class Gen496 extends StatelessWidget {
  /// {@macro Gen496}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen496Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen496Painter}
/// Custom painter for [Gen496].
/// {@endtemplate}
class Gen496Painter extends CustomPainter {
  /// {@macro Gen496Painter}
  const Gen496Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen496Painter oldDelegate) =>

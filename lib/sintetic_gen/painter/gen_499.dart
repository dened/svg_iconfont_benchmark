...
/// Gen499 widget.
/// {@endtemplate}
class Gen499 extends StatelessWidget {
  /// {@macro Gen499}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen499Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen499Painter}
/// Custom painter for [Gen499].
/// {@endtemplate}
class Gen499Painter extends CustomPainter {
  /// {@macro Gen499Painter}
  const Gen499Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen499Painter oldDelegate) =>

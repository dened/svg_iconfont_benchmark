...
/// Gen50 widget.
/// {@endtemplate}
class Gen50 extends StatelessWidget {
  /// {@macro Gen50}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen50Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen50Painter}
/// Custom painter for [Gen50].
/// {@endtemplate}
class Gen50Painter extends CustomPainter {
  /// {@macro Gen50Painter}
  const Gen50Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen50Painter oldDelegate) =>

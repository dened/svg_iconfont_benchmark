...
/// Gen51 widget.
/// {@endtemplate}
class Gen51 extends StatelessWidget {
  /// {@macro Gen51}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen51Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen51Painter}
/// Custom painter for [Gen51].
/// {@endtemplate}
class Gen51Painter extends CustomPainter {
  /// {@macro Gen51Painter}
  const Gen51Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen51Painter oldDelegate) =>

...
/// Gen53 widget.
/// {@endtemplate}
class Gen53 extends StatelessWidget {
  /// {@macro Gen53}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen53Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen53Painter}
/// Custom painter for [Gen53].
/// {@endtemplate}
class Gen53Painter extends CustomPainter {
  /// {@macro Gen53Painter}
  const Gen53Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen53Painter oldDelegate) =>

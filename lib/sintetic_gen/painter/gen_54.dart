...
/// Gen54 widget.
/// {@endtemplate}
class Gen54 extends StatelessWidget {
  /// {@macro Gen54}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen54Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen54Painter}
/// Custom painter for [Gen54].
/// {@endtemplate}
class Gen54Painter extends CustomPainter {
  /// {@macro Gen54Painter}
  const Gen54Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen54Painter oldDelegate) =>

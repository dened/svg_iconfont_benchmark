...
/// Gen56 widget.
/// {@endtemplate}
class Gen56 extends StatelessWidget {
  /// {@macro Gen56}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen56Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen56Painter}
/// Custom painter for [Gen56].
/// {@endtemplate}
class Gen56Painter extends CustomPainter {
  /// {@macro Gen56Painter}
  const Gen56Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen56Painter oldDelegate) =>

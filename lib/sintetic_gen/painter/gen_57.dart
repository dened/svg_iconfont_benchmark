...
/// Gen57 widget.
/// {@endtemplate}
class Gen57 extends StatelessWidget {
  /// {@macro Gen57}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen57Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen57Painter}
/// Custom painter for [Gen57].
/// {@endtemplate}
class Gen57Painter extends CustomPainter {
  /// {@macro Gen57Painter}
  const Gen57Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen57Painter oldDelegate) =>

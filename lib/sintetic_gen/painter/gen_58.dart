...
/// Gen58 widget.
/// {@endtemplate}
class Gen58 extends StatelessWidget {
  /// {@macro Gen58}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen58Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen58Painter}
/// Custom painter for [Gen58].
/// {@endtemplate}
class Gen58Painter extends CustomPainter {
  /// {@macro Gen58Painter}
  const Gen58Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen58Painter oldDelegate) =>

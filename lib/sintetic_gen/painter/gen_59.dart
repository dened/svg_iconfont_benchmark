...
/// Gen59 widget.
/// {@endtemplate}
class Gen59 extends StatelessWidget {
  /// {@macro Gen59}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen59Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen59Painter}
/// Custom painter for [Gen59].
/// {@endtemplate}
class Gen59Painter extends CustomPainter {
  /// {@macro Gen59Painter}
  const Gen59Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen59Painter oldDelegate) =>

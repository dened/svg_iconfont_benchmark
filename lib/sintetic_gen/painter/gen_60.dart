...
/// Gen60 widget.
/// {@endtemplate}
class Gen60 extends StatelessWidget {
  /// {@macro Gen60}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen60Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen60Painter}
/// Custom painter for [Gen60].
/// {@endtemplate}
class Gen60Painter extends CustomPainter {
  /// {@macro Gen60Painter}
  const Gen60Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen60Painter oldDelegate) =>

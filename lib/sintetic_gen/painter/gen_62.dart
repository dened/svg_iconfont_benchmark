...
/// Gen62 widget.
/// {@endtemplate}
class Gen62 extends StatelessWidget {
  /// {@macro Gen62}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen62Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen62Painter}
/// Custom painter for [Gen62].
/// {@endtemplate}
class Gen62Painter extends CustomPainter {
  /// {@macro Gen62Painter}
  const Gen62Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen62Painter oldDelegate) =>

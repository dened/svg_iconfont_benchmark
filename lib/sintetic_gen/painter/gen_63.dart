...
/// Gen63 widget.
/// {@endtemplate}
class Gen63 extends StatelessWidget {
  /// {@macro Gen63}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen63Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen63Painter}
/// Custom painter for [Gen63].
/// {@endtemplate}
class Gen63Painter extends CustomPainter {
  /// {@macro Gen63Painter}
  const Gen63Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen63Painter oldDelegate) =>

...
/// Gen65 widget.
/// {@endtemplate}
class Gen65 extends StatelessWidget {
  /// {@macro Gen65}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen65Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen65Painter}
/// Custom painter for [Gen65].
/// {@endtemplate}
class Gen65Painter extends CustomPainter {
  /// {@macro Gen65Painter}
  const Gen65Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen65Painter oldDelegate) =>

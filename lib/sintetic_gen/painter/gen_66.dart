...
/// Gen66 widget.
/// {@endtemplate}
class Gen66 extends StatelessWidget {
  /// {@macro Gen66}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen66Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen66Painter}
/// Custom painter for [Gen66].
/// {@endtemplate}
class Gen66Painter extends CustomPainter {
  /// {@macro Gen66Painter}
  const Gen66Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen66Painter oldDelegate) =>

...
/// Gen69 widget.
/// {@endtemplate}
class Gen69 extends StatelessWidget {
  /// {@macro Gen69}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen69Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen69Painter}
/// Custom painter for [Gen69].
/// {@endtemplate}
class Gen69Painter extends CustomPainter {
  /// {@macro Gen69Painter}
  const Gen69Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen69Painter oldDelegate) =>

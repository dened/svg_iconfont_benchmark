...
class Gen7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen7Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen7Painter}
/// Custom painter for [Gen7].
/// {@endtemplate}
class Gen7Painter extends CustomPainter {
  /// {@macro Gen7Painter}
  const Gen7Painter({ui.ColorFilter? colorFilter}) : _colorFilter = colorFilter;
  ...
  @override
  bool shouldRepaint(Gen7Painter oldDelegate) =>

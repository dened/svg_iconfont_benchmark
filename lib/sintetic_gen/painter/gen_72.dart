...
/// Gen72 widget.
/// {@endtemplate}
class Gen72 extends StatelessWidget {
  /// {@macro Gen72}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen72Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen72Painter}
/// Custom painter for [Gen72].
/// {@endtemplate}
class Gen72Painter extends CustomPainter {
  /// {@macro Gen72Painter}
  const Gen72Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen72Painter oldDelegate) =>

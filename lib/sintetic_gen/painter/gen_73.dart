...
/// Gen73 widget.
/// {@endtemplate}
class Gen73 extends StatelessWidget {
  /// {@macro Gen73}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen73Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen73Painter}
/// Custom painter for [Gen73].
/// {@endtemplate}
class Gen73Painter extends CustomPainter {
  /// {@macro Gen73Painter}
  const Gen73Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen73Painter oldDelegate) =>

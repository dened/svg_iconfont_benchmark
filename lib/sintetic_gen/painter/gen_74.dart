...
/// Gen74 widget.
/// {@endtemplate}
class Gen74 extends StatelessWidget {
  /// {@macro Gen74}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen74Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen74Painter}
/// Custom painter for [Gen74].
/// {@endtemplate}
class Gen74Painter extends CustomPainter {
  /// {@macro Gen74Painter}
  const Gen74Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen74Painter oldDelegate) =>

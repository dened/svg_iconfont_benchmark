...
/// Gen75 widget.
/// {@endtemplate}
class Gen75 extends StatelessWidget {
  /// {@macro Gen75}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen75Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen75Painter}
/// Custom painter for [Gen75].
/// {@endtemplate}
class Gen75Painter extends CustomPainter {
  /// {@macro Gen75Painter}
  const Gen75Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen75Painter oldDelegate) =>

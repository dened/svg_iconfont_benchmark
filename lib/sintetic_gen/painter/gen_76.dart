...
/// Gen76 widget.
/// {@endtemplate}
class Gen76 extends StatelessWidget {
  /// {@macro Gen76}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen76Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen76Painter}
/// Custom painter for [Gen76].
/// {@endtemplate}
class Gen76Painter extends CustomPainter {
  /// {@macro Gen76Painter}
  const Gen76Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen76Painter oldDelegate) =>

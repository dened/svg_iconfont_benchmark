...
/// Gen77 widget.
/// {@endtemplate}
class Gen77 extends StatelessWidget {
  /// {@macro Gen77}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen77Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen77Painter}
/// Custom painter for [Gen77].
/// {@endtemplate}
class Gen77Painter extends CustomPainter {
  /// {@macro Gen77Painter}
  const Gen77Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen77Painter oldDelegate) =>

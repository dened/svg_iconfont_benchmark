...
/// Gen78 widget.
/// {@endtemplate}
class Gen78 extends StatelessWidget {
  /// {@macro Gen78}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen78Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen78Painter}
/// Custom painter for [Gen78].
/// {@endtemplate}
class Gen78Painter extends CustomPainter {
  /// {@macro Gen78Painter}
  const Gen78Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen78Painter oldDelegate) =>

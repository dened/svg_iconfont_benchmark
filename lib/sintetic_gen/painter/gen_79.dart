...
/// Gen79 widget.
/// {@endtemplate}
class Gen79 extends StatelessWidget {
  /// {@macro Gen79}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen79Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen79Painter}
/// Custom painter for [Gen79].
/// {@endtemplate}
class Gen79Painter extends CustomPainter {
  /// {@macro Gen79Painter}
  const Gen79Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen79Painter oldDelegate) =>

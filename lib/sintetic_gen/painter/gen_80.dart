...
/// Gen80 widget.
/// {@endtemplate}
class Gen80 extends StatelessWidget {
  /// {@macro Gen80}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen80Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen80Painter}
/// Custom painter for [Gen80].
/// {@endtemplate}
class Gen80Painter extends CustomPainter {
  /// {@macro Gen80Painter}
  const Gen80Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen80Painter oldDelegate) =>

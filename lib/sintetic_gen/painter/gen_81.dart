...
/// Gen81 widget.
/// {@endtemplate}
class Gen81 extends StatelessWidget {
  /// {@macro Gen81}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen81Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen81Painter}
/// Custom painter for [Gen81].
/// {@endtemplate}
class Gen81Painter extends CustomPainter {
  /// {@macro Gen81Painter}
  const Gen81Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen81Painter oldDelegate) =>

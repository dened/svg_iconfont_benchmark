...
/// Gen82 widget.
/// {@endtemplate}
class Gen82 extends StatelessWidget {
  /// {@macro Gen82}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen82Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen82Painter}
/// Custom painter for [Gen82].
/// {@endtemplate}
class Gen82Painter extends CustomPainter {
  /// {@macro Gen82Painter}
  const Gen82Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen82Painter oldDelegate) =>

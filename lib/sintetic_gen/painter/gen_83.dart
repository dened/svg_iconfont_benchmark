...
/// Gen83 widget.
/// {@endtemplate}
class Gen83 extends StatelessWidget {
  /// {@macro Gen83}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen83Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen83Painter}
/// Custom painter for [Gen83].
/// {@endtemplate}
class Gen83Painter extends CustomPainter {
  /// {@macro Gen83Painter}
  const Gen83Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen83Painter oldDelegate) =>

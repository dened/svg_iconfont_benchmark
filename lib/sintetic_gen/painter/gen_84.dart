...
/// Gen84 widget.
/// {@endtemplate}
class Gen84 extends StatelessWidget {
  /// {@macro Gen84}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen84Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen84Painter}
/// Custom painter for [Gen84].
/// {@endtemplate}
class Gen84Painter extends CustomPainter {
  /// {@macro Gen84Painter}
  const Gen84Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen84Painter oldDelegate) =>

...
/// Gen88 widget.
/// {@endtemplate}
class Gen88 extends StatelessWidget {
  /// {@macro Gen88}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen88Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen88Painter}
/// Custom painter for [Gen88].
/// {@endtemplate}
class Gen88Painter extends CustomPainter {
  /// {@macro Gen88Painter}
  const Gen88Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen88Painter oldDelegate) =>

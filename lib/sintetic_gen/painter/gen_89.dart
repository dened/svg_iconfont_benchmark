...
/// Gen89 widget.
/// {@endtemplate}
class Gen89 extends StatelessWidget {
  /// {@macro Gen89}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen89Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen89Painter}
/// Custom painter for [Gen89].
/// {@endtemplate}
class Gen89Painter extends CustomPainter {
  /// {@macro Gen89Painter}
  const Gen89Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen89Painter oldDelegate) =>

...
/// Gen90 widget.
/// {@endtemplate}
class Gen90 extends StatelessWidget {
  /// {@macro Gen90}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen90Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen90Painter}
/// Custom painter for [Gen90].
/// {@endtemplate}
class Gen90Painter extends CustomPainter {
  /// {@macro Gen90Painter}
  const Gen90Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen90Painter oldDelegate) =>

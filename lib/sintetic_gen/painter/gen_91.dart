...
/// Gen91 widget.
/// {@endtemplate}
class Gen91 extends StatelessWidget {
  /// {@macro Gen91}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen91Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen91Painter}
/// Custom painter for [Gen91].
/// {@endtemplate}
class Gen91Painter extends CustomPainter {
  /// {@macro Gen91Painter}
  const Gen91Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen91Painter oldDelegate) =>

...
/// Gen92 widget.
/// {@endtemplate}
class Gen92 extends StatelessWidget {
  /// {@macro Gen92}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen92Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen92Painter}
/// Custom painter for [Gen92].
/// {@endtemplate}
class Gen92Painter extends CustomPainter {
  /// {@macro Gen92Painter}
  const Gen92Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen92Painter oldDelegate) =>

...
/// Gen93 widget.
/// {@endtemplate}
class Gen93 extends StatelessWidget {
  /// {@macro Gen93}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen93Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen93Painter}
/// Custom painter for [Gen93].
/// {@endtemplate}
class Gen93Painter extends CustomPainter {
  /// {@macro Gen93Painter}
  const Gen93Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen93Painter oldDelegate) =>

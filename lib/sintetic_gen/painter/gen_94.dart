...
/// Gen94 widget.
/// {@endtemplate}
class Gen94 extends StatelessWidget {
  /// {@macro Gen94}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen94Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen94Painter}
/// Custom painter for [Gen94].
/// {@endtemplate}
class Gen94Painter extends CustomPainter {
  /// {@macro Gen94Painter}
  const Gen94Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen94Painter oldDelegate) =>

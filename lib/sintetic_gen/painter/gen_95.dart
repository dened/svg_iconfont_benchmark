...
/// Gen95 widget.
/// {@endtemplate}
class Gen95 extends StatelessWidget {
  /// {@macro Gen95}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen95Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen95Painter}
/// Custom painter for [Gen95].
/// {@endtemplate}
class Gen95Painter extends CustomPainter {
  /// {@macro Gen95Painter}
  const Gen95Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen95Painter oldDelegate) =>

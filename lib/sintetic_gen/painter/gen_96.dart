...
/// Gen96 widget.
/// {@endtemplate}
class Gen96 extends StatelessWidget {
  /// {@macro Gen96}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen96Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen96Painter}
/// Custom painter for [Gen96].
/// {@endtemplate}
class Gen96Painter extends CustomPainter {
  /// {@macro Gen96Painter}
  const Gen96Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen96Painter oldDelegate) =>

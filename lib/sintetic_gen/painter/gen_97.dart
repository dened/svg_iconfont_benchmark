...
/// Gen97 widget.
/// {@endtemplate}
class Gen97 extends StatelessWidget {
  /// {@macro Gen97}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen97Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen97Painter}
/// Custom painter for [Gen97].
/// {@endtemplate}
class Gen97Painter extends CustomPainter {
  /// {@macro Gen97Painter}
  const Gen97Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen97Painter oldDelegate) =>

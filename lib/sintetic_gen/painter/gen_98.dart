...
/// Gen98 widget.
/// {@endtemplate}
class Gen98 extends StatelessWidget {
  /// {@macro Gen98}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen98Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen98Painter}
/// Custom painter for [Gen98].
/// {@endtemplate}
class Gen98Painter extends CustomPainter {
  /// {@macro Gen98Painter}
  const Gen98Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen98Painter oldDelegate) =>

...
/// Gen99 widget.
/// {@endtemplate}
class Gen99 extends StatelessWidget {
  /// {@macro Gen99}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: Gen99Painter(colorFilter: colorFilter),
        size: svgSize,
      ),
    );
  }
...
/// {@template Gen99Painter}
/// Custom painter for [Gen99].
/// {@endtemplate}
class Gen99Painter extends CustomPainter {
  /// {@macro Gen99Painter}
  const Gen99Painter({ui.ColorFilter? colorFilter})
  ...
  @override
  bool shouldRepaint(Gen99Painter oldDelegate) =>

...
/// Gen111 widget.
/// {@endtemplate}
class Gen111 extends LeafRenderObjectWidget {
  /// {@macro Gen111}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen111RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen111RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen111RenderObject extends RenderBox {
  Gen111RenderObject();

  final _painter = _Gen111Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen111.svgSize.width;
    final desiredHeight = _height ?? Gen111.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen111.svgSize.width == 0 || Gen111.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

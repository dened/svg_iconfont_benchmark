...
/// Gen112 widget.
/// {@endtemplate}
class Gen112 extends LeafRenderObjectWidget {
  /// {@macro Gen112}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen112RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen112RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen112RenderObject extends RenderBox {
  Gen112RenderObject();

  final _painter = _Gen112Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen112.svgSize.width;
    final desiredHeight = _height ?? Gen112.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen112.svgSize.width == 0 || Gen112.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

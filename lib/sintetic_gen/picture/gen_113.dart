...
/// Gen113 widget.
/// {@endtemplate}
class Gen113 extends LeafRenderObjectWidget {
  /// {@macro Gen113}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen113RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen113RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen113RenderObject extends RenderBox {
  Gen113RenderObject();

  final _painter = _Gen113Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen113.svgSize.width;
    final desiredHeight = _height ?? Gen113.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen113.svgSize.width == 0 || Gen113.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

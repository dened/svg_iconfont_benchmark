...
/// Gen122 widget.
/// {@endtemplate}
class Gen122 extends LeafRenderObjectWidget {
  /// {@macro Gen122}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen122RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen122RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen122RenderObject extends RenderBox {
  Gen122RenderObject();

  final _painter = _Gen122Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen122.svgSize.width;
    final desiredHeight = _height ?? Gen122.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen122.svgSize.width == 0 || Gen122.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen126 widget.
/// {@endtemplate}
class Gen126 extends LeafRenderObjectWidget {
  /// {@macro Gen126}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen126RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen126RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen126RenderObject extends RenderBox {
  Gen126RenderObject();

  final _painter = _Gen126Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen126.svgSize.width;
    final desiredHeight = _height ?? Gen126.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen126.svgSize.width == 0 || Gen126.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen127 widget.
/// {@endtemplate}
class Gen127 extends LeafRenderObjectWidget {
  /// {@macro Gen127}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen127RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen127RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen127RenderObject extends RenderBox {
  Gen127RenderObject();

  final _painter = _Gen127Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen127.svgSize.width;
    final desiredHeight = _height ?? Gen127.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen127.svgSize.width == 0 || Gen127.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen128 widget.
/// {@endtemplate}
class Gen128 extends LeafRenderObjectWidget {
  /// {@macro Gen128}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen128RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen128RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen128RenderObject extends RenderBox {
  Gen128RenderObject();

  final _painter = _Gen128Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen128.svgSize.width;
    final desiredHeight = _height ?? Gen128.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen128.svgSize.width == 0 || Gen128.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

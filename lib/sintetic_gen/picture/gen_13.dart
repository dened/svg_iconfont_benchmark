...
/// Gen13 widget.
/// {@endtemplate}
class Gen13 extends LeafRenderObjectWidget {
  /// {@macro Gen13}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen13RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen13RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen13RenderObject extends RenderBox {
  Gen13RenderObject();

  final _painter = _Gen13Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen13.svgSize.width;
    final desiredHeight = _height ?? Gen13.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen13.svgSize.width == 0 || Gen13.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

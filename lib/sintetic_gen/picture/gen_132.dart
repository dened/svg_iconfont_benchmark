...
/// Gen132 widget.
/// {@endtemplate}
class Gen132 extends LeafRenderObjectWidget {
  /// {@macro Gen132}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen132RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen132RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen132RenderObject extends RenderBox {
  Gen132RenderObject();

  final _painter = _Gen132Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen132.svgSize.width;
    final desiredHeight = _height ?? Gen132.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen132.svgSize.width == 0 || Gen132.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

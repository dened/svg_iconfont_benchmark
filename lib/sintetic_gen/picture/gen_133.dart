...
/// Gen133 widget.
/// {@endtemplate}
class Gen133 extends LeafRenderObjectWidget {
  /// {@macro Gen133}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen133RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen133RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen133RenderObject extends RenderBox {
  Gen133RenderObject();

  final _painter = _Gen133Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen133.svgSize.width;
    final desiredHeight = _height ?? Gen133.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen133.svgSize.width == 0 || Gen133.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen134 widget.
/// {@endtemplate}
class Gen134 extends LeafRenderObjectWidget {
  /// {@macro Gen134}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen134RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen134RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen134RenderObject extends RenderBox {
  Gen134RenderObject();

  final _painter = _Gen134Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen134.svgSize.width;
    final desiredHeight = _height ?? Gen134.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen134.svgSize.width == 0 || Gen134.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

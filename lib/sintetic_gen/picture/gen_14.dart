...
/// Gen14 widget.
/// {@endtemplate}
class Gen14 extends LeafRenderObjectWidget {
  /// {@macro Gen14}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen14RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen14RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen14RenderObject extends RenderBox {
  Gen14RenderObject();

  final _painter = _Gen14Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen14.svgSize.width;
    final desiredHeight = _height ?? Gen14.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen14.svgSize.width == 0 || Gen14.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

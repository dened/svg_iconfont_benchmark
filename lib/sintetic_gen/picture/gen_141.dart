...
/// Gen141 widget.
/// {@endtemplate}
class Gen141 extends LeafRenderObjectWidget {
  /// {@macro Gen141}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen141RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen141RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen141RenderObject extends RenderBox {
  Gen141RenderObject();

  final _painter = _Gen141Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen141.svgSize.width;
    final desiredHeight = _height ?? Gen141.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen141.svgSize.width == 0 || Gen141.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

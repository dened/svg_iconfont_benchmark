...
/// Gen142 widget.
/// {@endtemplate}
class Gen142 extends LeafRenderObjectWidget {
  /// {@macro Gen142}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen142RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen142RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen142RenderObject extends RenderBox {
  Gen142RenderObject();

  final _painter = _Gen142Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen142.svgSize.width;
    final desiredHeight = _height ?? Gen142.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen142.svgSize.width == 0 || Gen142.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

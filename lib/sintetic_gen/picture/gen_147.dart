...
/// Gen147 widget.
/// {@endtemplate}
class Gen147 extends LeafRenderObjectWidget {
  /// {@macro Gen147}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen147RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen147RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen147RenderObject extends RenderBox {
  Gen147RenderObject();

  final _painter = _Gen147Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen147.svgSize.width;
    final desiredHeight = _height ?? Gen147.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen147.svgSize.width == 0 || Gen147.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

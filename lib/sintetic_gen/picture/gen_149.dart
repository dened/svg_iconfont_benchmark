...
/// Gen149 widget.
/// {@endtemplate}
class Gen149 extends LeafRenderObjectWidget {
  /// {@macro Gen149}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen149RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen149RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen149RenderObject extends RenderBox {
  Gen149RenderObject();

  final _painter = _Gen149Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen149.svgSize.width;
    final desiredHeight = _height ?? Gen149.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen149.svgSize.width == 0 || Gen149.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

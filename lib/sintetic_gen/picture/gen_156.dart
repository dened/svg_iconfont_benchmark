...
/// Gen156 widget.
/// {@endtemplate}
class Gen156 extends LeafRenderObjectWidget {
  /// {@macro Gen156}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen156RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen156RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen156RenderObject extends RenderBox {
  Gen156RenderObject();

  final _painter = _Gen156Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen156.svgSize.width;
    final desiredHeight = _height ?? Gen156.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen156.svgSize.width == 0 || Gen156.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

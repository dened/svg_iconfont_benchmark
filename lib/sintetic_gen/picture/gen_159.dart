...
/// Gen159 widget.
/// {@endtemplate}
class Gen159 extends LeafRenderObjectWidget {
  /// {@macro Gen159}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen159RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen159RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen159RenderObject extends RenderBox {
  Gen159RenderObject();

  final _painter = _Gen159Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen159.svgSize.width;
    final desiredHeight = _height ?? Gen159.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen159.svgSize.width == 0 || Gen159.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

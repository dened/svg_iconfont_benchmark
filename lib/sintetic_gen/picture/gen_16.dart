...
/// Gen16 widget.
/// {@endtemplate}
class Gen16 extends LeafRenderObjectWidget {
  /// {@macro Gen16}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen16RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen16RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen16RenderObject extends RenderBox {
  Gen16RenderObject();

  final _painter = _Gen16Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen16.svgSize.width;
    final desiredHeight = _height ?? Gen16.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen16.svgSize.width == 0 || Gen16.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

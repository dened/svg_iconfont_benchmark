...
/// Gen160 widget.
/// {@endtemplate}
class Gen160 extends LeafRenderObjectWidget {
  /// {@macro Gen160}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen160RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen160RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen160RenderObject extends RenderBox {
  Gen160RenderObject();

  final _painter = _Gen160Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen160.svgSize.width;
    final desiredHeight = _height ?? Gen160.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen160.svgSize.width == 0 || Gen160.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

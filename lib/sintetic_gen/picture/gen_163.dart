...
/// Gen163 widget.
/// {@endtemplate}
class Gen163 extends LeafRenderObjectWidget {
  /// {@macro Gen163}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen163RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen163RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen163RenderObject extends RenderBox {
  Gen163RenderObject();

  final _painter = _Gen163Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen163.svgSize.width;
    final desiredHeight = _height ?? Gen163.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen163.svgSize.width == 0 || Gen163.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen169 widget.
/// {@endtemplate}
class Gen169 extends LeafRenderObjectWidget {
  /// {@macro Gen169}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen169RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen169RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen169RenderObject extends RenderBox {
  Gen169RenderObject();

  final _painter = _Gen169Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen169.svgSize.width;
    final desiredHeight = _height ?? Gen169.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen169.svgSize.width == 0 || Gen169.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen172 widget.
/// {@endtemplate}
class Gen172 extends LeafRenderObjectWidget {
  /// {@macro Gen172}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen172RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen172RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen172RenderObject extends RenderBox {
  Gen172RenderObject();

  final _painter = _Gen172Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen172.svgSize.width;
    final desiredHeight = _height ?? Gen172.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen172.svgSize.width == 0 || Gen172.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

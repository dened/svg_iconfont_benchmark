...
/// Gen173 widget.
/// {@endtemplate}
class Gen173 extends LeafRenderObjectWidget {
  /// {@macro Gen173}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen173RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen173RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen173RenderObject extends RenderBox {
  Gen173RenderObject();

  final _painter = _Gen173Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen173.svgSize.width;
    final desiredHeight = _height ?? Gen173.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen173.svgSize.width == 0 || Gen173.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen18 widget.
/// {@endtemplate}
class Gen18 extends LeafRenderObjectWidget {
  /// {@macro Gen18}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen18RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen18RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen18RenderObject extends RenderBox {
  Gen18RenderObject();

  final _painter = _Gen18Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen18.svgSize.width;
    final desiredHeight = _height ?? Gen18.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen18.svgSize.width == 0 || Gen18.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

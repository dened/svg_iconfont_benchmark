...
/// Gen180 widget.
/// {@endtemplate}
class Gen180 extends LeafRenderObjectWidget {
  /// {@macro Gen180}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen180RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen180RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen180RenderObject extends RenderBox {
  Gen180RenderObject();

  final _painter = _Gen180Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen180.svgSize.width;
    final desiredHeight = _height ?? Gen180.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen180.svgSize.width == 0 || Gen180.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

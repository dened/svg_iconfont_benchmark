...
/// Gen183 widget.
/// {@endtemplate}
class Gen183 extends LeafRenderObjectWidget {
  /// {@macro Gen183}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen183RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen183RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen183RenderObject extends RenderBox {
  Gen183RenderObject();

  final _painter = _Gen183Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen183.svgSize.width;
    final desiredHeight = _height ?? Gen183.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen183.svgSize.width == 0 || Gen183.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

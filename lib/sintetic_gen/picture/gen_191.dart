...
/// Gen191 widget.
/// {@endtemplate}
class Gen191 extends LeafRenderObjectWidget {
  /// {@macro Gen191}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen191RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen191RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen191RenderObject extends RenderBox {
  Gen191RenderObject();

  final _painter = _Gen191Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen191.svgSize.width;
    final desiredHeight = _height ?? Gen191.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen191.svgSize.width == 0 || Gen191.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

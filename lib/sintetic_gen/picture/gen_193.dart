...
/// Gen193 widget.
/// {@endtemplate}
class Gen193 extends LeafRenderObjectWidget {
  /// {@macro Gen193}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen193RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen193RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen193RenderObject extends RenderBox {
  Gen193RenderObject();

  final _painter = _Gen193Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen193.svgSize.width;
    final desiredHeight = _height ?? Gen193.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen193.svgSize.width == 0 || Gen193.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

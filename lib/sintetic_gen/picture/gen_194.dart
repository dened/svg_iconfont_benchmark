...
/// Gen194 widget.
/// {@endtemplate}
class Gen194 extends LeafRenderObjectWidget {
  /// {@macro Gen194}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen194RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen194RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen194RenderObject extends RenderBox {
  Gen194RenderObject();

  final _painter = _Gen194Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen194.svgSize.width;
    final desiredHeight = _height ?? Gen194.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen194.svgSize.width == 0 || Gen194.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

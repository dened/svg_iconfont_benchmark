...
/// Gen197 widget.
/// {@endtemplate}
class Gen197 extends LeafRenderObjectWidget {
  /// {@macro Gen197}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen197RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen197RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen197RenderObject extends RenderBox {
  Gen197RenderObject();

  final _painter = _Gen197Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen197.svgSize.width;
    final desiredHeight = _height ?? Gen197.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen197.svgSize.width == 0 || Gen197.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

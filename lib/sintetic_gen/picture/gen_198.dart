...
/// Gen198 widget.
/// {@endtemplate}
class Gen198 extends LeafRenderObjectWidget {
  /// {@macro Gen198}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen198RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen198RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen198RenderObject extends RenderBox {
  Gen198RenderObject();

  final _painter = _Gen198Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen198.svgSize.width;
    final desiredHeight = _height ?? Gen198.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen198.svgSize.width == 0 || Gen198.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

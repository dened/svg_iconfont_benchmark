...
/// Gen202 widget.
/// {@endtemplate}
class Gen202 extends LeafRenderObjectWidget {
  /// {@macro Gen202}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen202RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen202RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen202RenderObject extends RenderBox {
  Gen202RenderObject();

  final _painter = _Gen202Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen202.svgSize.width;
    final desiredHeight = _height ?? Gen202.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen202.svgSize.width == 0 || Gen202.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

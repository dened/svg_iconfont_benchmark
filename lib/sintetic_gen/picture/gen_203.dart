...
/// Gen203 widget.
/// {@endtemplate}
class Gen203 extends LeafRenderObjectWidget {
  /// {@macro Gen203}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen203RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen203RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen203RenderObject extends RenderBox {
  Gen203RenderObject();

  final _painter = _Gen203Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen203.svgSize.width;
    final desiredHeight = _height ?? Gen203.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen203.svgSize.width == 0 || Gen203.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

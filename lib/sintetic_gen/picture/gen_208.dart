...
/// Gen208 widget.
/// {@endtemplate}
class Gen208 extends LeafRenderObjectWidget {
  /// {@macro Gen208}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen208RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen208RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen208RenderObject extends RenderBox {
  Gen208RenderObject();

  final _painter = _Gen208Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen208.svgSize.width;
    final desiredHeight = _height ?? Gen208.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen208.svgSize.width == 0 || Gen208.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

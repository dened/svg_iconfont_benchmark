...
/// Gen209 widget.
/// {@endtemplate}
class Gen209 extends LeafRenderObjectWidget {
  /// {@macro Gen209}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen209RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen209RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen209RenderObject extends RenderBox {
  Gen209RenderObject();

  final _painter = _Gen209Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen209.svgSize.width;
    final desiredHeight = _height ?? Gen209.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen209.svgSize.width == 0 || Gen209.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

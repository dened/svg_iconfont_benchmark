...
/// Gen212 widget.
/// {@endtemplate}
class Gen212 extends LeafRenderObjectWidget {
  /// {@macro Gen212}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen212RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen212RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen212RenderObject extends RenderBox {
  Gen212RenderObject();

  final _painter = _Gen212Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen212.svgSize.width;
    final desiredHeight = _height ?? Gen212.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen212.svgSize.width == 0 || Gen212.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen214 widget.
/// {@endtemplate}
class Gen214 extends LeafRenderObjectWidget {
  /// {@macro Gen214}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen214RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen214RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen214RenderObject extends RenderBox {
  Gen214RenderObject();

  final _painter = _Gen214Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen214.svgSize.width;
    final desiredHeight = _height ?? Gen214.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen214.svgSize.width == 0 || Gen214.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen217 widget.
/// {@endtemplate}
class Gen217 extends LeafRenderObjectWidget {
  /// {@macro Gen217}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen217RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen217RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen217RenderObject extends RenderBox {
  Gen217RenderObject();

  final _painter = _Gen217Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen217.svgSize.width;
    final desiredHeight = _height ?? Gen217.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen217.svgSize.width == 0 || Gen217.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen223 widget.
/// {@endtemplate}
class Gen223 extends LeafRenderObjectWidget {
  /// {@macro Gen223}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen223RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen223RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen223RenderObject extends RenderBox {
  Gen223RenderObject();

  final _painter = _Gen223Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen223.svgSize.width;
    final desiredHeight = _height ?? Gen223.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen223.svgSize.width == 0 || Gen223.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

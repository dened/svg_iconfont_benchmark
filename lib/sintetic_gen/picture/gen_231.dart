...
/// Gen231 widget.
/// {@endtemplate}
class Gen231 extends LeafRenderObjectWidget {
  /// {@macro Gen231}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen231RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen231RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen231RenderObject extends RenderBox {
  Gen231RenderObject();

  final _painter = _Gen231Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen231.svgSize.width;
    final desiredHeight = _height ?? Gen231.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen231.svgSize.width == 0 || Gen231.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

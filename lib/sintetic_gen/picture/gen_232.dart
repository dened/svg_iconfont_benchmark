...
/// Gen232 widget.
/// {@endtemplate}
class Gen232 extends LeafRenderObjectWidget {
  /// {@macro Gen232}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen232RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen232RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen232RenderObject extends RenderBox {
  Gen232RenderObject();

  final _painter = _Gen232Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen232.svgSize.width;
    final desiredHeight = _height ?? Gen232.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen232.svgSize.width == 0 || Gen232.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

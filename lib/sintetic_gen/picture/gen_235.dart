...
/// Gen235 widget.
/// {@endtemplate}
class Gen235 extends LeafRenderObjectWidget {
  /// {@macro Gen235}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen235RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen235RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen235RenderObject extends RenderBox {
  Gen235RenderObject();

  final _painter = _Gen235Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen235.svgSize.width;
    final desiredHeight = _height ?? Gen235.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen235.svgSize.width == 0 || Gen235.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

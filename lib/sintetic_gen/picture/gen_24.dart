...
/// Gen24 widget.
/// {@endtemplate}
class Gen24 extends LeafRenderObjectWidget {
  /// {@macro Gen24}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen24RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen24RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen24RenderObject extends RenderBox {
  Gen24RenderObject();

  final _painter = _Gen24Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen24.svgSize.width;
    final desiredHeight = _height ?? Gen24.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen24.svgSize.width == 0 || Gen24.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

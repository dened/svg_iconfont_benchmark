...
/// Gen243 widget.
/// {@endtemplate}
class Gen243 extends LeafRenderObjectWidget {
  /// {@macro Gen243}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen243RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen243RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen243RenderObject extends RenderBox {
  Gen243RenderObject();

  final _painter = _Gen243Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen243.svgSize.width;
    final desiredHeight = _height ?? Gen243.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen243.svgSize.width == 0 || Gen243.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

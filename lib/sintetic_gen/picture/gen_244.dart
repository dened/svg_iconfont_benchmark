...
/// Gen244 widget.
/// {@endtemplate}
class Gen244 extends LeafRenderObjectWidget {
  /// {@macro Gen244}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen244RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen244RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen244RenderObject extends RenderBox {
  Gen244RenderObject();

  final _painter = _Gen244Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen244.svgSize.width;
    final desiredHeight = _height ?? Gen244.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen244.svgSize.width == 0 || Gen244.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

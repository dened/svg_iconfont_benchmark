...
/// Gen249 widget.
/// {@endtemplate}
class Gen249 extends LeafRenderObjectWidget {
  /// {@macro Gen249}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen249RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen249RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen249RenderObject extends RenderBox {
  Gen249RenderObject();

  final _painter = _Gen249Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen249.svgSize.width;
    final desiredHeight = _height ?? Gen249.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen249.svgSize.width == 0 || Gen249.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen250 widget.
/// {@endtemplate}
class Gen250 extends LeafRenderObjectWidget {
  /// {@macro Gen250}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen250RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen250RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen250RenderObject extends RenderBox {
  Gen250RenderObject();

  final _painter = _Gen250Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen250.svgSize.width;
    final desiredHeight = _height ?? Gen250.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen250.svgSize.width == 0 || Gen250.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

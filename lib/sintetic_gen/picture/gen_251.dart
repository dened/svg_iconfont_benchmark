...
/// Gen251 widget.
/// {@endtemplate}
class Gen251 extends LeafRenderObjectWidget {
  /// {@macro Gen251}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen251RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen251RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen251RenderObject extends RenderBox {
  Gen251RenderObject();

  final _painter = _Gen251Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen251.svgSize.width;
    final desiredHeight = _height ?? Gen251.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen251.svgSize.width == 0 || Gen251.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

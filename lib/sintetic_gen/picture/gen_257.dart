...
/// Gen257 widget.
/// {@endtemplate}
class Gen257 extends LeafRenderObjectWidget {
  /// {@macro Gen257}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen257RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen257RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen257RenderObject extends RenderBox {
  Gen257RenderObject();

  final _painter = _Gen257Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen257.svgSize.width;
    final desiredHeight = _height ?? Gen257.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen257.svgSize.width == 0 || Gen257.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

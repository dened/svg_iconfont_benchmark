...
/// Gen262 widget.
/// {@endtemplate}
class Gen262 extends LeafRenderObjectWidget {
  /// {@macro Gen262}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen262RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen262RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen262RenderObject extends RenderBox {
  Gen262RenderObject();

  final _painter = _Gen262Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen262.svgSize.width;
    final desiredHeight = _height ?? Gen262.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen262.svgSize.width == 0 || Gen262.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

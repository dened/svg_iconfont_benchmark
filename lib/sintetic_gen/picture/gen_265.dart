...
/// Gen265 widget.
/// {@endtemplate}
class Gen265 extends LeafRenderObjectWidget {
  /// {@macro Gen265}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen265RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen265RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen265RenderObject extends RenderBox {
  Gen265RenderObject();

  final _painter = _Gen265Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen265.svgSize.width;
    final desiredHeight = _height ?? Gen265.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen265.svgSize.width == 0 || Gen265.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen267 widget.
/// {@endtemplate}
class Gen267 extends LeafRenderObjectWidget {
  /// {@macro Gen267}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen267RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen267RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen267RenderObject extends RenderBox {
  Gen267RenderObject();

  final _painter = _Gen267Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen267.svgSize.width;
    final desiredHeight = _height ?? Gen267.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen267.svgSize.width == 0 || Gen267.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

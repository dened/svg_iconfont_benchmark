...
/// Gen269 widget.
/// {@endtemplate}
class Gen269 extends LeafRenderObjectWidget {
  /// {@macro Gen269}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen269RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen269RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen269RenderObject extends RenderBox {
  Gen269RenderObject();

  final _painter = _Gen269Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen269.svgSize.width;
    final desiredHeight = _height ?? Gen269.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen269.svgSize.width == 0 || Gen269.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen271 widget.
/// {@endtemplate}
class Gen271 extends LeafRenderObjectWidget {
  /// {@macro Gen271}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen271RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen271RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen271RenderObject extends RenderBox {
  Gen271RenderObject();

  final _painter = _Gen271Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen271.svgSize.width;
    final desiredHeight = _height ?? Gen271.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen271.svgSize.width == 0 || Gen271.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

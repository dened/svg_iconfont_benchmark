...
/// Gen272 widget.
/// {@endtemplate}
class Gen272 extends LeafRenderObjectWidget {
  /// {@macro Gen272}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen272RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen272RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen272RenderObject extends RenderBox {
  Gen272RenderObject();

  final _painter = _Gen272Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen272.svgSize.width;
    final desiredHeight = _height ?? Gen272.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen272.svgSize.width == 0 || Gen272.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

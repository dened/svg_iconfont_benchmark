...
/// Gen279 widget.
/// {@endtemplate}
class Gen279 extends LeafRenderObjectWidget {
  /// {@macro Gen279}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen279RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen279RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen279RenderObject extends RenderBox {
  Gen279RenderObject();

  final _painter = _Gen279Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen279.svgSize.width;
    final desiredHeight = _height ?? Gen279.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen279.svgSize.width == 0 || Gen279.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

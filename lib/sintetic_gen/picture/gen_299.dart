...
/// Gen299 widget.
/// {@endtemplate}
class Gen299 extends LeafRenderObjectWidget {
  /// {@macro Gen299}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen299RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen299RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen299RenderObject extends RenderBox {
  Gen299RenderObject();

  final _painter = _Gen299Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen299.svgSize.width;
    final desiredHeight = _height ?? Gen299.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen299.svgSize.width == 0 || Gen299.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen302 widget.
/// {@endtemplate}
class Gen302 extends LeafRenderObjectWidget {
  /// {@macro Gen302}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen302RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen302RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen302RenderObject extends RenderBox {
  Gen302RenderObject();

  final _painter = _Gen302Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen302.svgSize.width;
    final desiredHeight = _height ?? Gen302.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen302.svgSize.width == 0 || Gen302.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

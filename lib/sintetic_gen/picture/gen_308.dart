...
/// Gen308 widget.
/// {@endtemplate}
class Gen308 extends LeafRenderObjectWidget {
  /// {@macro Gen308}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen308RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen308RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen308RenderObject extends RenderBox {
  Gen308RenderObject();

  final _painter = _Gen308Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen308.svgSize.width;
    final desiredHeight = _height ?? Gen308.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen308.svgSize.width == 0 || Gen308.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen313 widget.
/// {@endtemplate}
class Gen313 extends LeafRenderObjectWidget {
  /// {@macro Gen313}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen313RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen313RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen313RenderObject extends RenderBox {
  Gen313RenderObject();

  final _painter = _Gen313Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen313.svgSize.width;
    final desiredHeight = _height ?? Gen313.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen313.svgSize.width == 0 || Gen313.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

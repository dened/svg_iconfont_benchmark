...
/// Gen314 widget.
/// {@endtemplate}
class Gen314 extends LeafRenderObjectWidget {
  /// {@macro Gen314}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen314RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen314RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen314RenderObject extends RenderBox {
  Gen314RenderObject();

  final _painter = _Gen314Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen314.svgSize.width;
    final desiredHeight = _height ?? Gen314.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen314.svgSize.width == 0 || Gen314.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

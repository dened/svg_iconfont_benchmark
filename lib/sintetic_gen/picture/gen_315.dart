...
/// Gen315 widget.
/// {@endtemplate}
class Gen315 extends LeafRenderObjectWidget {
  /// {@macro Gen315}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen315RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen315RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen315RenderObject extends RenderBox {
  Gen315RenderObject();

  final _painter = _Gen315Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen315.svgSize.width;
    final desiredHeight = _height ?? Gen315.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen315.svgSize.width == 0 || Gen315.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

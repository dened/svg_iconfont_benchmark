...
/// Gen321 widget.
/// {@endtemplate}
class Gen321 extends LeafRenderObjectWidget {
  /// {@macro Gen321}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen321RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen321RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen321RenderObject extends RenderBox {
  Gen321RenderObject();

  final _painter = _Gen321Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen321.svgSize.width;
    final desiredHeight = _height ?? Gen321.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen321.svgSize.width == 0 || Gen321.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

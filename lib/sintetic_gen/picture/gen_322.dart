...
/// Gen322 widget.
/// {@endtemplate}
class Gen322 extends LeafRenderObjectWidget {
  /// {@macro Gen322}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen322RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen322RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen322RenderObject extends RenderBox {
  Gen322RenderObject();

  final _painter = _Gen322Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen322.svgSize.width;
    final desiredHeight = _height ?? Gen322.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen322.svgSize.width == 0 || Gen322.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

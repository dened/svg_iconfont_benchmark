...
/// Gen323 widget.
/// {@endtemplate}
class Gen323 extends LeafRenderObjectWidget {
  /// {@macro Gen323}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen323RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen323RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen323RenderObject extends RenderBox {
  Gen323RenderObject();

  final _painter = _Gen323Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen323.svgSize.width;
    final desiredHeight = _height ?? Gen323.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen323.svgSize.width == 0 || Gen323.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen325 widget.
/// {@endtemplate}
class Gen325 extends LeafRenderObjectWidget {
  /// {@macro Gen325}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen325RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen325RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen325RenderObject extends RenderBox {
  Gen325RenderObject();

  final _painter = _Gen325Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen325.svgSize.width;
    final desiredHeight = _height ?? Gen325.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen325.svgSize.width == 0 || Gen325.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

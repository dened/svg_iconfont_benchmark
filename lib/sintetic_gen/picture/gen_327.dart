...
/// Gen327 widget.
/// {@endtemplate}
class Gen327 extends LeafRenderObjectWidget {
  /// {@macro Gen327}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen327RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen327RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen327RenderObject extends RenderBox {
  Gen327RenderObject();

  final _painter = _Gen327Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen327.svgSize.width;
    final desiredHeight = _height ?? Gen327.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen327.svgSize.width == 0 || Gen327.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen331 widget.
/// {@endtemplate}
class Gen331 extends LeafRenderObjectWidget {
  /// {@macro Gen331}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen331RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen331RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen331RenderObject extends RenderBox {
  Gen331RenderObject();

  final _painter = _Gen331Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen331.svgSize.width;
    final desiredHeight = _height ?? Gen331.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen331.svgSize.width == 0 || Gen331.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen335 widget.
/// {@endtemplate}
class Gen335 extends LeafRenderObjectWidget {
  /// {@macro Gen335}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen335RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen335RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen335RenderObject extends RenderBox {
  Gen335RenderObject();

  final _painter = _Gen335Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen335.svgSize.width;
    final desiredHeight = _height ?? Gen335.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen335.svgSize.width == 0 || Gen335.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen338 widget.
/// {@endtemplate}
class Gen338 extends LeafRenderObjectWidget {
  /// {@macro Gen338}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen338RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen338RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen338RenderObject extends RenderBox {
  Gen338RenderObject();

  final _painter = _Gen338Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen338.svgSize.width;
    final desiredHeight = _height ?? Gen338.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen338.svgSize.width == 0 || Gen338.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen340 widget.
/// {@endtemplate}
class Gen340 extends LeafRenderObjectWidget {
  /// {@macro Gen340}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen340RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen340RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen340RenderObject extends RenderBox {
  Gen340RenderObject();

  final _painter = _Gen340Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen340.svgSize.width;
    final desiredHeight = _height ?? Gen340.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen340.svgSize.width == 0 || Gen340.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

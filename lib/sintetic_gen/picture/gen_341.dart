...
/// Gen341 widget.
/// {@endtemplate}
class Gen341 extends LeafRenderObjectWidget {
  /// {@macro Gen341}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen341RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen341RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen341RenderObject extends RenderBox {
  Gen341RenderObject();

  final _painter = _Gen341Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen341.svgSize.width;
    final desiredHeight = _height ?? Gen341.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen341.svgSize.width == 0 || Gen341.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen343 widget.
/// {@endtemplate}
class Gen343 extends LeafRenderObjectWidget {
  /// {@macro Gen343}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen343RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen343RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen343RenderObject extends RenderBox {
  Gen343RenderObject();

  final _painter = _Gen343Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen343.svgSize.width;
    final desiredHeight = _height ?? Gen343.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen343.svgSize.width == 0 || Gen343.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

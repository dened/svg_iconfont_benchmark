...
/// Gen346 widget.
/// {@endtemplate}
class Gen346 extends LeafRenderObjectWidget {
  /// {@macro Gen346}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen346RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen346RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen346RenderObject extends RenderBox {
  Gen346RenderObject();

  final _painter = _Gen346Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen346.svgSize.width;
    final desiredHeight = _height ?? Gen346.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen346.svgSize.width == 0 || Gen346.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

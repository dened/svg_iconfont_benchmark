...
/// Gen347 widget.
/// {@endtemplate}
class Gen347 extends LeafRenderObjectWidget {
  /// {@macro Gen347}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen347RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen347RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen347RenderObject extends RenderBox {
  Gen347RenderObject();

  final _painter = _Gen347Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen347.svgSize.width;
    final desiredHeight = _height ?? Gen347.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen347.svgSize.width == 0 || Gen347.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

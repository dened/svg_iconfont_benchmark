...
/// Gen350 widget.
/// {@endtemplate}
class Gen350 extends LeafRenderObjectWidget {
  /// {@macro Gen350}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen350RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen350RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen350RenderObject extends RenderBox {
  Gen350RenderObject();

  final _painter = _Gen350Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen350.svgSize.width;
    final desiredHeight = _height ?? Gen350.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen350.svgSize.width == 0 || Gen350.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

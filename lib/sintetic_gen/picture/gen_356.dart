...
/// Gen356 widget.
/// {@endtemplate}
class Gen356 extends LeafRenderObjectWidget {
  /// {@macro Gen356}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen356RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen356RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen356RenderObject extends RenderBox {
  Gen356RenderObject();

  final _painter = _Gen356Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen356.svgSize.width;
    final desiredHeight = _height ?? Gen356.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen356.svgSize.width == 0 || Gen356.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen359 widget.
/// {@endtemplate}
class Gen359 extends LeafRenderObjectWidget {
  /// {@macro Gen359}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen359RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen359RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen359RenderObject extends RenderBox {
  Gen359RenderObject();

  final _painter = _Gen359Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen359.svgSize.width;
    final desiredHeight = _height ?? Gen359.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen359.svgSize.width == 0 || Gen359.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

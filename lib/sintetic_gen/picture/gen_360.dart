...
/// Gen360 widget.
/// {@endtemplate}
class Gen360 extends LeafRenderObjectWidget {
  /// {@macro Gen360}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen360RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen360RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen360RenderObject extends RenderBox {
  Gen360RenderObject();

  final _painter = _Gen360Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen360.svgSize.width;
    final desiredHeight = _height ?? Gen360.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen360.svgSize.width == 0 || Gen360.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

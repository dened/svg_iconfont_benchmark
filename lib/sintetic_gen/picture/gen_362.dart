...
/// Gen362 widget.
/// {@endtemplate}
class Gen362 extends LeafRenderObjectWidget {
  /// {@macro Gen362}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen362RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen362RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen362RenderObject extends RenderBox {
  Gen362RenderObject();

  final _painter = _Gen362Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen362.svgSize.width;
    final desiredHeight = _height ?? Gen362.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen362.svgSize.width == 0 || Gen362.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen364 widget.
/// {@endtemplate}
class Gen364 extends LeafRenderObjectWidget {
  /// {@macro Gen364}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen364RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen364RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen364RenderObject extends RenderBox {
  Gen364RenderObject();

  final _painter = _Gen364Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen364.svgSize.width;
    final desiredHeight = _height ?? Gen364.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen364.svgSize.width == 0 || Gen364.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

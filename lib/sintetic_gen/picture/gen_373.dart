...
/// Gen373 widget.
/// {@endtemplate}
class Gen373 extends LeafRenderObjectWidget {
  /// {@macro Gen373}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen373RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen373RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen373RenderObject extends RenderBox {
  Gen373RenderObject();

  final _painter = _Gen373Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen373.svgSize.width;
    final desiredHeight = _height ?? Gen373.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen373.svgSize.width == 0 || Gen373.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

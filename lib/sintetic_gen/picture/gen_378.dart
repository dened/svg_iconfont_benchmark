...
/// Gen378 widget.
/// {@endtemplate}
class Gen378 extends LeafRenderObjectWidget {
  /// {@macro Gen378}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen378RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen378RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen378RenderObject extends RenderBox {
  Gen378RenderObject();

  final _painter = _Gen378Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen378.svgSize.width;
    final desiredHeight = _height ?? Gen378.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen378.svgSize.width == 0 || Gen378.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

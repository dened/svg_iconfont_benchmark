...
/// Gen387 widget.
/// {@endtemplate}
class Gen387 extends LeafRenderObjectWidget {
  /// {@macro Gen387}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen387RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen387RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen387RenderObject extends RenderBox {
  Gen387RenderObject();

  final _painter = _Gen387Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen387.svgSize.width;
    final desiredHeight = _height ?? Gen387.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen387.svgSize.width == 0 || Gen387.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

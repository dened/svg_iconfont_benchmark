...
/// Gen391 widget.
/// {@endtemplate}
class Gen391 extends LeafRenderObjectWidget {
  /// {@macro Gen391}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen391RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen391RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen391RenderObject extends RenderBox {
  Gen391RenderObject();

  final _painter = _Gen391Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen391.svgSize.width;
    final desiredHeight = _height ?? Gen391.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen391.svgSize.width == 0 || Gen391.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen395 widget.
/// {@endtemplate}
class Gen395 extends LeafRenderObjectWidget {
  /// {@macro Gen395}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen395RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen395RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen395RenderObject extends RenderBox {
  Gen395RenderObject();

  final _painter = _Gen395Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen395.svgSize.width;
    final desiredHeight = _height ?? Gen395.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen395.svgSize.width == 0 || Gen395.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

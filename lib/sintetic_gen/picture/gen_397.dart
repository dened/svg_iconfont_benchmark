...
/// Gen397 widget.
/// {@endtemplate}
class Gen397 extends LeafRenderObjectWidget {
  /// {@macro Gen397}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen397RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen397RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen397RenderObject extends RenderBox {
  Gen397RenderObject();

  final _painter = _Gen397Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen397.svgSize.width;
    final desiredHeight = _height ?? Gen397.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen397.svgSize.width == 0 || Gen397.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen398 widget.
/// {@endtemplate}
class Gen398 extends LeafRenderObjectWidget {
  /// {@macro Gen398}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen398RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen398RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen398RenderObject extends RenderBox {
  Gen398RenderObject();

  final _painter = _Gen398Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen398.svgSize.width;
    final desiredHeight = _height ?? Gen398.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen398.svgSize.width == 0 || Gen398.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

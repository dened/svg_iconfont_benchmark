...
/// Gen399 widget.
/// {@endtemplate}
class Gen399 extends LeafRenderObjectWidget {
  /// {@macro Gen399}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen399RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen399RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen399RenderObject extends RenderBox {
  Gen399RenderObject();

  final _painter = _Gen399Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen399.svgSize.width;
    final desiredHeight = _height ?? Gen399.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen399.svgSize.width == 0 || Gen399.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

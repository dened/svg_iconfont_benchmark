...
/// Gen4 widget.
/// {@endtemplate}
class Gen4 extends LeafRenderObjectWidget {
  /// {@macro Gen4}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen4RenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, Gen4RenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class Gen4RenderObject extends RenderBox {
  Gen4RenderObject();

  final _painter = _Gen4Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen4.svgSize.width;
    final desiredHeight = _height ?? Gen4.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen4.svgSize.width == 0 || Gen4.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

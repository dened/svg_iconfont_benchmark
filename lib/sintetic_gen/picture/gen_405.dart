...
/// Gen405 widget.
/// {@endtemplate}
class Gen405 extends LeafRenderObjectWidget {
  /// {@macro Gen405}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen405RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen405RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen405RenderObject extends RenderBox {
  Gen405RenderObject();

  final _painter = _Gen405Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen405.svgSize.width;
    final desiredHeight = _height ?? Gen405.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen405.svgSize.width == 0 || Gen405.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

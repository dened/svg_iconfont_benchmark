...
/// Gen406 widget.
/// {@endtemplate}
class Gen406 extends LeafRenderObjectWidget {
  /// {@macro Gen406}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen406RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen406RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen406RenderObject extends RenderBox {
  Gen406RenderObject();

  final _painter = _Gen406Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen406.svgSize.width;
    final desiredHeight = _height ?? Gen406.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen406.svgSize.width == 0 || Gen406.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

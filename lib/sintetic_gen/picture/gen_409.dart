...
/// Gen409 widget.
/// {@endtemplate}
class Gen409 extends LeafRenderObjectWidget {
  /// {@macro Gen409}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen409RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen409RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen409RenderObject extends RenderBox {
  Gen409RenderObject();

  final _painter = _Gen409Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen409.svgSize.width;
    final desiredHeight = _height ?? Gen409.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen409.svgSize.width == 0 || Gen409.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen412 widget.
/// {@endtemplate}
class Gen412 extends LeafRenderObjectWidget {
  /// {@macro Gen412}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen412RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen412RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen412RenderObject extends RenderBox {
  Gen412RenderObject();

  final _painter = _Gen412Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen412.svgSize.width;
    final desiredHeight = _height ?? Gen412.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen412.svgSize.width == 0 || Gen412.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

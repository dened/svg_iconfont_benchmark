...
/// Gen416 widget.
/// {@endtemplate}
class Gen416 extends LeafRenderObjectWidget {
  /// {@macro Gen416}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen416RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen416RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen416RenderObject extends RenderBox {
  Gen416RenderObject();

  final _painter = _Gen416Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen416.svgSize.width;
    final desiredHeight = _height ?? Gen416.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen416.svgSize.width == 0 || Gen416.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

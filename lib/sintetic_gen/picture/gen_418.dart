...
/// Gen418 widget.
/// {@endtemplate}
class Gen418 extends LeafRenderObjectWidget {
  /// {@macro Gen418}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen418RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen418RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen418RenderObject extends RenderBox {
  Gen418RenderObject();

  final _painter = _Gen418Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen418.svgSize.width;
    final desiredHeight = _height ?? Gen418.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen418.svgSize.width == 0 || Gen418.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen42 widget.
/// {@endtemplate}
class Gen42 extends LeafRenderObjectWidget {
  /// {@macro Gen42}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen42RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen42RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen42RenderObject extends RenderBox {
  Gen42RenderObject();

  final _painter = _Gen42Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen42.svgSize.width;
    final desiredHeight = _height ?? Gen42.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen42.svgSize.width == 0 || Gen42.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

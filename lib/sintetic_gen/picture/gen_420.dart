...
/// Gen420 widget.
/// {@endtemplate}
class Gen420 extends LeafRenderObjectWidget {
  /// {@macro Gen420}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen420RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen420RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen420RenderObject extends RenderBox {
  Gen420RenderObject();

  final _painter = _Gen420Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen420.svgSize.width;
    final desiredHeight = _height ?? Gen420.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen420.svgSize.width == 0 || Gen420.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen422 widget.
/// {@endtemplate}
class Gen422 extends LeafRenderObjectWidget {
  /// {@macro Gen422}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen422RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen422RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen422RenderObject extends RenderBox {
  Gen422RenderObject();

  final _painter = _Gen422Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen422.svgSize.width;
    final desiredHeight = _height ?? Gen422.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen422.svgSize.width == 0 || Gen422.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

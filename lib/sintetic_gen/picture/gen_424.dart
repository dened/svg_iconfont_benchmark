...
/// Gen424 widget.
/// {@endtemplate}
class Gen424 extends LeafRenderObjectWidget {
  /// {@macro Gen424}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen424RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen424RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen424RenderObject extends RenderBox {
  Gen424RenderObject();

  final _painter = _Gen424Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen424.svgSize.width;
    final desiredHeight = _height ?? Gen424.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen424.svgSize.width == 0 || Gen424.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

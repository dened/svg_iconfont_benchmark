...
/// Gen426 widget.
/// {@endtemplate}
class Gen426 extends LeafRenderObjectWidget {
  /// {@macro Gen426}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen426RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen426RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen426RenderObject extends RenderBox {
  Gen426RenderObject();

  final _painter = _Gen426Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen426.svgSize.width;
    final desiredHeight = _height ?? Gen426.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen426.svgSize.width == 0 || Gen426.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

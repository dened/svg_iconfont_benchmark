...
/// Gen43 widget.
/// {@endtemplate}
class Gen43 extends LeafRenderObjectWidget {
  /// {@macro Gen43}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen43RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen43RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen43RenderObject extends RenderBox {
  Gen43RenderObject();

  final _painter = _Gen43Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen43.svgSize.width;
    final desiredHeight = _height ?? Gen43.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen43.svgSize.width == 0 || Gen43.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen438 widget.
/// {@endtemplate}
class Gen438 extends LeafRenderObjectWidget {
  /// {@macro Gen438}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen438RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen438RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen438RenderObject extends RenderBox {
  Gen438RenderObject();

  final _painter = _Gen438Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen438.svgSize.width;
    final desiredHeight = _height ?? Gen438.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen438.svgSize.width == 0 || Gen438.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen445 widget.
/// {@endtemplate}
class Gen445 extends LeafRenderObjectWidget {
  /// {@macro Gen445}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen445RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen445RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen445RenderObject extends RenderBox {
  Gen445RenderObject();

  final _painter = _Gen445Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen445.svgSize.width;
    final desiredHeight = _height ?? Gen445.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen445.svgSize.width == 0 || Gen445.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

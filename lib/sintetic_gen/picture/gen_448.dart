...
/// Gen448 widget.
/// {@endtemplate}
class Gen448 extends LeafRenderObjectWidget {
  /// {@macro Gen448}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen448RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen448RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen448RenderObject extends RenderBox {
  Gen448RenderObject();

  final _painter = _Gen448Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen448.svgSize.width;
    final desiredHeight = _height ?? Gen448.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen448.svgSize.width == 0 || Gen448.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

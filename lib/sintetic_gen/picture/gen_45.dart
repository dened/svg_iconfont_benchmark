...
/// Gen45 widget.
/// {@endtemplate}
class Gen45 extends LeafRenderObjectWidget {
  /// {@macro Gen45}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen45RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen45RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen45RenderObject extends RenderBox {
  Gen45RenderObject();

  final _painter = _Gen45Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen45.svgSize.width;
    final desiredHeight = _height ?? Gen45.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen45.svgSize.width == 0 || Gen45.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen451 widget.
/// {@endtemplate}
class Gen451 extends LeafRenderObjectWidget {
  /// {@macro Gen451}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen451RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen451RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen451RenderObject extends RenderBox {
  Gen451RenderObject();

  final _painter = _Gen451Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen451.svgSize.width;
    final desiredHeight = _height ?? Gen451.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen451.svgSize.width == 0 || Gen451.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen456 widget.
/// {@endtemplate}
class Gen456 extends LeafRenderObjectWidget {
  /// {@macro Gen456}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen456RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen456RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen456RenderObject extends RenderBox {
  Gen456RenderObject();

  final _painter = _Gen456Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen456.svgSize.width;
    final desiredHeight = _height ?? Gen456.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen456.svgSize.width == 0 || Gen456.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen458 widget.
/// {@endtemplate}
class Gen458 extends LeafRenderObjectWidget {
  /// {@macro Gen458}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen458RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen458RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen458RenderObject extends RenderBox {
  Gen458RenderObject();

  final _painter = _Gen458Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen458.svgSize.width;
    final desiredHeight = _height ?? Gen458.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen458.svgSize.width == 0 || Gen458.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen459 widget.
/// {@endtemplate}
class Gen459 extends LeafRenderObjectWidget {
  /// {@macro Gen459}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen459RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen459RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen459RenderObject extends RenderBox {
  Gen459RenderObject();

  final _painter = _Gen459Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen459.svgSize.width;
    final desiredHeight = _height ?? Gen459.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen459.svgSize.width == 0 || Gen459.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

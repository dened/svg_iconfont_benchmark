...
/// Gen46 widget.
/// {@endtemplate}
class Gen46 extends LeafRenderObjectWidget {
  /// {@macro Gen46}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen46RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen46RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen46RenderObject extends RenderBox {
  Gen46RenderObject();

  final _painter = _Gen46Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen46.svgSize.width;
    final desiredHeight = _height ?? Gen46.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen46.svgSize.width == 0 || Gen46.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

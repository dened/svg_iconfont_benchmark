...
/// Gen460 widget.
/// {@endtemplate}
class Gen460 extends LeafRenderObjectWidget {
  /// {@macro Gen460}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen460RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen460RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen460RenderObject extends RenderBox {
  Gen460RenderObject();

  final _painter = _Gen460Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen460.svgSize.width;
    final desiredHeight = _height ?? Gen460.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen460.svgSize.width == 0 || Gen460.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen462 widget.
/// {@endtemplate}
class Gen462 extends LeafRenderObjectWidget {
  /// {@macro Gen462}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen462RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen462RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen462RenderObject extends RenderBox {
  Gen462RenderObject();

  final _painter = _Gen462Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen462.svgSize.width;
    final desiredHeight = _height ?? Gen462.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen462.svgSize.width == 0 || Gen462.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

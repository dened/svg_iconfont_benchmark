...
/// Gen467 widget.
/// {@endtemplate}
class Gen467 extends LeafRenderObjectWidget {
  /// {@macro Gen467}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen467RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen467RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen467RenderObject extends RenderBox {
  Gen467RenderObject();

  final _painter = _Gen467Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen467.svgSize.width;
    final desiredHeight = _height ?? Gen467.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen467.svgSize.width == 0 || Gen467.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

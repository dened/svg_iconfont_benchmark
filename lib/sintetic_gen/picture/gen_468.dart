...
/// Gen468 widget.
/// {@endtemplate}
class Gen468 extends LeafRenderObjectWidget {
  /// {@macro Gen468}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen468RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen468RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen468RenderObject extends RenderBox {
  Gen468RenderObject();

  final _painter = _Gen468Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen468.svgSize.width;
    final desiredHeight = _height ?? Gen468.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen468.svgSize.width == 0 || Gen468.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

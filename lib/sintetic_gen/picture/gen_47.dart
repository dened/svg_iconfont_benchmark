...
/// Gen47 widget.
/// {@endtemplate}
class Gen47 extends LeafRenderObjectWidget {
  /// {@macro Gen47}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen47RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen47RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen47RenderObject extends RenderBox {
  Gen47RenderObject();

  final _painter = _Gen47Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen47.svgSize.width;
    final desiredHeight = _height ?? Gen47.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen47.svgSize.width == 0 || Gen47.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen471 widget.
/// {@endtemplate}
class Gen471 extends LeafRenderObjectWidget {
  /// {@macro Gen471}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen471RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen471RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen471RenderObject extends RenderBox {
  Gen471RenderObject();

  final _painter = _Gen471Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen471.svgSize.width;
    final desiredHeight = _height ?? Gen471.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen471.svgSize.width == 0 || Gen471.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

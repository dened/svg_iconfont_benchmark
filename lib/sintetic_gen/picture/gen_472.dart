...
/// Gen472 widget.
/// {@endtemplate}
class Gen472 extends LeafRenderObjectWidget {
  /// {@macro Gen472}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen472RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen472RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen472RenderObject extends RenderBox {
  Gen472RenderObject();

  final _painter = _Gen472Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen472.svgSize.width;
    final desiredHeight = _height ?? Gen472.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen472.svgSize.width == 0 || Gen472.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

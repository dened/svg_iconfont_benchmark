...
/// Gen473 widget.
/// {@endtemplate}
class Gen473 extends LeafRenderObjectWidget {
  /// {@macro Gen473}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen473RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen473RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen473RenderObject extends RenderBox {
  Gen473RenderObject();

  final _painter = _Gen473Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen473.svgSize.width;
    final desiredHeight = _height ?? Gen473.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen473.svgSize.width == 0 || Gen473.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

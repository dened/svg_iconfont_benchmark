...
/// Gen48 widget.
/// {@endtemplate}
class Gen48 extends LeafRenderObjectWidget {
  /// {@macro Gen48}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen48RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen48RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen48RenderObject extends RenderBox {
  Gen48RenderObject();

  final _painter = _Gen48Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen48.svgSize.width;
    final desiredHeight = _height ?? Gen48.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen48.svgSize.width == 0 || Gen48.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

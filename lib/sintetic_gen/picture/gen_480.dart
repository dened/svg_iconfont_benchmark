...
/// Gen480 widget.
/// {@endtemplate}
class Gen480 extends LeafRenderObjectWidget {
  /// {@macro Gen480}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen480RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen480RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen480RenderObject extends RenderBox {
  Gen480RenderObject();

  final _painter = _Gen480Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen480.svgSize.width;
    final desiredHeight = _height ?? Gen480.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen480.svgSize.width == 0 || Gen480.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

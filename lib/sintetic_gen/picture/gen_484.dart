...
/// Gen484 widget.
/// {@endtemplate}
class Gen484 extends LeafRenderObjectWidget {
  /// {@macro Gen484}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen484RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen484RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen484RenderObject extends RenderBox {
  Gen484RenderObject();

  final _painter = _Gen484Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen484.svgSize.width;
    final desiredHeight = _height ?? Gen484.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen484.svgSize.width == 0 || Gen484.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

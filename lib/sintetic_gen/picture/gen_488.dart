...
/// Gen488 widget.
/// {@endtemplate}
class Gen488 extends LeafRenderObjectWidget {
  /// {@macro Gen488}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen488RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen488RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen488RenderObject extends RenderBox {
  Gen488RenderObject();

  final _painter = _Gen488Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen488.svgSize.width;
    final desiredHeight = _height ?? Gen488.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen488.svgSize.width == 0 || Gen488.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

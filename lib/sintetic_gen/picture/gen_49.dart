...
/// Gen49 widget.
/// {@endtemplate}
class Gen49 extends LeafRenderObjectWidget {
  /// {@macro Gen49}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen49RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen49RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen49RenderObject extends RenderBox {
  Gen49RenderObject();

  final _painter = _Gen49Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen49.svgSize.width;
    final desiredHeight = _height ?? Gen49.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen49.svgSize.width == 0 || Gen49.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen492 widget.
/// {@endtemplate}
class Gen492 extends LeafRenderObjectWidget {
  /// {@macro Gen492}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen492RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen492RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen492RenderObject extends RenderBox {
  Gen492RenderObject();

  final _painter = _Gen492Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen492.svgSize.width;
    final desiredHeight = _height ?? Gen492.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen492.svgSize.width == 0 || Gen492.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

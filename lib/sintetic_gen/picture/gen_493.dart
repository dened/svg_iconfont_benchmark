...
/// Gen493 widget.
/// {@endtemplate}
class Gen493 extends LeafRenderObjectWidget {
  /// {@macro Gen493}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen493RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen493RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen493RenderObject extends RenderBox {
  Gen493RenderObject();

  final _painter = _Gen493Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen493.svgSize.width;
    final desiredHeight = _height ?? Gen493.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen493.svgSize.width == 0 || Gen493.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

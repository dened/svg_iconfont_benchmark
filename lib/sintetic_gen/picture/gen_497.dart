...
/// Gen497 widget.
/// {@endtemplate}
class Gen497 extends LeafRenderObjectWidget {
  /// {@macro Gen497}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen497RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen497RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen497RenderObject extends RenderBox {
  Gen497RenderObject();

  final _painter = _Gen497Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen497.svgSize.width;
    final desiredHeight = _height ?? Gen497.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen497.svgSize.width == 0 || Gen497.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

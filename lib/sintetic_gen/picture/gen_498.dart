...
/// Gen498 widget.
/// {@endtemplate}
class Gen498 extends LeafRenderObjectWidget {
  /// {@macro Gen498}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen498RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen498RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen498RenderObject extends RenderBox {
  Gen498RenderObject();

  final _painter = _Gen498Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen498.svgSize.width;
    final desiredHeight = _height ?? Gen498.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen498.svgSize.width == 0 || Gen498.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

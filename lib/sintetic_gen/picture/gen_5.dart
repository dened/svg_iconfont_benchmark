...
/// Gen5 widget.
/// {@endtemplate}
class Gen5 extends LeafRenderObjectWidget {
  /// {@macro Gen5}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen5RenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, Gen5RenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class Gen5RenderObject extends RenderBox {
  Gen5RenderObject();

  final _painter = _Gen5Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen5.svgSize.width;
    final desiredHeight = _height ?? Gen5.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen5.svgSize.width == 0 || Gen5.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

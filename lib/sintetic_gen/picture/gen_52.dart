...
/// Gen52 widget.
/// {@endtemplate}
class Gen52 extends LeafRenderObjectWidget {
  /// {@macro Gen52}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen52RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen52RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen52RenderObject extends RenderBox {
  Gen52RenderObject();

  final _painter = _Gen52Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen52.svgSize.width;
    final desiredHeight = _height ?? Gen52.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen52.svgSize.width == 0 || Gen52.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

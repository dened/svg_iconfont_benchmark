...
/// Gen55 widget.
/// {@endtemplate}
class Gen55 extends LeafRenderObjectWidget {
  /// {@macro Gen55}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen55RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen55RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen55RenderObject extends RenderBox {
  Gen55RenderObject();

  final _painter = _Gen55Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen55.svgSize.width;
    final desiredHeight = _height ?? Gen55.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen55.svgSize.width == 0 || Gen55.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen6 widget.
/// {@endtemplate}
class Gen6 extends LeafRenderObjectWidget {
  /// {@macro Gen6}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen6RenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, Gen6RenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class Gen6RenderObject extends RenderBox {
  Gen6RenderObject();

  final _painter = _Gen6Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen6.svgSize.width;
    final desiredHeight = _height ?? Gen6.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen6.svgSize.width == 0 || Gen6.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen61 widget.
/// {@endtemplate}
class Gen61 extends LeafRenderObjectWidget {
  /// {@macro Gen61}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen61RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen61RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen61RenderObject extends RenderBox {
  Gen61RenderObject();

  final _painter = _Gen61Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen61.svgSize.width;
    final desiredHeight = _height ?? Gen61.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen61.svgSize.width == 0 || Gen61.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

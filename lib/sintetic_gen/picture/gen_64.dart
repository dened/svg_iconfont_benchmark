...
/// Gen64 widget.
/// {@endtemplate}
class Gen64 extends LeafRenderObjectWidget {
  /// {@macro Gen64}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen64RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen64RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen64RenderObject extends RenderBox {
  Gen64RenderObject();

  final _painter = _Gen64Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen64.svgSize.width;
    final desiredHeight = _height ?? Gen64.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen64.svgSize.width == 0 || Gen64.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

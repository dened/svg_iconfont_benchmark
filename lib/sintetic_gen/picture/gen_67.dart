...
/// Gen67 widget.
/// {@endtemplate}
class Gen67 extends LeafRenderObjectWidget {
  /// {@macro Gen67}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen67RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen67RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen67RenderObject extends RenderBox {
  Gen67RenderObject();

  final _painter = _Gen67Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen67.svgSize.width;
    final desiredHeight = _height ?? Gen67.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen67.svgSize.width == 0 || Gen67.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

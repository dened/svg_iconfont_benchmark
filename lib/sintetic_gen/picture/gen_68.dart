...
/// Gen68 widget.
/// {@endtemplate}
class Gen68 extends LeafRenderObjectWidget {
  /// {@macro Gen68}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen68RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen68RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen68RenderObject extends RenderBox {
  Gen68RenderObject();

  final _painter = _Gen68Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen68.svgSize.width;
    final desiredHeight = _height ?? Gen68.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen68.svgSize.width == 0 || Gen68.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen70 widget.
/// {@endtemplate}
class Gen70 extends LeafRenderObjectWidget {
  /// {@macro Gen70}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen70RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen70RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen70RenderObject extends RenderBox {
  Gen70RenderObject();

  final _painter = _Gen70Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen70.svgSize.width;
    final desiredHeight = _height ?? Gen70.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen70.svgSize.width == 0 || Gen70.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

...
/// Gen71 widget.
/// {@endtemplate}
class Gen71 extends LeafRenderObjectWidget {
  /// {@macro Gen71}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen71RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen71RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen71RenderObject extends RenderBox {
  Gen71RenderObject();

  final _painter = _Gen71Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen71.svgSize.width;
    final desiredHeight = _height ?? Gen71.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen71.svgSize.width == 0 || Gen71.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

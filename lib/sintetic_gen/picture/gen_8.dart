...
/// Gen8 widget.
/// {@endtemplate}
class Gen8 extends LeafRenderObjectWidget {
  /// {@macro Gen8}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen8RenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, Gen8RenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class Gen8RenderObject extends RenderBox {
  Gen8RenderObject();

  final _painter = _Gen8Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen8.svgSize.width;
    final desiredHeight = _height ?? Gen8.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen8.svgSize.width == 0 || Gen8.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

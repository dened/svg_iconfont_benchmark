...
/// Gen85 widget.
/// {@endtemplate}
class Gen85 extends LeafRenderObjectWidget {
  /// {@macro Gen85}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen85RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen85RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen85RenderObject extends RenderBox {
  Gen85RenderObject();

  final _painter = _Gen85Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen85.svgSize.width;
    final desiredHeight = _height ?? Gen85.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen85.svgSize.width == 0 || Gen85.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

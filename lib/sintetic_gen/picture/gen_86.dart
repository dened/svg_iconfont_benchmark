...
/// Gen86 widget.
/// {@endtemplate}
class Gen86 extends LeafRenderObjectWidget {
  /// {@macro Gen86}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen86RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen86RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen86RenderObject extends RenderBox {
  Gen86RenderObject();

  final _painter = _Gen86Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen86.svgSize.width;
    final desiredHeight = _height ?? Gen86.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen86.svgSize.width == 0 || Gen86.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

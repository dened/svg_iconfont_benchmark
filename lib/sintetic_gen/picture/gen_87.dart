...
/// Gen87 widget.
/// {@endtemplate}
class Gen87 extends LeafRenderObjectWidget {
  /// {@macro Gen87}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen87RenderObject()
    ..width = width
    ..height = height
  ...
  void updateRenderObject(
    ...
    Gen87RenderObject renderObject,
  ) {
    renderObject
      ..width = width
      ..height = height
...
class Gen87RenderObject extends RenderBox {
  Gen87RenderObject();

  final _painter = _Gen87Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen87.svgSize.width;
    final desiredHeight = _height ?? Gen87.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen87.svgSize.width == 0 || Gen87.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

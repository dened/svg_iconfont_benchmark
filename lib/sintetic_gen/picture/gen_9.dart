...
/// Gen9 widget.
/// {@endtemplate}
class Gen9 extends LeafRenderObjectWidget {
  /// {@macro Gen9}
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => Gen9RenderObject()
    ..width = width
    ..height = height
    ..colorFilter = colorFilter;

  @override
  void updateRenderObject(BuildContext context, Gen9RenderObject renderObject) {
    renderObject
      ..width = width
      ..height = height
      ..colorFilter = colorFilter;
...
class Gen9RenderObject extends RenderBox {
  Gen9RenderObject();

  final _painter = _Gen9Painter();
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    final desiredWidth = _width ?? Gen9.svgSize.width;
    final desiredHeight = _height ?? Gen9.svgSize.height;
  ...
  void performLayout() {
    ...
    if (Gen9.svgSize.width == 0 || Gen9.svgSize.height == 0) {
      _scale = 1.0;
      return;
    }
    _scale = min(

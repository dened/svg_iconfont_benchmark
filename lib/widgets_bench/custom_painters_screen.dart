...
import 'package:svg_benchmark/sintetic_gen/painter/_all.dart';

class SinteticCustomPaintersScreen extends StatelessWidget {
  const SinteticCustomPaintersScreen({super.key, this.itemCount = 20, this.crossAxisCount, this.changeColor = true});

...
import 'package:svg_benchmark/sintetic_gen/picture/_all.dart';

class SinteticPictureScreen extends StatelessWidget {
  const SinteticPictureScreen({super.key, this.itemCount = 20, this.crossAxisCount, this.changeColor = true});
